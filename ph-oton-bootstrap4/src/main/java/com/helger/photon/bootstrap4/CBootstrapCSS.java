...
public final class CBootstrapCSS
{
  ...
  public static final ICSSClassProvider COL_XS = DefaultCSSClassProvider.create ("col-xs");
  ...
  public static final ICSSClassProvider FLOAT_XS_LEFT = DefaultCSSClassProvider.create ("float-xs-left");
  public static final ICSSClassProvider FLOAT_XS_NONE = DefaultCSSClassProvider.create ("float-xs-none");
  public static final ICSSClassProvider FLOAT_XS_RIGHT = DefaultCSSClassProvider.create ("float-xs-right");
