                                ...
                                @Nonnull final FormErrorList aFormErrors)
  {
    ...
    aForm.addFormGroup (new BootstrapFormGroup ().setLabelMandatory (EText.LABEL_USER.getDisplayText (aDisplayLocale))
                                                 .setCtrl (new HCUserSelect (new RequestField (FIELD_USER,
                                                                             ...
                                                                             aDisplayLocale,
                                                                             x -> x.isNotDeleted () && x.isEnabled ()).setReadOnly (bEdit))
                                                 ...
                                                 @Nonnull final EWebPageFormAction eFormAction)
  {
    ...
    if (aFormErrors.isEmpty ())
    {
      if (bEdit)
      {
        ...
        aWPEC.postRedirectGetInternal (success (EText.EDIT_SUCCESS.getDisplayTextWithArgs (aDisplayLocale, aUser.getDisplayName ())));
      }
      else
      {
        aUserTokenMgr.createUserToken (sTokenString, aCustomAttrMap, aUser);
        aWPEC.postRedirectGetInternal (success (EText.CREATE_SUCCESS.getDisplayTextWithArgs (aDisplayLocale, aUser.getDisplayName ())));
      }
    }
  }
