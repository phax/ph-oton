...
/**
 * An enumeration that can be used in <code>setAutoComplete</code> methods of input controls.<br>
...
public enum EHCAutoComplete implements IHCHasHTMLAttributeValue
{
  ...
  /**
   * The second administrative level, in addresses with at least two of them. In countries with two
   * administrative levels, this would typically be the city, town, village, or other locality in
   * which the address is located.
   */
  ADDRESS_LEVEL2 ("address-level2"),
  /**
   * The first administrative level in the address. This is typically the province in which the
   * address is located. In the United States, this would be the state. In Switzerland, the canton.
  ...
  /**
   * The amount, given in the currency specified by "transaction-currency", of the transaction, for
   * a payment form.
   */
  ...
  BDAY_YEAR ("bday-year"),
  /**
   * A gender identity (such as "Female", "Fa'afafine", "Hijra", "Male", "Nonbinary"), as freeform
   * text without newlines.
   */
  SEX ("sex"),
  /**
   * A full telephone number, including the country code. If you need to break the phone number up
   * into its components, you can use these values for those fields:
   */
  TEL ("tel"),
  /**
  ...
  IMPP ("impp"),
  /**
   * A URL, such as a home page or company website address as appropriate given the context of the
   * other fields in the form.
   */
  URL ("url"),
  /**
   * The URL of an image representing the person, company, or contact information given in the other
   * fields in the form.
   */
  PHOTO ("photo");
