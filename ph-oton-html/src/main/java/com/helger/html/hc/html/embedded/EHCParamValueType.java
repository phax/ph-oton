...
/**
 * An enumeration that can be used in {@link com.helger.html.hc.html.embedded.HCParam} objects to
 * define the used value type.
 *
...
public enum EHCParamValueType implements IHCHasHTMLAttributeValue
{
  ...
  EHCParamValueType (@NonNull @Nonempty final String sAttrValue)
  {
