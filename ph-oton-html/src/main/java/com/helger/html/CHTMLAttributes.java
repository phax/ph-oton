...
public final class CHTMLAttributes
{
  ...
  public static final IMicroQName ARIA_BRAILLELABEL = new MicroQName (PREFIX_ARIA + "braillelabel");
  public static final IMicroQName ARIA_BRAILLEROLEDESCRIPTION = new MicroQName (PREFIX_ARIA + "brailleroledescription");
  ...
  public static final IMicroQName ARIA_COLCOUNT = new MicroQName (PREFIX_ARIA + "colcount");
  public static final IMicroQName ARIA_COLINDEX = new MicroQName (PREFIX_ARIA + "colindex");
  public static final IMicroQName ARIA_COLINDEXTEXT = new MicroQName (PREFIX_ARIA + "colindextext");
  public static final IMicroQName ARIA_COLSPAN = new MicroQName (PREFIX_ARIA + "colspan");
  public static final IMicroQName ARIA_CONTROLS = new MicroQName (PREFIX_ARIA + "controls");
  public static final IMicroQName ARIA_CURRENT = new MicroQName (PREFIX_ARIA + "current");
  ...
  public static final IMicroQName ARIA_KEYSHORTCUTS = new MicroQName (PREFIX_ARIA + "keyshortcuts");
  ...
  public static final IMicroQName ARIA_PLACEHOLDER = new MicroQName (PREFIX_ARIA + "placeholder");
  ...
  public static final IMicroQName ARIA_ROLEDESCRIPTION = new MicroQName (PREFIX_ARIA + "roledescription");
  public static final IMicroQName ARIA_ROWCOUNT = new MicroQName (PREFIX_ARIA + "rowcount");
  public static final IMicroQName ARIA_ROWINDEX = new MicroQName (PREFIX_ARIA + "rowindex");
  public static final IMicroQName ARIA_ROWINDEXTEXT = new MicroQName (PREFIX_ARIA + "rowindextext");
  public static final IMicroQName ARIA_ROWSPAN = new MicroQName (PREFIX_ARIA + "rowspan");
