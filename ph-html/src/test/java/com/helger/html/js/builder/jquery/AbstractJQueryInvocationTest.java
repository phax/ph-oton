...
public class AbstractJQueryInvocationTest
{
  ...
  {
    assertNotNull (JQuery.idRef ("any").bind ());
  }
  ...
  {
    assertNotNull (JQuery.idRef ("any")._clone ());
  }
  ...
  {
    assertNotNull (JQuery.idRef ("any").delegate ());
  }
  ...
  public void test_eq ()
  {
    assertNotNull (JQuery.idRef ("any")._eq ());
  }
  ...
  {
    assertNotNull (JQuery.idRef ("any")._not ());
  }
  ...
  {
    assertNotNull (JQuery.idRef ("any").unbind ());
  }

  @Test
  public void testundelegate ()
  {
    assertNotNull (JQuery.idRef ("any").undelegate ());
  }
