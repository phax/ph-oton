...
public final class HCSampTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCSamp.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCSamp.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
    ...
    assertEquals (0, HCSamp.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCSamp.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                           .getChildCount ());
