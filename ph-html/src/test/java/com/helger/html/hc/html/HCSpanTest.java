...
public final class HCSpanTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCSpan.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCSpan.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
    ...
    assertEquals (0, HCSpan.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCSpan.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                           .getChildCount ());
