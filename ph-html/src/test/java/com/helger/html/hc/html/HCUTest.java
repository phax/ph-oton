...
public final class HCUTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCU.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCU.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
    ...
    assertEquals (0, HCU.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCU.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic"))).getChildCount ());
