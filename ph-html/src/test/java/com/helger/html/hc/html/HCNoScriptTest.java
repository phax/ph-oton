...
public final class HCNoScriptTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCNoScript.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCNoScript.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
    ...
    assertEquals (0, HCNoScript.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCNoScript.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                               .getChildCount ());
