...
/**
 * Test class for class {@link HCSmall} This file is automatically generated
...
public final class HCSmallTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCSmall.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCSmall.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                            .getChildCount ());
