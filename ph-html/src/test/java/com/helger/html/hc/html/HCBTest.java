...
/**
 * Test class for class {@link HCB} This file is automatically generated from
...
public final class HCBTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCB.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCB.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic"))).getChildCount ());
