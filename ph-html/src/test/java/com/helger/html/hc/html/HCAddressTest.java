...
public final class HCAddressTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCAddress.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCAddress.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
