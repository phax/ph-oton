...
public final class HCLITest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCLI.create ((IHCNodeBuilder) null).getChildCount ());
    assertEquals (0, HCLI.create ((IHCNodeBuilder) null, (IHCNodeBuilder) null).getChildCount ());
    ...
    assertEquals (0, HCLI.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCLI.create (CollectionHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                         .getChildCount ());
