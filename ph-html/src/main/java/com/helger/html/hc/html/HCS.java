...
public class HCS extends AbstractHCElementWithChildren <HCS>
{
   ...
   */
  @Nonnull
  public static HCS create (@Nullable final String sChild)
  {
    return new HCS ().addChild (sChild);
  }
   ...
   */
  @Nonnull
  public static HCS create (@Nullable final String... aChildren)
  {
    return new HCS ().addChildren (aChildren);
  }

  /**
   * Create a new S element with the passed child node
   * 
   * @param aChild
  ...
  /**
   * Create a new S element with the passed child nodes
   * 
   * @param aChildren
   ...
   */
  @Nonnull
  public static HCS create (@Nullable final IHCNode aChild)
  {
    return new HCS ().addChild (aChild);
  }
   ...
   */
  @Nonnull
  public static HCS create (@Nullable final IHCNode... aChildren)
  {
    return new HCS ().addChildren (aChildren);
  }
   ...
   */
  @Nonnull
  public static HCS create (@Nullable final Iterable <? extends IHCNode> aChildren)
  {
    return new HCS ().addChildren (aChildren);
  }
}
