...
/**
 * All TinyMCE4 supported languages. Note: not all locales here are valid Java locales!<br>
...
public enum ETinyMCE4Language
{
  ...
  /**
   * Get the language from the passed locale, considering only available translations. If the passed
   * locale has language 'English' no translation is required!
   *
   * @param aLocale
   ...
   *        The locale to check. May be <code>null</code>.
   * @param eDefault
   *        The default language to be returned if no match was found. May be <code>null</code>.
