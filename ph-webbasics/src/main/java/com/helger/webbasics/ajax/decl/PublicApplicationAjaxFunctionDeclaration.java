...
import com.helger.webbasics.ajax.servlet.PublicApplicationAjaxServlet;
...
{
  public PublicApplicationAjaxFunctionDeclaration (@Nonnull @Nonempty final String sFunctionName,
  ...
  {
    return PublicApplicationAjaxServlet.SERVLET_DEFAULT_PATH + '/';
  }
}
