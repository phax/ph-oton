...
import com.helger.webbasics.ajax.servlet.SecureApplicationAjaxServlet;

/**
 * Ajax function declaration for the secure application
 *
 * @author Philip Helger
 */
public class SecureApplicationAjaxFunctionDeclaration extends AbstractAjaxFunctionDeclaration
{
  public SecureApplicationAjaxFunctionDeclaration (@Nonnull @Nonempty final String sFunctionName,
  ...
  {
    return SecureApplicationAjaxServlet.SERVLET_DEFAULT_PATH + '/';
  }
}
