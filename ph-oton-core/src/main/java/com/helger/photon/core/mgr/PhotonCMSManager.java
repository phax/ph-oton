 ...
 * @since 10.2.0
 */
public final class PhotonCMSManager extends AbstractGlobalSingleton
{
  public static final String FAVORITES_XML = "favorites.xml";

  private static final Logger LOGGER = LoggerFactory.getLogger (PhotonCMSManager.class);

  private FavoriteManager m_aFavoriteManager;

  @Deprecated (forRemoval = false)
  @UsedViaReflection
  public PhotonCMSManager ()
  {}
  ...
  @NonNull
  public static PhotonCMSManager getInstance ()
  {
    return getGlobalSingleton (PhotonCMSManager.class);
  }
