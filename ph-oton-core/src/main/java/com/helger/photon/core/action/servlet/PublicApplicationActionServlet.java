...
/**
 * This class handles the actions for the public application
 *
...
public class PublicApplicationActionServlet extends AbstractApplicationActionServlet
{
  ...
  private static final boolean s_bIsRegistered = ServletStatusManager.isServletRegistered (PublicApplicationActionServlet.class);

  public PublicApplicationActionServlet ()
  {}
