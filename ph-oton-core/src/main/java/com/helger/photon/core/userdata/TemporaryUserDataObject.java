...
/**
 * A special version of {@link AbstractUserDataObject} creating a "temporary only" file. A
 * {@link TemporaryUserDataObject} always resides on the file system and can be accessed by regular
 * file IO.
 *
