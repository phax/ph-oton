 ...
 * before an {@link IActionExecutor} is invoked.
 *
 * @author Philip Helger
 */
public interface IActionBeforeExecutionCallback extends ICallback
{
  /**
   * Callback method
   *
   ...
   */
  void onBeforeExecution (@Nonnull IActionInvoker aInvoker,
