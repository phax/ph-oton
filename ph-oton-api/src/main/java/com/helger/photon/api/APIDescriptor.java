...
public class APIDescriptor implements IAPIDescriptor
{
   ...
   * @param aExecutor
   *        The executor to be invoked for that API. May not be <code>null</code>.
   */
   ...
   *        The executor class to be instantiated for every API invocation. May not be
   *        <code>null</code>.
   */
   ...
   *        The factory to be used to create executor instances for every API invocation. May not be
   *        <code>null</code>.
   */
  ...
  /**
   * Add a required HTTP header. If this HTTP header is not present, invocation will not be
   * possible.
   *
   * @param sHeaderName
   *        The name of the required HTTP header. May be <code>null</code> or empty in which case
  ...
  /**
   * Add one or more required HTTP headers. If one of these HTTP headers are not present, invocation
   * will not be possible.
   *
   * @param aHeaderNames
   *        The names of the required HTTP headers. May be <code>null</code> or empty.
   * @return this for chaining
  ...
  /**
   * Add a required request parameter. If this request parameter is not present, invocation will not
   * be possible.
   *
   * @param sParamName
   *        The name of the required request parameter. May be <code>null</code> or empty in which
   *        case the parameter is ignored.
   * @return this for chaining
  ...
  /**
   * Add one or more required request parameters. If one of these request parameters are not
   * present, invocation will not be possible.
   *
   * @param aParamNames
   *        The names of the required HTTP parameters. May be <code>null</code> or empty.
   * @return this for chaining
