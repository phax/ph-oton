 ...
 */
package com.helger.bootstrap3.config;
 ...
 */
@IsSPIImplementation
public final class ThirdPartyModuleProvider_ph_bootstrap3 implements IThirdPartyModuleProviderSPI
{
  public static final IThirdPartyModule BOOTSTRAP3 = new ThirdPartyModule ("Bootstrap",
                                                                           "Twitter",
                                                                           ELicense.MIT,
                                                                           CBootstrap.BOOTSTRAP_VERSION_334,
