...
b,c,d,h){const m=a.scriptNonce?{nonce:a.scriptNonce}:null;var k=a.scriptNonce?{scriptAttrs:{nonce:a.scriptNonce}}:null;d&&d(a.value,b,c);a.inlinejsBeforeExternal&&$.globalEval(a.inlinejsBeforeExternal,m);let l;a.inlinejsAfterExternal&&(l=function(){$.globalEval(a.inlinejsAfterExternal,m)});a.externaljs?l?this.loadJSInOrder(a.externaljs,k,l):this.loadJSInOrder(a.externaljs,k):l&&l();d=document.head||document.getElementsByTagName("head")[0];k=function(g,n){let f=document.createElement("style");f.type=
"text/css";f.title="dynamicallyLoadedCSS";f.media=g;a.styleNonce&&f.setAttribute("nonce",a.styleNonce);f.styleSheet?f.styleSheet.cssText=n:f.appendChild(document.createTextNode(n));return f};if(a.inlinecssBeforeExternal)for(var e in a.inlinecssBeforeExternal)d.appendChild(k(a.inlinecssBeforeExternal[e].media,a.inlinecssBeforeExternal[e].content));if(a.externalcss)for(let g in a.externalcss)e=document.createElement("link"),e.href=a.externalcss[g].href,e.type="text/css",e.rel="stylesheet",e.title="dynamicallyLoadedCSS",
e.media=a.externalcss[g].media,a.styleNonce&&e.setAttribute("nonce",a.styleNonce),d.appendChild(e);if(a.inlinecssAfterExternal)for(let g in a.inlinecssAfterExternal)d.appendChild(k(a.inlinecssAfterExternal[g].media,a.inlinecssAfterExternal[g].content));h&&h(a.value,b,c)}};var jqph=window.jqph=new jqphClass;
