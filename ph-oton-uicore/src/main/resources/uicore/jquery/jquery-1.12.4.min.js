...
ra=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,fa=/[+~]/,sa=/'|\\/g,ba=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,ca=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},oa=function(){H()};try{ha.apply(F=V.call(G.childNodes),G.childNodes),F[G.childNodes.length].nodeType}catch(ad){ha={apply:F.length?function(a,b){Z.apply(a,V.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}w=b.support={};Nb=
