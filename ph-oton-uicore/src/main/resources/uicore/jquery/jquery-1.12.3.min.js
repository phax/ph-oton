...
a.offsetHeight,g=Z(a),h=p.boxSizing&&"border-box"===c.css(a,"boxSizing",!1,g);r.msFullscreenElement&&q.top!==q&&a.getClientRects().length&&(f=Math.round(100*a.getBoundingClientRect()[b]));if(0>=f||null==f){f=B(a,b,g);if(0>f||null==f)f=a.style[b];if(sa.test(f))return f;e=h&&(p.boxSizingReliable()||f===a.style[b]);f=parseFloat(f)||0}return f+Eb(a,b,d||(h?"border":"content"),e,g)+"px"}function D(a,b,d,c,f){return new D.prototype.init(a,b,d,c,f)}function Gb(){q.setTimeout(function(){S=void 0});return S=
c.now()}function oa(a,b){var d,c={height:a},f=0;for(b=b?1:0;4>f;f+=2-b)d=Y[f],c["margin"+d]=c["padding"+d]=a;b&&(c.opacity=c.width=a);return c}function Hb(a,b,d){for(var c,f=(L.tweeners[b]||[]).concat(L.tweeners["*"]),g=0,h=f.length;g<h;g++)if(c=f[g].call(d,b,a))return c}function oc(a,b){var d,e,f,g,h;for(d in a)if(e=c.camelCase(d),f=b[e],g=a[d],c.isArray(g)&&(f=g[1],g=a[d]=g[0]),d!==e&&(a[e]=g,delete a[d]),(h=c.cssHooks[e])&&"expand"in h)for(d in g=h.expand(g),delete a[e],g)d in a||(a[d]=g[d],b[d]=
f);else b[e]=f}function L(a,b,d){var e,f=0,g=L.prefilters.length,h=c.Deferred().always(function(){delete k.elem}),k=function(){if(e)return!1;for(var b=S||Gb(),b=Math.max(0,l.startTime+l.duration-b),d=1-(b/l.duration||0),c=0,f=l.tweens.length;c<f;c++)l.tweens[c].run(d);h.notifyWith(a,[l,d,b]);if(1>d&&f)return b;h.resolveWith(a,[l]);return!1},l=h.promise({elem:a,props:c.extend({},b),opts:c.extend(!0,{specialEasing:{},easing:c.easing._default},d),originalProperties:b,originalOptions:d,startTime:S||Gb(),
...
q;if(!(q=e)){q=c||"*";for(var t=k.nodeType?[k]:k,K=[],Sa=0,v=t.length;Sa<v;Sa++)b(q,t[Sa],K);q=K}q=!a||!e&&c?q:x(q,u,a,k,l);t=d?g||(e?a:r||f)?[]:h:q;d&&d(q,t,k,l);if(f)for(m=x(t,p),f(m,[],k,l),k=m.length;k--;)if(n=m[k])t[p[k]]=!(q[p[k]]=n);if(e){if(g||a){if(g){m=[];for(k=t.length;k--;)(n=t[k])&&m.push(q[k]=n);g(null,t=[],m,l)}for(k=t.length;k--;)(n=t[k])&&-1<(m=g?C(e,n):u[k])&&(e[m]=!(h[m]=n))}}else t=x(t===h?t.splice(r,t.length):t),g?g(null,h,t,l):ha.apply(h,t)})}function A(a){var b,c,d,e=a.length,
...
d<e&&A(a=a.slice(d)),d<e&&p(a))}l.push(c)}return q(l)}function L(a,c){var d=0<c.length,f=0<a.length,g=function(e,g,h,k,l){var m,n,u,p=0,q="0",r=e&&[],pa=[],K=xa,y=e||f&&t.find.TAG("*",l),z=W+=null==K?1:Math.random()||.1,aa=y.length;for(l&&(xa=g===v||g||l);q!==aa&&null!=(m=y[q]);q++){if(f&&m){n=0;g||m.ownerDocument===v||(H(m),h=!E);for(;u=a[n++];)if(u(m,g||v,h)){k.push(m);break}l&&(W=z)}d&&((m=!u&&m)&&p--,e&&r.push(m))}p+=q;if(d&&q!==p){for(n=0;u=c[n++];)u(r,pa,g,h);if(e){if(0<p)for(;q--;)r[q]||pa[q]||
(pa[q]=Y.call(k));pa=x(pa)}ha.apply(k,pa);l&&!e&&0<pa.length&&1<p+c.length&&b.uniqueSort(k)}l&&(W=z,xa=K);return r};return d?e(g):g}var I,w,t,aa,Nb,va,Ta,J,xa,ia,ta,H,v,T,E,y,qa,M,ua,z="sizzle"+1*new Date,G=a.document,W=0,Q=0,O=c(),P=c(),B=c(),N=function(a,b){a===b&&(ta=!0);return 0},X={}.hasOwnProperty,F=[],Y=F.pop,Z=F.push,ha=F.push,V=F.slice,C=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1},ea=/[\x20\t\r\n\f]+/g,S=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,
ga=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,ja=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,ka=/=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g,la=/:((?:\\.|[\w-]|[^\x00-\xa0])+)(?:\((('((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)")|((?:\\.|[^\\()[\]]|\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\])*)|.*)\)|)/,da=/^(?:\\.|[\w-]|[^\x00-\xa0])+$/,U={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,
CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:/^((?:\\.|[\w-]|[^\x00-\xa0])+|[*])/,ATTR:/^\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\]/,PSEUDO:/^:((?:\\.|[\w-]|[^\x00-\xa0])+)(?:\((('((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)")|((?:\\.|[^\\()[\]]|\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\])*)|.*)\)|)/,
CHILD:/^:(only|first|last|nth|nth-last)-(child|of-type)(?:\([\x20\t\r\n\f]*(even|odd|(([+-]|)(\d*)n|)[\x20\t\r\n\f]*(?:([+-]|)[\x20\t\r\n\f]*(\d+)|))[\x20\t\r\n\f]*\)|)/i,bool:/^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$/i,needsContext:/^[\x20\t\r\n\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i},ma=/^(?:input|select|textarea|button)$/i,na=/^h\d$/i,R=/^[^{]+\{\s*\[native \w/,
ra=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,fa=/[+~]/,sa=/'|\\/g,ba=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,ca=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},oa=function(){H()};try{ha.apply(F=V.call(G.childNodes),G.childNodes),F[G.childNodes.length].nodeType}catch($c){ha={apply:F.length?function(a,b){Z.apply(a,V.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}w=b.support={};Nb=
...
a||[],!0))},is:function(a){return!!Ea(this,"string"===typeof a&&Pb.test(a)?c(a):a||[],!1).length}});var Ua,vc=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(c.fn.init=function(a,b,d){var e;if(!a)return this;d=d||Ua;if("string"===typeof a){e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:vc.exec(a);if(!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof c?b[0]:b,c.merge(this,c.parseHTML(e[1],b&&b.nodeType?b.ownerDocument||b:r,!0)),
...
a.contentDocument||a.contentWindow.document:c.merge([],a.childNodes)}},function(a,b){c.fn[a]=function(d,e){var f=c.map(this,b,d);"Until"!==a.slice(-5)&&(e=d);e&&"string"===typeof e&&(f=c.filter(e,f));1<this.length&&(xc[a]||(f=c.uniqueSort(f)),wc.test(a)&&(f=f.reverse()));return this.pushStack(f)}});var J=/\S+/g;c.Callbacks=function(a){a="string"===typeof a?fc(a):c.extend({},a);var b,d,e,f,g=[],h=[],k=-1,l=function(){f=a.once;for(e=b=!0;h.length;k=-1)for(d=h.shift();++k<g.length;)!1===g[k].apply(d[0],
...
typeof a){for(e in a)this.off(e,b,a[e]);return this}if(!1===b||"function"===typeof b)d=b,b=void 0;!1===d&&(d=ea);return this.each(function(){c.event.remove(this,a,d,b)})},trigger:function(a,b){return this.each(function(){c.event.trigger(a,b,this)})},triggerHandler:function(a,b){var d=this[0];if(d)return c.event.trigger(a,b,d,!0)}});var Bc=/ jQuery\d+="(?:null|\d+)"/g,Tb=/<(?:abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video)[\s/>]/i,
Cc=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,Dc=/<script|<style|<link/i,lc=/checked\s*(?:[^=]|=\s*.checked.)/i,kc=/^true\/(.*)/,mc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,Xa=lb(r).appendChild(r.createElement("div"));c.extend({htmlPrefilter:function(a){return a.replace(Cc,"<$1></$2>")},clone:function(a,b,d){var e,f,g,h,k,l=c.contains(a.ownerDocument,a);p.html5Clone||c.isXMLDoc(a)||!Tb.test("<"+a.nodeName+">")?g=a.cloneNode(!0):(Xa.innerHTML=a.outerHTML,Xa.removeChild(g=
...
f=0===a[0].offsetHeight)a[0].style.display="",a[1].style.display="none",f=0===a[0].offsetHeight;c.removeChild(k)}var b,d,e,f,g,h,k=r.createElement("div"),l=r.createElement("div");l.style&&(l.style.cssText="float:left;opacity:.5",p.opacity="0.5"===l.style.opacity,p.cssFloat=!!l.style.cssFloat,l.style.backgroundClip="content-box",l.cloneNode(!0).style.backgroundClip="",p.clearCloneStyle="content-box"===l.style.backgroundClip,k=r.createElement("div"),k.style.cssText="border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
l.innerHTML="",k.appendChild(l),p.boxSizing=""===l.style.boxSizing||""===l.style.MozBoxSizing||""===l.style.WebkitBoxSizing,c.extend(p,{reliableHiddenOffsets:function(){null==b&&a();return f},boxSizingReliable:function(){null==b&&a();return e},pixelMarginRight:function(){null==b&&a();return d},pixelPosition:function(){null==b&&a();return b},reliableMarginRight:function(){null==b&&a();return g},reliableMarginLeft:function(){null==b&&a();return h}}))})();var Z,B,Ec=/^(top|right|bottom|left)$/;q.getComputedStyle?
(Z=function(a){var b=a.ownerDocument.defaultView;b&&b.opener||(b=q);return b.getComputedStyle(a)},B=function(a,b,d){var e,f,g=a.style;f=(d=d||Z(a))?d.getPropertyValue(b)||d[b]:void 0;""!==f&&void 0!==f||c.contains(a.ownerDocument,a)||(f=c.style(a,b));d&&!p.pixelMarginRight()&&sa.test(f)&&Ub.test(b)&&(a=g.width,b=g.minWidth,e=g.maxWidth,g.minWidth=g.maxWidth=g.width=f,f=d.width,g.width=a,g.minWidth=b,g.maxWidth=e);return void 0===f?f:f+""}):Vb.currentStyle&&(Z=function(a){return a.currentStyle},B=
function(a,b,c){var e,f,g,h=a.style;g=(c=c||Z(a))?c[b]:void 0;null==g&&h&&h[b]&&(g=h[b]);if(sa.test(g)&&!Ec.test(b)){c=h.left;if(f=(e=a.runtimeStyle)&&e.left)e.left=a.currentStyle.left;h.left="fontSize"===b?"1em":g;g=h.pixelLeft+"px";h.left=c;f&&(e.left=f)}return void 0===g?g:g+""||"auto"});var Za=/alpha\([^)]*\)/i,Fc=/opacity\s*=\s*([^)]*)/i,Gc=/^(none|table(?!-c[ea]).+)/,nc=new RegExp("^("+Va+")(.*)$","i"),Hc={position:"absolute",visibility:"hidden",display:"block"},Wb={letterSpacing:"0",fontWeight:"400"},
...
a.elem[a.prop]=a.now:c.style(a.elem,a.prop,a.now+a.unit)}}};D.propHooks.scrollTop=D.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};c.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};c.fx=D.prototype.init;c.fx.step={};var S,za,Ic=/^(?:toggle|show|hide)$/,Jc=/queueHooks$/;c.Animation=c.extend(L,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);kb(c.elem,a,Ga.exec(b),c);return c}]},tweener:function(a,
...
b||"width"in b)&&(d.overflow=[m.overflow,m.overflowX,m.overflowY],l=c.css(a,"display"),f="none"===l?c._data(a,"olddisplay")||fa(a.nodeName):l,"inline"===f&&"none"===c.css(a,"float")&&(p.inlineBlockNeedsLayout&&"inline"!==fa(a.nodeName)?m.zoom=1:m.display="inline-block"));d.overflow&&(m.overflow="hidden",p.shrinkWrapBlocks()||n.always(function(){m.overflow=d.overflow[0];m.overflowX=d.overflow[1];m.overflowY=d.overflow[2]}));for(e in b)if(f=b[e],Ic.exec(f)){delete b[e];g=g||"toggle"===f;if(f===(r?"hide":
"show"))if("show"===f&&x&&void 0!==x[e])r=!0;else continue;q[e]=x&&x[e]||c.style(a,e)}else l=void 0;if(c.isEmptyObject(q))"inline"===("none"===l?fa(a.nodeName):l)&&(m.display=l);else for(e in x?"hidden"in x&&(r=x.hidden):x=c._data(a,"fxshow",{}),g&&(x.hidden=!r),r?c(a).show():n.done(function(){c(a).hide()}),n.done(function(){var b;c._removeData(a,"fxshow");for(b in q)c.style(a,b,q[b])}),q)b=Hb(r?x[e]:0,e,n),e in x||(x[e]=b.start,r&&(b.end=b.start,b.start="width"===e||"height"===e?1:0))}],prefilter:function(a,
b){b?L.prefilters.unshift(a):L.prefilters.push(a)}});c.speed=function(a,b,d){var e=a&&"object"===typeof a?c.extend({},a):{complete:d||!d&&b||c.isFunction(a)&&a,duration:a,easing:d&&b||b&&!c.isFunction(b)&&b};e.duration=c.fx.off?0:"number"===typeof e.duration?e.duration:e.duration in c.fx.speeds?c.fx.speeds[e.duration]:c.fx.speeds._default;if(null==e.queue||!0===e.queue)e.queue="fx";e.old=e.complete;e.complete=function(){c.isFunction(e.old)&&e.old.call(this);e.queue&&c.dequeue(this,e.queue)};return e};
c.fn.extend({fadeTo:function(a,b,c,e){return this.filter(R).css("opacity",0).show().end().animate({opacity:b},a,c,e)},animate:function(a,b,d,e){var f=c.isEmptyObject(a),g=c.speed(b,d,e);b=function(){var b=L(this,c.extend({},a),g);(f||c._data(this,"finish"))&&b.stop(!0)};b.finish=b;return f||!1===g.queue?this.each(b):this.queue(g.queue,b)},stop:function(a,b,d){var e=function(a){var b=a.stop;delete a.stop;b(d)};"string"!==typeof a&&(d=b,b=a,a=void 0);b&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b=
...
this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;b<g;b++)e[b]&&e[b].finish&&e[b].finish.call(this);delete d.finish})}});c.each(["toggle","show","hide"],function(a,b){var d=c.fn[b];c.fn[b]=function(a,c,g){return null==a||"boolean"===typeof a?d.apply(this,arguments):this.animate(oa(b,!0),a,c,g)}});c.each({slideDown:oa("show"),slideUp:oa("hide"),slideToggle:oa("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){c.fn[a]=function(a,c,
f){return this.animate(b,a,c,f)}});c.timers=[];c.fx.tick=function(){var a,b=c.timers,d=0;for(S=c.now();d<b.length;d++)a=b[d],a()||b[d]!==a||b.splice(d--,1);b.length||c.fx.stop();S=void 0};c.fx.timer=function(a){c.timers.push(a);a()?c.fx.start():c.timers.pop()};c.fx.interval=13;c.fx.start=function(){za||(za=q.setInterval(c.fx.tick,c.fx.interval))};c.fx.stop=function(){q.clearInterval(za);za=null};c.fx.speeds={slow:600,fast:200,_default:400};c.fn.delay=function(a,b){a=c.fx?c.fx.speeds[a]||a:a;return this.queue(b||
"fx",function(b,c){var f=q.setTimeout(b,a);c.stop=function(){q.clearTimeout(f)}})};(function(){var a,b=r.createElement("input"),c=r.createElement("div"),e=r.createElement("select"),f=e.appendChild(r.createElement("option")),c=r.createElement("div");c.setAttribute("className","t");c.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";c.getElementsByTagName("a");b.setAttribute("type","checkbox");c.appendChild(b);a=c.getElementsByTagName("a")[0];a.style.cssText="top:1px";p.getSetAttribute=
"t"!==c.className;p.style=/top/.test(a.getAttribute("style"));p.hrefNormalized="/a"===a.getAttribute("href");p.checkOn=!!b.value;p.optSelected=f.selected;p.enctype=!!r.createElement("form").enctype;e.disabled=!0;p.optDisabled=!f.disabled;b=r.createElement("input");b.setAttribute("value","");p.input=""===b.getAttribute("value");b.value="t";b.setAttribute("type","radio");p.radioValue="t"===b.value})();var Kc=/\r/g,Lc=/[\x20\t\r\n\f]+/g;c.fn.extend({val:function(a){var b,d,e,f=this[0];if(arguments.length)return e=
c.isFunction(a),this.each(function(d){1===this.nodeType&&(d=e?a.call(this,d,c(this).val()):a,null==d?d="":"number"===typeof d?d+="":c.isArray(d)&&(d=c.map(d,function(a){return null==a?"":a+""})),b=c.valHooks[this.type]||c.valHooks[this.nodeName.toLowerCase()],b&&"set"in b&&void 0!==b.set(this,d,"value")||(this.value=d))});if(f){if((b=c.valHooks[f.type]||c.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&void 0!==(d=b.get(f,"value")))return d;d=f.value;return"string"===typeof d?d.replace(Kc,""):null==
d?"":d}}});c.extend({valHooks:{option:{get:function(a){var b=c.find.attr(a,"value");return null!=b?b:c.trim(c.text(a)).replace(Lc," ")}},select:{get:function(a){for(var b,d=a.options,e=a.selectedIndex,f=(a="select-one"===a.type||0>e)?null:[],g=a?e+1:d.length,h=0>e?g:a?e:0;h<g;h++)if(b=d[h],!(!b.selected&&h!==e||(p.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&c.nodeName(b.parentNode,"optgroup"))){b=c(b).val();if(a)return b;f.push(b)}return f},set:function(a,b){for(var d,
e,f=a.options,g=c.makeArray(b),h=f.length;h--;)if(e=f[h],-1<c.inArray(c.valHooks.option.get(e),g))try{e.selected=d=!0}catch(k){e.scrollHeight}else e.selected=!1;d||(a.selectedIndex=-1);return f}}}});c.each(["radio","checkbox"],function(){c.valHooks[this]={set:function(a,b){if(c.isArray(b))return a.checked=-1<c.inArray(c(a).val(),b)}};p.checkOn||(c.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var la,Xb,O=c.expr.attrHandle,$a=/^(?:checked|selected)$/i,C=p.getSetAttribute,
Aa=p.input;c.fn.extend({attr:function(a,b){return X(this,c.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){c.removeAttr(this,a)})}});c.extend({attr:function(a,b,d){var e,f,g=a.nodeType;if(3!==g&&8!==g&&2!==g){if("undefined"===typeof a.getAttribute)return c.prop(a,b,d);1===g&&c.isXMLDoc(a)||(b=b.toLowerCase(),f=c.attrHooks[b]||(c.expr.match.bool.test(b)?Xb:la));if(void 0!==d){if(null===d){c.removeAttr(a,b);return}if(f&&"set"in f&&void 0!==(e=f.set(a,d,b)))return e;
a.setAttribute(b,d+"");return d}if(f&&"get"in f&&null!==(e=f.get(a,b)))return e;e=c.find.attr(a,b);return null==e?void 0:e}},attrHooks:{type:{set:function(a,b){if(!p.radioValue&&"radio"===b&&c.nodeName(a,"input")){var d=a.value;a.setAttribute("type",b);d&&(a.value=d);return b}}}},removeAttr:function(a,b){var d,e,f=0,g=b&&b.match(J);if(g&&1===a.nodeType)for(;d=g[f++];)e=c.propFix[d]||d,c.expr.match.bool.test(d)?Aa&&C||!$a.test(d)?a[e]=!1:a[c.camelCase("default-"+d)]=a[e]=!1:c.attr(a,d,""),a.removeAttribute(C?
d:e)}});Xb={set:function(a,b,d){!1===b?c.removeAttr(a,d):Aa&&C||!$a.test(d)?a.setAttribute(!C&&c.propFix[d]||d,d):a[c.camelCase("default-"+d)]=a[d]=!0;return d}};c.each(c.expr.match.bool.source.match(/\w+/g),function(a,b){var d=O[b]||c.find.attr;Aa&&C||!$a.test(b)?O[b]=function(a,b,c){var h,k;c||(k=O[b],O[b]=h,h=null!=d(a,b,c)?b.toLowerCase():null,O[b]=k);return h}:O[b]=function(a,b,d){if(!d)return a[c.camelCase("default-"+b)]?b.toLowerCase():null}});Aa&&C||(c.attrHooks.value={set:function(a,b,d){if(c.nodeName(a,
"input"))a.defaultValue=b;else return la&&la.set(a,b,d)}});C||(la={set:function(a,b,c){var e=a.getAttributeNode(c);e||a.setAttributeNode(e=a.ownerDocument.createAttribute(c));e.value=b+="";if("value"===c||b===a.getAttribute(c))return b}},O.id=O.name=O.coords=function(a,b,c){var e;if(!c)return(e=a.getAttributeNode(b))&&""!==e.value?e.value:null},c.valHooks.button={get:function(a,b){var c=a.getAttributeNode(b);if(c&&c.specified)return c.value},set:la.set},c.attrHooks.contenteditable={set:function(a,
b,c){la.set(a,""===b?!1:b,c)}},c.each(["width","height"],function(a,b){c.attrHooks[b]={set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}}}));p.style||(c.attrHooks.style={get:function(a){return a.style.cssText||void 0},set:function(a,b){return a.style.cssText=b+""}});var Mc=/^(?:input|select|textarea|button|object)$/i,Nc=/^(?:a|area)$/i;c.fn.extend({prop:function(a,b){return X(this,c.prop,a,b,1<arguments.length)},removeProp:function(a){a=c.propFix[a]||a;return this.each(function(){try{this[a]=
void 0,delete this[a]}catch(b){}})}});c.extend({prop:function(a,b,d){var e,f,g=a.nodeType;if(3!==g&&8!==g&&2!==g)return 1===g&&c.isXMLDoc(a)||(b=c.propFix[b]||b,f=c.propHooks[b]),void 0!==d?f&&"set"in f&&void 0!==(e=f.set(a,d,b))?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]},propHooks:{tabIndex:{get:function(a){var b=c.find.attr(a,"tabindex");return b?parseInt(b,10):Mc.test(a.nodeName)||Nc.test(a.nodeName)&&a.href?0:-1}}},propFix:{"for":"htmlFor","class":"className"}});p.hrefNormalized||c.each(["href",
"src"],function(a,b){c.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}});p.optSelected||(c.propHooks.selected={get:function(a){if(a=a.parentNode)a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex;return null},set:function(a){if(a=a.parentNode)a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex}});c.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){c.propFix[this.toLowerCase()]=this});p.enctype||
(c.propFix.enctype="encoding");var ab=/[\t\r\n\f]/g;c.fn.extend({addClass:function(a){var b,d,e,f,g,h,k=0;if(c.isFunction(a))return this.each(function(b){c(this).addClass(a.call(this,b,V(this)))});if("string"===typeof a&&a)for(b=a.match(J)||[];d=this[k++];)if(f=V(d),e=1===d.nodeType&&(" "+f+" ").replace(ab," ")){for(h=0;g=b[h++];)0>e.indexOf(" "+g+" ")&&(e+=g+" ");e=c.trim(e);f!==e&&c.attr(d,"class",e)}return this},removeClass:function(a){var b,d,e,f,g,h,k=0;if(c.isFunction(a))return this.each(function(b){c(this).removeClass(a.call(this,
...
V(this),b),b)}):this.each(function(){var b,f,g,h;if("string"===d)for(f=0,g=c(this),h=a.match(J)||[];b=h[f++];)g.hasClass(b)?g.removeClass(b):g.addClass(b);else if(void 0===a||"boolean"===d)(b=V(this))&&c._data(this,"__className__",b),c.attr(this,"class",b||!1===a?"":c._data(this,"__className__")||"")})},hasClass:function(a){var b,c=0;for(a=" "+a+" ";b=this[c++];)if(1===b.nodeType&&-1<(" "+V(b)+" ").replace(ab," ").indexOf(a))return!0;return!1}});c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
function(a,b){c.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});c.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var Oc=q.location,bb=c.now(),cb=/\?/,Pc=/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;c.parseJSON=function(a){if(q.JSON&&q.JSON.parse)return q.JSON.parse(a+"");var b,d=null,e=c.trim(a+"");return e&&!c.trim(e.replace(Pc,function(a,c,e,k){b&&
c&&(d=0);if(0===d)return a;b=e||c;d+=!k-!e;return""}))?Function("return "+e)():c.error("Invalid JSON: "+a)};c.parseXML=function(a){var b,d;if(!a||"string"!==typeof a)return null;try{q.DOMParser?(d=new q.DOMParser,b=d.parseFromString(a,"text/xml")):(b=new q.ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a))}catch(e){b=void 0}b&&b.documentElement&&!b.getElementsByTagName("parsererror").length||c.error("Invalid XML: "+a);return b};var Qc=/#.*$/,Yb=/([?&])_=[^&]*/,Rc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
Sc=/^(?:GET|HEAD)$/,Tc=/^\/\//,Zb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,$b={},Ma={},ac="*/".concat("*"),db=Oc.href,da=Zb.exec(db.toLowerCase())||[];c.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:db,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(da[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":ac,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",
json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":c.parseJSON,"text xml":c.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Na(Na(a,c.ajaxSettings),b):Na(c.ajaxSettings,a)},ajaxPrefilter:Ib($b),ajaxTransport:Ib(Ma),ajax:function(a,b){function d(a,b,d,e){var f,p,u,w;w=b;if(2!==I){I=2;k&&q.clearTimeout(k);
n=void 0;h=e||"";t.readyState=0<a?4:0;e=200<=a&&300>a||304===a;if(d){u=m;for(var H=t,v,C,E,y,B=u.contents,M=u.dataTypes;"*"===M[0];)M.shift(),void 0===C&&(C=u.mimeType||H.getResponseHeader("Content-Type"));if(C)for(y in B)if(B[y]&&B[y].test(C)){M.unshift(y);break}if(M[0]in d)E=M[0];else{for(y in d){if(!M[0]||u.converters[y+" "+M[0]]){E=y;break}v||(v=y)}E=E||v}E?(E!==M[0]&&M.unshift(E),u=d[E]):u=void 0}a:{d=m;v=u;C=t;E=e;var J,z,G,H={},B=d.dataTypes.slice();if(B[1])for(z in d.converters)H[z.toLowerCase()]=
d.converters[z];for(y=B.shift();y;)if(d.responseFields[y]&&(C[d.responseFields[y]]=v),!G&&E&&d.dataFilter&&(v=d.dataFilter(v,d.dataType)),G=y,y=B.shift())if("*"===y)y=G;else if("*"!==G&&G!==y){z=H[G+" "+y]||H["* "+y];if(!z)for(J in H)if(u=J.split(" "),u[1]===y&&(z=H[G+" "+u[0]]||H["* "+u[0]])){!0===z?z=H[J]:!0!==H[J]&&(y=u[0],B.unshift(u[1]));break}if(!0!==z)if(z&&d["throws"])v=z(v);else try{v=z(v)}catch(L){u={state:"parsererror",error:z?L:"No conversion from "+G+" to "+y};break a}}u={state:"success",
data:v}}if(e)m.ifModified&&((w=t.getResponseHeader("Last-Modified"))&&(c.lastModified[g]=w),(w=t.getResponseHeader("etag"))&&(c.etag[g]=w)),204===a||"HEAD"===m.type?w="nocontent":304===a?w="notmodified":(w=u.state,f=u.data,p=u.error,e=!p);else if(p=w,a||!w)w="error",0>a&&(a=0);t.status=a;t.statusText=(b||w)+"";e?A.resolveWith(r,[f,w,t]):A.rejectWith(r,[t,w,p]);t.statusCode(F);F=void 0;l&&x.trigger(e?"ajaxSuccess":"ajaxError",[t,m,e?f:p]);D.fireWith(r,[t,w]);l&&(x.trigger("ajaxComplete",[t,m]),--c.active||
c.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,k,l,n,p,m=c.ajaxSetup({},b),r=m.context||m,x=m.context&&(r.nodeType||r.jquery)?c(r):c.event,A=c.Deferred(),D=c.Callbacks("once memory"),F=m.statusCode||{},C={},B={},I=0,w="canceled",t={readyState:0,getResponseHeader:function(a){var b;if(2===I){if(!p)for(p={};b=Rc.exec(h);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===I?h:null},setRequestHeader:function(a,
b){var c=a.toLowerCase();I||(a=B[c]=B[c]||a,C[a]=b);return this},overrideMimeType:function(a){I||(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>I)for(b in a)F[b]=[F[b],a[b]];else t.always(a[t.status]);return this},abort:function(a){a=a||w;n&&n.abort(a);d(0,a);return this}};A.promise(t).complete=D.add;t.success=t.done;t.error=t.fail;m.url=((a||m.url||db)+"").replace(Qc,"").replace(Tc,da[1]+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=c.trim(m.dataType||"*").toLowerCase().match(J)||
[""];null==m.crossDomain&&(e=Zb.exec(m.url.toLowerCase()),m.crossDomain=!(!e||e[1]===da[1]&&e[2]===da[2]&&(e[3]||("http:"===e[1]?"80":"443"))===(da[3]||("http:"===da[1]?"80":"443"))));m.data&&m.processData&&"string"!==typeof m.data&&(m.data=c.param(m.data,m.traditional));Jb($b,m,b,t);if(2===I)return t;(l=c.event&&m.global)&&0===c.active++&&c.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!Sc.test(m.type);g=m.url;m.hasContent||(m.data&&(g=m.url+=(cb.test(g)?"&":"?")+m.data,delete m.data),
!1===m.cache&&(m.url=Yb.test(g)?g.replace(Yb,"$1_="+bb++):g+(cb.test(g)?"&":"?")+"_="+bb++));m.ifModified&&(c.lastModified[g]&&t.setRequestHeader("If-Modified-Since",c.lastModified[g]),c.etag[g]&&t.setRequestHeader("If-None-Match",c.etag[g]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&t.setRequestHeader("Content-Type",m.contentType);t.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+ac+"; q=0.01":""):m.accepts["*"]);
for(f in m.headers)t.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(r,t,m)||2===I))return t.abort();w="abort";for(f in{success:1,error:1,complete:1})t[f](m[f]);if(n=Jb(Ma,m,b,t)){t.readyState=1;l&&x.trigger("ajaxSend",[t,m]);if(2===I)return t;m.async&&0<m.timeout&&(k=q.setTimeout(function(){t.abort("timeout")},m.timeout));try{I=1,n.send(C,d)}catch(aa){if(2>I)d(-1,aa);else throw aa;}}else d(-1,"No Transport");return t},getJSON:function(a,b,d){return c.get(a,b,d,"json")},
...
a)})},unwrap:function(){return this.parent().each(function(){c.nodeName(this,"body")||c(this).replaceWith(this.childNodes)}).end()}});c.expr.filters.hidden=function(a){if(p.reliableHiddenOffsets())a=0>=a.offsetWidth&&0>=a.offsetHeight&&!a.getClientRects().length;else a:{for(;a&&1===a.nodeType;){if("none"===(a.style&&a.style.display||c.css(a,"display"))||"hidden"===a.type){a=!0;break a}a=a.parentNode}a=!1}return a};c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)};var Uc=/%20/g,pc=
/\[\]$/,bc=/\r?\n/g,Vc=/^(?:submit|button|image|reset|file)$/i,Wc=/^(?:input|select|textarea|keygen)/i;c.param=function(a,b){var d,e=[],f=function(a,b){b=c.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};void 0===b&&(b=c.ajaxSettings&&c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)Oa(d,a[d],b,f);return e.join("&").replace(Uc,"+")};c.fn.extend({serialize:function(){return c.param(this.serializeArray())},
serializeArray:function(){return this.map(function(){var a=c.prop(this,"elements");return a?c.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!c(this).is(":disabled")&&Wc.test(this.nodeName)&&!Vc.test(a)&&(this.checked||!Ia.test(a))}).map(function(a,b){var d=c(this).val();return null==d?null:c.isArray(d)?c.map(d,function(a){return{name:b.name,value:a.replace(bc,"\r\n")}}):{name:b.name,value:d.replace(bc,"\r\n")}}).get()}});c.ajaxSettings.xhr=void 0!==q.ActiveXObject?function(){return this.isLocal?
Kb():8<r.documentMode?Pa():/^(get|post|head|put|delete|options)$/i.test(this.type)&&Pa()||Kb()}:Pa;var Xc=0,Ba={},Ca=c.ajaxSettings.xhr();q.attachEvent&&q.attachEvent("onunload",function(){for(var a in Ba)Ba[a](void 0,!0)});p.cors=!!Ca&&"withCredentials"in Ca;(Ca=p.ajax=!!Ca)&&c.ajaxTransport(function(a){if(!a.crossDomain||p.cors){var b;return{send:function(d,e){var f,g=a.xhr(),h=++Xc;g.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(f in a.xhrFields)g[f]=a.xhrFields[f];a.mimeType&&
...
a||"**",c)}});c.fn.size=function(){return this.length};c.fn.andSelf=c.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return c});var Yc=q.jQuery,Zc=q.$;c.noConflict=function(a){q.$===c&&(q.$=Zc);a&&q.jQuery===c&&(q.jQuery=Yc);return c};U||(q.jQuery=q.$=c);return c});
