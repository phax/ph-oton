...
/**
 * Central registry of the named metric instruments emitted for the system migrations performed by
 * {@link SystemMigrationHelper}. Each instrument is created once at class-load time via the vendor
 ...
 */
@Immutable
public final class SystemMigrationMetrics
{
  /** System migrations that were really executed, by ID, success and failure kind. */
  public static final ITelemetryCounter MIGRATIONS_EXECUTED = TelemetryMetrics.counter (CMgrsTelemetry.METRIC_MIGRATIONS_EXECUTED,
                                                                                        "System migrations that were really executed - successfully or not",
                                                                                        CMgrsTelemetry.UNIT_MIGRATION);
