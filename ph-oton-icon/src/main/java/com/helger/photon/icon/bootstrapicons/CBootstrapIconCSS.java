...
public final class CBootstrapIconCSS
{
  ...
  public static final ICSSClassProvider BI_0_CIRCLE = DefaultCSSClassProvider.create ("bi-0-circle");
  public static final ICSSClassProvider BI_0_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-0-circle-fill");
  public static final ICSSClassProvider BI_0_SQUARE = DefaultCSSClassProvider.create ("bi-0-square");
  public static final ICSSClassProvider BI_0_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-0-square-fill");
  public static final ICSSClassProvider BI_1_CIRCLE = DefaultCSSClassProvider.create ("bi-1-circle");
  public static final ICSSClassProvider BI_1_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-1-circle-fill");
  public static final ICSSClassProvider BI_1_SQUARE = DefaultCSSClassProvider.create ("bi-1-square");
  public static final ICSSClassProvider BI_1_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-1-square-fill");
  public static final ICSSClassProvider BI_123 = DefaultCSSClassProvider.create ("bi-123");
  public static final ICSSClassProvider BI_2_CIRCLE = DefaultCSSClassProvider.create ("bi-2-circle");
  public static final ICSSClassProvider BI_2_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-2-circle-fill");
  public static final ICSSClassProvider BI_2_SQUARE = DefaultCSSClassProvider.create ("bi-2-square");
  public static final ICSSClassProvider BI_2_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-2-square-fill");
  public static final ICSSClassProvider BI_3_CIRCLE = DefaultCSSClassProvider.create ("bi-3-circle");
  public static final ICSSClassProvider BI_3_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-3-circle-fill");
  public static final ICSSClassProvider BI_3_SQUARE = DefaultCSSClassProvider.create ("bi-3-square");
  public static final ICSSClassProvider BI_3_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-3-square-fill");
  public static final ICSSClassProvider BI_4_CIRCLE = DefaultCSSClassProvider.create ("bi-4-circle");
  public static final ICSSClassProvider BI_4_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-4-circle-fill");
  public static final ICSSClassProvider BI_4_SQUARE = DefaultCSSClassProvider.create ("bi-4-square");
  public static final ICSSClassProvider BI_4_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-4-square-fill");
  public static final ICSSClassProvider BI_5_CIRCLE = DefaultCSSClassProvider.create ("bi-5-circle");
  public static final ICSSClassProvider BI_5_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-5-circle-fill");
  public static final ICSSClassProvider BI_5_SQUARE = DefaultCSSClassProvider.create ("bi-5-square");
  public static final ICSSClassProvider BI_5_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-5-square-fill");
  public static final ICSSClassProvider BI_6_CIRCLE = DefaultCSSClassProvider.create ("bi-6-circle");
  public static final ICSSClassProvider BI_6_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-6-circle-fill");
  public static final ICSSClassProvider BI_6_SQUARE = DefaultCSSClassProvider.create ("bi-6-square");
  public static final ICSSClassProvider BI_6_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-6-square-fill");
  public static final ICSSClassProvider BI_7_CIRCLE = DefaultCSSClassProvider.create ("bi-7-circle");
  public static final ICSSClassProvider BI_7_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-7-circle-fill");
  public static final ICSSClassProvider BI_7_SQUARE = DefaultCSSClassProvider.create ("bi-7-square");
  public static final ICSSClassProvider BI_7_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-7-square-fill");
  public static final ICSSClassProvider BI_8_CIRCLE = DefaultCSSClassProvider.create ("bi-8-circle");
  public static final ICSSClassProvider BI_8_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-8-circle-fill");
  public static final ICSSClassProvider BI_8_SQUARE = DefaultCSSClassProvider.create ("bi-8-square");
  public static final ICSSClassProvider BI_8_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-8-square-fill");
  public static final ICSSClassProvider BI_9_CIRCLE = DefaultCSSClassProvider.create ("bi-9-circle");
  public static final ICSSClassProvider BI_9_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-9-circle-fill");
  public static final ICSSClassProvider BI_9_SQUARE = DefaultCSSClassProvider.create ("bi-9-square");
  public static final ICSSClassProvider BI_9_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-9-square-fill");
  public static final ICSSClassProvider BI_ACTIVITY = DefaultCSSClassProvider.create ("bi-activity");
  public static final ICSSClassProvider BI_AIRPLANE = DefaultCSSClassProvider.create ("bi-airplane");
  public static final ICSSClassProvider BI_AIRPLANE_ENGINES = DefaultCSSClassProvider.create ("bi-airplane-engines");
  public static final ICSSClassProvider BI_AIRPLANE_ENGINES_FILL = DefaultCSSClassProvider.create ("bi-airplane-engines-fill");
  public static final ICSSClassProvider BI_AIRPLANE_FILL = DefaultCSSClassProvider.create ("bi-airplane-fill");
  ...
  public static final ICSSClassProvider BI_ALEXA = DefaultCSSClassProvider.create ("bi-alexa");
  ...
  public static final ICSSClassProvider BI_ALIPAY = DefaultCSSClassProvider.create ("bi-alipay");
  public static final ICSSClassProvider BI_ALPHABET = DefaultCSSClassProvider.create ("bi-alphabet");
  public static final ICSSClassProvider BI_ALPHABET_UPPERCASE = DefaultCSSClassProvider.create ("bi-alphabet-uppercase");
  public static final ICSSClassProvider BI_ALT = DefaultCSSClassProvider.create ("bi-alt");
  public static final ICSSClassProvider BI_AMAZON = DefaultCSSClassProvider.create ("bi-amazon");
  public static final ICSSClassProvider BI_AMD = DefaultCSSClassProvider.create ("bi-amd");
  public static final ICSSClassProvider BI_ANDROID = DefaultCSSClassProvider.create ("bi-android");
  public static final ICSSClassProvider BI_ANDROID2 = DefaultCSSClassProvider.create ("bi-android2");
  ...
  public static final ICSSClassProvider BI_ARROWS = DefaultCSSClassProvider.create ("bi-arrows");
  ...
  public static final ICSSClassProvider BI_ARROWS_COLLAPSE_VERTICAL = DefaultCSSClassProvider.create ("bi-arrows-collapse-vertical");
  public static final ICSSClassProvider BI_ARROWS_EXPAND = DefaultCSSClassProvider.create ("bi-arrows-expand");
  public static final ICSSClassProvider BI_ARROWS_EXPAND_VERTICAL = DefaultCSSClassProvider.create ("bi-arrows-expand-vertical");
  ...
  public static final ICSSClassProvider BI_ARROWS_VERTICAL = DefaultCSSClassProvider.create ("bi-arrows-vertical");
  ...
  public static final ICSSClassProvider BI_BACKPACK = DefaultCSSClassProvider.create ("bi-backpack");
  public static final ICSSClassProvider BI_BACKPACK_FILL = DefaultCSSClassProvider.create ("bi-backpack-fill");
  public static final ICSSClassProvider BI_BACKPACK2 = DefaultCSSClassProvider.create ("bi-backpack2");
  public static final ICSSClassProvider BI_BACKPACK2_FILL = DefaultCSSClassProvider.create ("bi-backpack2-fill");
  public static final ICSSClassProvider BI_BACKPACK3 = DefaultCSSClassProvider.create ("bi-backpack3");
  public static final ICSSClassProvider BI_BACKPACK3_FILL = DefaultCSSClassProvider.create ("bi-backpack3-fill");
  public static final ICSSClassProvider BI_BACKPACK4 = DefaultCSSClassProvider.create ("bi-backpack4");
  public static final ICSSClassProvider BI_BACKPACK4_FILL = DefaultCSSClassProvider.create ("bi-backpack4-fill");
  ...
  public static final ICSSClassProvider BI_BAN = DefaultCSSClassProvider.create ("bi-ban");
  public static final ICSSClassProvider BI_BAN_FILL = DefaultCSSClassProvider.create ("bi-ban-fill");
  ...
  public static final ICSSClassProvider BI_BING = DefaultCSSClassProvider.create ("bi-bing");
  ...
  public static final ICSSClassProvider BI_BOX_FILL = DefaultCSSClassProvider.create ("bi-box-fill");
  public static final ICSSClassProvider BI_BOX_SEAM = DefaultCSSClassProvider.create ("bi-box-seam");
  public static final ICSSClassProvider BI_BOX_SEAM_FILL = DefaultCSSClassProvider.create ("bi-box-seam-fill");
  ...
  public static final ICSSClassProvider BI_BRILLIANCE = DefaultCSSClassProvider.create ("bi-brilliance");
  ...
  public static final ICSSClassProvider BI_BROWSER_CHROME = DefaultCSSClassProvider.create ("bi-browser-chrome");
  public static final ICSSClassProvider BI_BROWSER_EDGE = DefaultCSSClassProvider.create ("bi-browser-edge");
  public static final ICSSClassProvider BI_BROWSER_FIREFOX = DefaultCSSClassProvider.create ("bi-browser-firefox");
  public static final ICSSClassProvider BI_BROWSER_SAFARI = DefaultCSSClassProvider.create ("bi-browser-safari");
  ...
  public static final ICSSClassProvider BI_BUILDING_ADD = DefaultCSSClassProvider.create ("bi-building-add");
  public static final ICSSClassProvider BI_BUILDING_CHECK = DefaultCSSClassProvider.create ("bi-building-check");
  public static final ICSSClassProvider BI_BUILDING_DASH = DefaultCSSClassProvider.create ("bi-building-dash");
  public static final ICSSClassProvider BI_BUILDING_DOWN = DefaultCSSClassProvider.create ("bi-building-down");
  public static final ICSSClassProvider BI_BUILDING_EXCLAMATION = DefaultCSSClassProvider.create ("bi-building-exclamation");
  public static final ICSSClassProvider BI_BUILDING_FILL = DefaultCSSClassProvider.create ("bi-building-fill");
  public static final ICSSClassProvider BI_BUILDING_FILL_ADD = DefaultCSSClassProvider.create ("bi-building-fill-add");
  public static final ICSSClassProvider BI_BUILDING_FILL_CHECK = DefaultCSSClassProvider.create ("bi-building-fill-check");
  public static final ICSSClassProvider BI_BUILDING_FILL_DASH = DefaultCSSClassProvider.create ("bi-building-fill-dash");
  public static final ICSSClassProvider BI_BUILDING_FILL_DOWN = DefaultCSSClassProvider.create ("bi-building-fill-down");
  public static final ICSSClassProvider BI_BUILDING_FILL_EXCLAMATION = DefaultCSSClassProvider.create ("bi-building-fill-exclamation");
  public static final ICSSClassProvider BI_BUILDING_FILL_GEAR = DefaultCSSClassProvider.create ("bi-building-fill-gear");
  public static final ICSSClassProvider BI_BUILDING_FILL_LOCK = DefaultCSSClassProvider.create ("bi-building-fill-lock");
  public static final ICSSClassProvider BI_BUILDING_FILL_SLASH = DefaultCSSClassProvider.create ("bi-building-fill-slash");
  public static final ICSSClassProvider BI_BUILDING_FILL_UP = DefaultCSSClassProvider.create ("bi-building-fill-up");
  public static final ICSSClassProvider BI_BUILDING_FILL_X = DefaultCSSClassProvider.create ("bi-building-fill-x");
  public static final ICSSClassProvider BI_BUILDING_GEAR = DefaultCSSClassProvider.create ("bi-building-gear");
  public static final ICSSClassProvider BI_BUILDING_LOCK = DefaultCSSClassProvider.create ("bi-building-lock");
  public static final ICSSClassProvider BI_BUILDING_SLASH = DefaultCSSClassProvider.create ("bi-building-slash");
  public static final ICSSClassProvider BI_BUILDING_UP = DefaultCSSClassProvider.create ("bi-building-up");
  public static final ICSSClassProvider BI_BUILDING_X = DefaultCSSClassProvider.create ("bi-building-x");
  public static final ICSSClassProvider BI_BUILDINGS = DefaultCSSClassProvider.create ("bi-buildings");
  public static final ICSSClassProvider BI_BUILDINGS_FILL = DefaultCSSClassProvider.create ("bi-buildings-fill");
  public static final ICSSClassProvider BI_BULLSEYE = DefaultCSSClassProvider.create ("bi-bullseye");
  public static final ICSSClassProvider BI_BUS_FRONT = DefaultCSSClassProvider.create ("bi-bus-front");
  public static final ICSSClassProvider BI_BUS_FRONT_FILL = DefaultCSSClassProvider.create ("bi-bus-front-fill");
  public static final ICSSClassProvider BI_C_CIRCLE = DefaultCSSClassProvider.create ("bi-c-circle");
  public static final ICSSClassProvider BI_C_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-c-circle-fill");
  public static final ICSSClassProvider BI_C_SQUARE = DefaultCSSClassProvider.create ("bi-c-square");
  public static final ICSSClassProvider BI_C_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-c-square-fill");
  public static final ICSSClassProvider BI_CAKE = DefaultCSSClassProvider.create ("bi-cake");
  public static final ICSSClassProvider BI_CAKE_FILL = DefaultCSSClassProvider.create ("bi-cake-fill");
  public static final ICSSClassProvider BI_CAKE2 = DefaultCSSClassProvider.create ("bi-cake2");
  public static final ICSSClassProvider BI_CAKE2_FILL = DefaultCSSClassProvider.create ("bi-cake2-fill");
  ...
  public static final ICSSClassProvider BI_CAPSULE = DefaultCSSClassProvider.create ("bi-capsule");
  public static final ICSSClassProvider BI_CAPSULE_PILL = DefaultCSSClassProvider.create ("bi-capsule-pill");
  public static final ICSSClassProvider BI_CAR_FRONT = DefaultCSSClassProvider.create ("bi-car-front");
  public static final ICSSClassProvider BI_CAR_FRONT_FILL = DefaultCSSClassProvider.create ("bi-car-front-fill");
  ...
  public static final ICSSClassProvider BI_CASSETTE = DefaultCSSClassProvider.create ("bi-cassette");
  public static final ICSSClassProvider BI_CASSETTE_FILL = DefaultCSSClassProvider.create ("bi-cassette-fill");
  public static final ICSSClassProvider BI_CAST = DefaultCSSClassProvider.create ("bi-cast");
  public static final ICSSClassProvider BI_CC_CIRCLE = DefaultCSSClassProvider.create ("bi-cc-circle");
  public static final ICSSClassProvider BI_CC_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-cc-circle-fill");
  public static final ICSSClassProvider BI_CC_SQUARE = DefaultCSSClassProvider.create ("bi-cc-square");
  public static final ICSSClassProvider BI_CC_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-cc-square-fill");
  ...
  public static final ICSSClassProvider BI_COOKIE = DefaultCSSClassProvider.create ("bi-cookie");
  public static final ICSSClassProvider BI_COPY = DefaultCSSClassProvider.create ("bi-copy");
  ...
  public static final ICSSClassProvider BI_CROSSHAIR = DefaultCSSClassProvider.create ("bi-crosshair");
  public static final ICSSClassProvider BI_CROSSHAIR2 = DefaultCSSClassProvider.create ("bi-crosshair2");
  ...
  public static final ICSSClassProvider BI_CUP_HOT = DefaultCSSClassProvider.create ("bi-cup-hot");
  public static final ICSSClassProvider BI_CUP_HOT_FILL = DefaultCSSClassProvider.create ("bi-cup-hot-fill");
  ...
  public static final ICSSClassProvider BI_CURRENCY_RUPEE = DefaultCSSClassProvider.create ("bi-currency-rupee");
  ...
  public static final ICSSClassProvider BI_DATABASE = DefaultCSSClassProvider.create ("bi-database");
  public static final ICSSClassProvider BI_DATABASE_ADD = DefaultCSSClassProvider.create ("bi-database-add");
  public static final ICSSClassProvider BI_DATABASE_CHECK = DefaultCSSClassProvider.create ("bi-database-check");
  public static final ICSSClassProvider BI_DATABASE_DASH = DefaultCSSClassProvider.create ("bi-database-dash");
  public static final ICSSClassProvider BI_DATABASE_DOWN = DefaultCSSClassProvider.create ("bi-database-down");
  public static final ICSSClassProvider BI_DATABASE_EXCLAMATION = DefaultCSSClassProvider.create ("bi-database-exclamation");
  public static final ICSSClassProvider BI_DATABASE_FILL = DefaultCSSClassProvider.create ("bi-database-fill");
  public static final ICSSClassProvider BI_DATABASE_FILL_ADD = DefaultCSSClassProvider.create ("bi-database-fill-add");
  public static final ICSSClassProvider BI_DATABASE_FILL_CHECK = DefaultCSSClassProvider.create ("bi-database-fill-check");
  public static final ICSSClassProvider BI_DATABASE_FILL_DASH = DefaultCSSClassProvider.create ("bi-database-fill-dash");
  public static final ICSSClassProvider BI_DATABASE_FILL_DOWN = DefaultCSSClassProvider.create ("bi-database-fill-down");
  public static final ICSSClassProvider BI_DATABASE_FILL_EXCLAMATION = DefaultCSSClassProvider.create ("bi-database-fill-exclamation");
  public static final ICSSClassProvider BI_DATABASE_FILL_GEAR = DefaultCSSClassProvider.create ("bi-database-fill-gear");
  public static final ICSSClassProvider BI_DATABASE_FILL_LOCK = DefaultCSSClassProvider.create ("bi-database-fill-lock");
  public static final ICSSClassProvider BI_DATABASE_FILL_SLASH = DefaultCSSClassProvider.create ("bi-database-fill-slash");
  public static final ICSSClassProvider BI_DATABASE_FILL_UP = DefaultCSSClassProvider.create ("bi-database-fill-up");
  public static final ICSSClassProvider BI_DATABASE_FILL_X = DefaultCSSClassProvider.create ("bi-database-fill-x");
  public static final ICSSClassProvider BI_DATABASE_GEAR = DefaultCSSClassProvider.create ("bi-database-gear");
  public static final ICSSClassProvider BI_DATABASE_LOCK = DefaultCSSClassProvider.create ("bi-database-lock");
  public static final ICSSClassProvider BI_DATABASE_SLASH = DefaultCSSClassProvider.create ("bi-database-slash");
  public static final ICSSClassProvider BI_DATABASE_UP = DefaultCSSClassProvider.create ("bi-database-up");
  public static final ICSSClassProvider BI_DATABASE_X = DefaultCSSClassProvider.create ("bi-database-x");
  ...
  public static final ICSSClassProvider BI_DROPBOX = DefaultCSSClassProvider.create ("bi-dropbox");
  ...
  public static final ICSSClassProvider BI_DUFFLE = DefaultCSSClassProvider.create ("bi-duffle");
  public static final ICSSClassProvider BI_DUFFLE_FILL = DefaultCSSClassProvider.create ("bi-duffle-fill");
  ...
  public static final ICSSClassProvider BI_EMOJI_ASTONISHED = DefaultCSSClassProvider.create ("bi-emoji-astonished");
  public static final ICSSClassProvider BI_EMOJI_ASTONISHED_FILL = DefaultCSSClassProvider.create ("bi-emoji-astonished-fill");
  ...
  public static final ICSSClassProvider BI_EMOJI_GRIMACE = DefaultCSSClassProvider.create ("bi-emoji-grimace");
  public static final ICSSClassProvider BI_EMOJI_GRIMACE_FILL = DefaultCSSClassProvider.create ("bi-emoji-grimace-fill");
  public static final ICSSClassProvider BI_EMOJI_GRIN = DefaultCSSClassProvider.create ("bi-emoji-grin");
  public static final ICSSClassProvider BI_EMOJI_GRIN_FILL = DefaultCSSClassProvider.create ("bi-emoji-grin-fill");
  ...
  public static final ICSSClassProvider BI_EMOJI_SURPRISE = DefaultCSSClassProvider.create ("bi-emoji-surprise");
  public static final ICSSClassProvider BI_EMOJI_SURPRISE_FILL = DefaultCSSClassProvider.create ("bi-emoji-surprise-fill");
  public static final ICSSClassProvider BI_EMOJI_TEAR = DefaultCSSClassProvider.create ("bi-emoji-tear");
  public static final ICSSClassProvider BI_EMOJI_TEAR_FILL = DefaultCSSClassProvider.create ("bi-emoji-tear-fill");
  ...
  public static final ICSSClassProvider BI_ENVELOPE_ARROW_DOWN = DefaultCSSClassProvider.create ("bi-envelope-arrow-down");
  public static final ICSSClassProvider BI_ENVELOPE_ARROW_DOWN_FILL = DefaultCSSClassProvider.create ("bi-envelope-arrow-down-fill");
  public static final ICSSClassProvider BI_ENVELOPE_ARROW_UP = DefaultCSSClassProvider.create ("bi-envelope-arrow-up");
  public static final ICSSClassProvider BI_ENVELOPE_ARROW_UP_FILL = DefaultCSSClassProvider.create ("bi-envelope-arrow-up-fill");
  public static final ICSSClassProvider BI_ENVELOPE_AT = DefaultCSSClassProvider.create ("bi-envelope-at");
  public static final ICSSClassProvider BI_ENVELOPE_AT_FILL = DefaultCSSClassProvider.create ("bi-envelope-at-fill");
  ...
  public static final ICSSClassProvider BI_ESCAPE = DefaultCSSClassProvider.create ("bi-escape");
  public static final ICSSClassProvider BI_ETHERNET = DefaultCSSClassProvider.create ("bi-ethernet");
  public static final ICSSClassProvider BI_EV_FRONT = DefaultCSSClassProvider.create ("bi-ev-front");
  public static final ICSSClassProvider BI_EV_FRONT_FILL = DefaultCSSClassProvider.create ("bi-ev-front-fill");
  public static final ICSSClassProvider BI_EV_STATION = DefaultCSSClassProvider.create ("bi-ev-station");
  public static final ICSSClassProvider BI_EV_STATION_FILL = DefaultCSSClassProvider.create ("bi-ev-station-fill");
  ...
  public static final ICSSClassProvider BI_EXPOSURE = DefaultCSSClassProvider.create ("bi-exposure");
  ...
  public static final ICSSClassProvider BI_FAST_FORWARD = DefaultCSSClassProvider.create ("bi-fast-forward");
  public static final ICSSClassProvider BI_FAST_FORWARD_BTN = DefaultCSSClassProvider.create ("bi-fast-forward-btn");
  public static final ICSSClassProvider BI_FAST_FORWARD_BTN_FILL = DefaultCSSClassProvider.create ("bi-fast-forward-btn-fill");
  public static final ICSSClassProvider BI_FAST_FORWARD_CIRCLE = DefaultCSSClassProvider.create ("bi-fast-forward-circle");
  public static final ICSSClassProvider BI_FAST_FORWARD_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-fast-forward-circle-fill");
  public static final ICSSClassProvider BI_FAST_FORWARD_FILL = DefaultCSSClassProvider.create ("bi-fast-forward-fill");
  public static final ICSSClassProvider BI_FEATHER = DefaultCSSClassProvider.create ("bi-feather");
  public static final ICSSClassProvider BI_FEATHER2 = DefaultCSSClassProvider.create ("bi-feather2");
  ...
  public static final ICSSClassProvider BI_FILETYPE_SQL = DefaultCSSClassProvider.create ("bi-filetype-sql");
  ...
  public static final ICSSClassProvider BI_FIRE = DefaultCSSClassProvider.create ("bi-fire");
  ...
  public static final ICSSClassProvider BI_FLOPPY = DefaultCSSClassProvider.create ("bi-floppy");
  public static final ICSSClassProvider BI_FLOPPY_FILL = DefaultCSSClassProvider.create ("bi-floppy-fill");
  public static final ICSSClassProvider BI_FLOPPY2 = DefaultCSSClassProvider.create ("bi-floppy2");
  public static final ICSSClassProvider BI_FLOPPY2_FILL = DefaultCSSClassProvider.create ("bi-floppy2-fill");
  ...
  public static final ICSSClassProvider BI_FUEL_PUMP = DefaultCSSClassProvider.create ("bi-fuel-pump");
  public static final ICSSClassProvider BI_FUEL_PUMP_DIESEL = DefaultCSSClassProvider.create ("bi-fuel-pump-diesel");
  public static final ICSSClassProvider BI_FUEL_PUMP_DIESEL_FILL = DefaultCSSClassProvider.create ("bi-fuel-pump-diesel-fill");
  public static final ICSSClassProvider BI_FUEL_PUMP_FILL = DefaultCSSClassProvider.create ("bi-fuel-pump-fill");
  ...
  public static final ICSSClassProvider BI_GENDER_NEUTER = DefaultCSSClassProvider.create ("bi-gender-neuter");
  ...
  public static final ICSSClassProvider BI_GITLAB = DefaultCSSClassProvider.create ("bi-gitlab");
  public static final ICSSClassProvider BI_GLOBE = DefaultCSSClassProvider.create ("bi-globe");
  public static final ICSSClassProvider BI_GLOBE_AMERICAS = DefaultCSSClassProvider.create ("bi-globe-americas");
  public static final ICSSClassProvider BI_GLOBE_ASIA_AUSTRALIA = DefaultCSSClassProvider.create ("bi-globe-asia-australia");
  public static final ICSSClassProvider BI_GLOBE_CENTRAL_SOUTH_ASIA = DefaultCSSClassProvider.create ("bi-globe-central-south-asia");
  public static final ICSSClassProvider BI_GLOBE_EUROPE_AFRICA = DefaultCSSClassProvider.create ("bi-globe-europe-africa");
  ...
  public static final ICSSClassProvider BI_GOOGLE_PLAY = DefaultCSSClassProvider.create ("bi-google-play");
  ...
  public static final ICSSClassProvider BI_H_CIRCLE = DefaultCSSClassProvider.create ("bi-h-circle");
  public static final ICSSClassProvider BI_H_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-h-circle-fill");
  public static final ICSSClassProvider BI_H_SQUARE = DefaultCSSClassProvider.create ("bi-h-square");
  public static final ICSSClassProvider BI_H_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-h-square-fill");
  ...
  public static final ICSSClassProvider BI_HIGHLIGHTER = DefaultCSSClassProvider.create ("bi-highlighter");
  public static final ICSSClassProvider BI_HIGHLIGHTS = DefaultCSSClassProvider.create ("bi-highlights");
  ...
  public static final ICSSClassProvider BI_HOUSE_ADD = DefaultCSSClassProvider.create ("bi-house-add");
  public static final ICSSClassProvider BI_HOUSE_ADD_FILL = DefaultCSSClassProvider.create ("bi-house-add-fill");
  public static final ICSSClassProvider BI_HOUSE_CHECK = DefaultCSSClassProvider.create ("bi-house-check");
  public static final ICSSClassProvider BI_HOUSE_CHECK_FILL = DefaultCSSClassProvider.create ("bi-house-check-fill");
  public static final ICSSClassProvider BI_HOUSE_DASH = DefaultCSSClassProvider.create ("bi-house-dash");
  public static final ICSSClassProvider BI_HOUSE_DASH_FILL = DefaultCSSClassProvider.create ("bi-house-dash-fill");
  ...
  public static final ICSSClassProvider BI_HOUSE_DOWN = DefaultCSSClassProvider.create ("bi-house-down");
  public static final ICSSClassProvider BI_HOUSE_DOWN_FILL = DefaultCSSClassProvider.create ("bi-house-down-fill");
  public static final ICSSClassProvider BI_HOUSE_EXCLAMATION = DefaultCSSClassProvider.create ("bi-house-exclamation");
  public static final ICSSClassProvider BI_HOUSE_EXCLAMATION_FILL = DefaultCSSClassProvider.create ("bi-house-exclamation-fill");
  public static final ICSSClassProvider BI_HOUSE_FILL = DefaultCSSClassProvider.create ("bi-house-fill");
  public static final ICSSClassProvider BI_HOUSE_GEAR = DefaultCSSClassProvider.create ("bi-house-gear");
  public static final ICSSClassProvider BI_HOUSE_GEAR_FILL = DefaultCSSClassProvider.create ("bi-house-gear-fill");
  ...
  public static final ICSSClassProvider BI_HOUSE_LOCK = DefaultCSSClassProvider.create ("bi-house-lock");
  public static final ICSSClassProvider BI_HOUSE_LOCK_FILL = DefaultCSSClassProvider.create ("bi-house-lock-fill");
  public static final ICSSClassProvider BI_HOUSE_SLASH = DefaultCSSClassProvider.create ("bi-house-slash");
  public static final ICSSClassProvider BI_HOUSE_SLASH_FILL = DefaultCSSClassProvider.create ("bi-house-slash-fill");
  public static final ICSSClassProvider BI_HOUSE_UP = DefaultCSSClassProvider.create ("bi-house-up");
  public static final ICSSClassProvider BI_HOUSE_UP_FILL = DefaultCSSClassProvider.create ("bi-house-up-fill");
  public static final ICSSClassProvider BI_HOUSE_X = DefaultCSSClassProvider.create ("bi-house-x");
  public static final ICSSClassProvider BI_HOUSE_X_FILL = DefaultCSSClassProvider.create ("bi-house-x-fill");
  public static final ICSSClassProvider BI_HOUSES = DefaultCSSClassProvider.create ("bi-houses");
  public static final ICSSClassProvider BI_HOUSES_FILL = DefaultCSSClassProvider.create ("bi-houses-fill");
  ...
  public static final ICSSClassProvider BI_INDENT = DefaultCSSClassProvider.create ("bi-indent");
  ...
  public static final ICSSClassProvider BI_LUGGAGE = DefaultCSSClassProvider.create ("bi-luggage");
  public static final ICSSClassProvider BI_LUGGAGE_FILL = DefaultCSSClassProvider.create ("bi-luggage-fill");
  public static final ICSSClassProvider BI_LUNGS = DefaultCSSClassProvider.create ("bi-lungs");
  public static final ICSSClassProvider BI_LUNGS_FILL = DefaultCSSClassProvider.create ("bi-lungs-fill");
  ...
  public static final ICSSClassProvider BI_MAILBOX_FLAG = DefaultCSSClassProvider.create ("bi-mailbox-flag");
  public static final ICSSClassProvider BI_MAILBOX2 = DefaultCSSClassProvider.create ("bi-mailbox2");
  public static final ICSSClassProvider BI_MAILBOX2_FLAG = DefaultCSSClassProvider.create ("bi-mailbox2-flag");
  ...
  public static final ICSSClassProvider BI_MARKER_TIP = DefaultCSSClassProvider.create ("bi-marker-tip");
  ...
  public static final ICSSClassProvider BI_MICROSOFT_TEAMS = DefaultCSSClassProvider.create ("bi-microsoft-teams");
  ...
  public static final ICSSClassProvider BI_NOISE_REDUCTION = DefaultCSSClassProvider.create ("bi-noise-reduction");
  ...
  public static final ICSSClassProvider BI_NVIDIA = DefaultCSSClassProvider.create ("bi-nvidia");
  public static final ICSSClassProvider BI_NVME = DefaultCSSClassProvider.create ("bi-nvme");
  public static final ICSSClassProvider BI_NVME_FILL = DefaultCSSClassProvider.create ("bi-nvme-fill");
  ...
  public static final ICSSClassProvider BI_OPENCOLLECTIVE = DefaultCSSClassProvider.create ("bi-opencollective");
  ...
  public static final ICSSClassProvider BI_P_CIRCLE = DefaultCSSClassProvider.create ("bi-p-circle");
  public static final ICSSClassProvider BI_P_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-p-circle-fill");
  public static final ICSSClassProvider BI_P_SQUARE = DefaultCSSClassProvider.create ("bi-p-square");
  public static final ICSSClassProvider BI_P_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-p-square-fill");
  ...
  public static final ICSSClassProvider BI_PASS = DefaultCSSClassProvider.create ("bi-pass");
  public static final ICSSClassProvider BI_PASS_FILL = DefaultCSSClassProvider.create ("bi-pass-fill");
  public static final ICSSClassProvider BI_PASSPORT = DefaultCSSClassProvider.create ("bi-passport");
  public static final ICSSClassProvider BI_PASSPORT_FILL = DefaultCSSClassProvider.create ("bi-passport-fill");
  ...
  public static final ICSSClassProvider BI_PCI_CARD_NETWORK = DefaultCSSClassProvider.create ("bi-pci-card-network");
  public static final ICSSClassProvider BI_PCI_CARD_SOUND = DefaultCSSClassProvider.create ("bi-pci-card-sound");
  ...
  public static final ICSSClassProvider BI_PERSON_ADD = DefaultCSSClassProvider.create ("bi-person-add");
  public static final ICSSClassProvider BI_PERSON_ARMS_UP = DefaultCSSClassProvider.create ("bi-person-arms-up");
  ...
  public static final ICSSClassProvider BI_PERSON_DOWN = DefaultCSSClassProvider.create ("bi-person-down");
  public static final ICSSClassProvider BI_PERSON_EXCLAMATION = DefaultCSSClassProvider.create ("bi-person-exclamation");
  public static final ICSSClassProvider BI_PERSON_FILL = DefaultCSSClassProvider.create ("bi-person-fill");
  public static final ICSSClassProvider BI_PERSON_FILL_ADD = DefaultCSSClassProvider.create ("bi-person-fill-add");
  public static final ICSSClassProvider BI_PERSON_FILL_CHECK = DefaultCSSClassProvider.create ("bi-person-fill-check");
  public static final ICSSClassProvider BI_PERSON_FILL_DASH = DefaultCSSClassProvider.create ("bi-person-fill-dash");
  public static final ICSSClassProvider BI_PERSON_FILL_DOWN = DefaultCSSClassProvider.create ("bi-person-fill-down");
  public static final ICSSClassProvider BI_PERSON_FILL_EXCLAMATION = DefaultCSSClassProvider.create ("bi-person-fill-exclamation");
  public static final ICSSClassProvider BI_PERSON_FILL_GEAR = DefaultCSSClassProvider.create ("bi-person-fill-gear");
  public static final ICSSClassProvider BI_PERSON_FILL_LOCK = DefaultCSSClassProvider.create ("bi-person-fill-lock");
  public static final ICSSClassProvider BI_PERSON_FILL_SLASH = DefaultCSSClassProvider.create ("bi-person-fill-slash");
  public static final ICSSClassProvider BI_PERSON_FILL_UP = DefaultCSSClassProvider.create ("bi-person-fill-up");
  public static final ICSSClassProvider BI_PERSON_FILL_X = DefaultCSSClassProvider.create ("bi-person-fill-x");
  public static final ICSSClassProvider BI_PERSON_GEAR = DefaultCSSClassProvider.create ("bi-person-gear");
  ...
  public static final ICSSClassProvider BI_PERSON_LOCK = DefaultCSSClassProvider.create ("bi-person-lock");
  ...
  public static final ICSSClassProvider BI_PERSON_RAISED_HAND = DefaultCSSClassProvider.create ("bi-person-raised-hand");
  public static final ICSSClassProvider BI_PERSON_ROLODEX = DefaultCSSClassProvider.create ("bi-person-rolodex");
  public static final ICSSClassProvider BI_PERSON_SLASH = DefaultCSSClassProvider.create ("bi-person-slash");
  public static final ICSSClassProvider BI_PERSON_SQUARE = DefaultCSSClassProvider.create ("bi-person-square");
  public static final ICSSClassProvider BI_PERSON_STANDING = DefaultCSSClassProvider.create ("bi-person-standing");
  public static final ICSSClassProvider BI_PERSON_STANDING_DRESS = DefaultCSSClassProvider.create ("bi-person-standing-dress");
  public static final ICSSClassProvider BI_PERSON_UP = DefaultCSSClassProvider.create ("bi-person-up");
  public static final ICSSClassProvider BI_PERSON_VCARD = DefaultCSSClassProvider.create ("bi-person-vcard");
  public static final ICSSClassProvider BI_PERSON_VCARD_FILL = DefaultCSSClassProvider.create ("bi-person-vcard-fill");
  ...
  public static final ICSSClassProvider BI_PERSON_WALKING = DefaultCSSClassProvider.create ("bi-person-walking");
  public static final ICSSClassProvider BI_PERSON_WHEELCHAIR = DefaultCSSClassProvider.create ("bi-person-wheelchair");
  ...
  public static final ICSSClassProvider BI_PRESCRIPTION = DefaultCSSClassProvider.create ("bi-prescription");
  public static final ICSSClassProvider BI_PRESCRIPTION2 = DefaultCSSClassProvider.create ("bi-prescription2");
  ...
  public static final ICSSClassProvider BI_R_CIRCLE = DefaultCSSClassProvider.create ("bi-r-circle");
  public static final ICSSClassProvider BI_R_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-r-circle-fill");
  public static final ICSSClassProvider BI_R_SQUARE = DefaultCSSClassProvider.create ("bi-r-square");
  public static final ICSSClassProvider BI_R_SQUARE_FILL = DefaultCSSClassProvider.create ("bi-r-square-fill");
  public static final ICSSClassProvider BI_RADAR = DefaultCSSClassProvider.create ("bi-radar");
  ...
  public static final ICSSClassProvider BI_REGEX = DefaultCSSClassProvider.create ("bi-regex");
  public static final ICSSClassProvider BI_REPEAT = DefaultCSSClassProvider.create ("bi-repeat");
  public static final ICSSClassProvider BI_REPEAT_1 = DefaultCSSClassProvider.create ("bi-repeat-1");
  ...
  public static final ICSSClassProvider BI_REWIND = DefaultCSSClassProvider.create ("bi-rewind");
  public static final ICSSClassProvider BI_REWIND_BTN = DefaultCSSClassProvider.create ("bi-rewind-btn");
  public static final ICSSClassProvider BI_REWIND_BTN_FILL = DefaultCSSClassProvider.create ("bi-rewind-btn-fill");
  public static final ICSSClassProvider BI_REWIND_CIRCLE = DefaultCSSClassProvider.create ("bi-rewind-circle");
  public static final ICSSClassProvider BI_REWIND_CIRCLE_FILL = DefaultCSSClassProvider.create ("bi-rewind-circle-fill");
  public static final ICSSClassProvider BI_REWIND_FILL = DefaultCSSClassProvider.create ("bi-rewind-fill");
  public static final ICSSClassProvider BI_ROBOT = DefaultCSSClassProvider.create ("bi-robot");
  public static final ICSSClassProvider BI_ROCKET = DefaultCSSClassProvider.create ("bi-rocket");
  public static final ICSSClassProvider BI_ROCKET_FILL = DefaultCSSClassProvider.create ("bi-rocket-fill");
  public static final ICSSClassProvider BI_ROCKET_TAKEOFF = DefaultCSSClassProvider.create ("bi-rocket-takeoff");
  public static final ICSSClassProvider BI_ROCKET_TAKEOFF_FILL = DefaultCSSClassProvider.create ("bi-rocket-takeoff-fill");
  ...
  public static final ICSSClassProvider BI_SCOOTER = DefaultCSSClassProvider.create ("bi-scooter");
  ...
  public static final ICSSClassProvider BI_SEND_ARROW_DOWN = DefaultCSSClassProvider.create ("bi-send-arrow-down");
  public static final ICSSClassProvider BI_SEND_ARROW_DOWN_FILL = DefaultCSSClassProvider.create ("bi-send-arrow-down-fill");
  public static final ICSSClassProvider BI_SEND_ARROW_UP = DefaultCSSClassProvider.create ("bi-send-arrow-up");
  public static final ICSSClassProvider BI_SEND_ARROW_UP_FILL = DefaultCSSClassProvider.create ("bi-send-arrow-up-fill");
  ...
  public static final ICSSClassProvider BI_SHADOWS = DefaultCSSClassProvider.create ("bi-shadows");
  ...
  public static final ICSSClassProvider BI_SIGN_DEAD_END = DefaultCSSClassProvider.create ("bi-sign-dead-end");
  public static final ICSSClassProvider BI_SIGN_DEAD_END_FILL = DefaultCSSClassProvider.create ("bi-sign-dead-end-fill");
  public static final ICSSClassProvider BI_SIGN_DO_NOT_ENTER = DefaultCSSClassProvider.create ("bi-sign-do-not-enter");
  public static final ICSSClassProvider BI_SIGN_DO_NOT_ENTER_FILL = DefaultCSSClassProvider.create ("bi-sign-do-not-enter-fill");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION = DefaultCSSClassProvider.create ("bi-sign-intersection");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_FILL = DefaultCSSClassProvider.create ("bi-sign-intersection-fill");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_SIDE = DefaultCSSClassProvider.create ("bi-sign-intersection-side");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_SIDE_FILL = DefaultCSSClassProvider.create ("bi-sign-intersection-side-fill");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_T = DefaultCSSClassProvider.create ("bi-sign-intersection-t");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_T_FILL = DefaultCSSClassProvider.create ("bi-sign-intersection-t-fill");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_Y = DefaultCSSClassProvider.create ("bi-sign-intersection-y");
  public static final ICSSClassProvider BI_SIGN_INTERSECTION_Y_FILL = DefaultCSSClassProvider.create ("bi-sign-intersection-y-fill");
  public static final ICSSClassProvider BI_SIGN_MERGE_LEFT = DefaultCSSClassProvider.create ("bi-sign-merge-left");
  public static final ICSSClassProvider BI_SIGN_MERGE_LEFT_FILL = DefaultCSSClassProvider.create ("bi-sign-merge-left-fill");
  public static final ICSSClassProvider BI_SIGN_MERGE_RIGHT = DefaultCSSClassProvider.create ("bi-sign-merge-right");
  public static final ICSSClassProvider BI_SIGN_MERGE_RIGHT_FILL = DefaultCSSClassProvider.create ("bi-sign-merge-right-fill");
  public static final ICSSClassProvider BI_SIGN_NO_LEFT_TURN = DefaultCSSClassProvider.create ("bi-sign-no-left-turn");
  public static final ICSSClassProvider BI_SIGN_NO_LEFT_TURN_FILL = DefaultCSSClassProvider.create ("bi-sign-no-left-turn-fill");
  public static final ICSSClassProvider BI_SIGN_NO_PARKING = DefaultCSSClassProvider.create ("bi-sign-no-parking");
  public static final ICSSClassProvider BI_SIGN_NO_PARKING_FILL = DefaultCSSClassProvider.create ("bi-sign-no-parking-fill");
  public static final ICSSClassProvider BI_SIGN_NO_RIGHT_TURN = DefaultCSSClassProvider.create ("bi-sign-no-right-turn");
  public static final ICSSClassProvider BI_SIGN_NO_RIGHT_TURN_FILL = DefaultCSSClassProvider.create ("bi-sign-no-right-turn-fill");
  public static final ICSSClassProvider BI_SIGN_RAILROAD = DefaultCSSClassProvider.create ("bi-sign-railroad");
  public static final ICSSClassProvider BI_SIGN_RAILROAD_FILL = DefaultCSSClassProvider.create ("bi-sign-railroad-fill");
  public static final ICSSClassProvider BI_SIGN_STOP = DefaultCSSClassProvider.create ("bi-sign-stop");
  public static final ICSSClassProvider BI_SIGN_STOP_FILL = DefaultCSSClassProvider.create ("bi-sign-stop-fill");
  public static final ICSSClassProvider BI_SIGN_STOP_LIGHTS = DefaultCSSClassProvider.create ("bi-sign-stop-lights");
  public static final ICSSClassProvider BI_SIGN_STOP_LIGHTS_FILL = DefaultCSSClassProvider.create ("bi-sign-stop-lights-fill");
  public static final ICSSClassProvider BI_SIGN_TURN_LEFT = DefaultCSSClassProvider.create ("bi-sign-turn-left");
  public static final ICSSClassProvider BI_SIGN_TURN_LEFT_FILL = DefaultCSSClassProvider.create ("bi-sign-turn-left-fill");
  public static final ICSSClassProvider BI_SIGN_TURN_RIGHT = DefaultCSSClassProvider.create ("bi-sign-turn-right");
  public static final ICSSClassProvider BI_SIGN_TURN_RIGHT_FILL = DefaultCSSClassProvider.create ("bi-sign-turn-right-fill");
  public static final ICSSClassProvider BI_SIGN_TURN_SLIGHT_LEFT = DefaultCSSClassProvider.create ("bi-sign-turn-slight-left");
  public static final ICSSClassProvider BI_SIGN_TURN_SLIGHT_LEFT_FILL = DefaultCSSClassProvider.create ("bi-sign-turn-slight-left-fill");
  public static final ICSSClassProvider BI_SIGN_TURN_SLIGHT_RIGHT = DefaultCSSClassProvider.create ("bi-sign-turn-slight-right");
  public static final ICSSClassProvider BI_SIGN_TURN_SLIGHT_RIGHT_FILL = DefaultCSSClassProvider.create ("bi-sign-turn-slight-right-fill");
  public static final ICSSClassProvider BI_SIGN_YIELD = DefaultCSSClassProvider.create ("bi-sign-yield");
  public static final ICSSClassProvider BI_SIGN_YIELD_FILL = DefaultCSSClassProvider.create ("bi-sign-yield-fill");
  ...
  public static final ICSSClassProvider BI_SIM_SLASH = DefaultCSSClassProvider.create ("bi-sim-slash");
  public static final ICSSClassProvider BI_SIM_SLASH_FILL = DefaultCSSClassProvider.create ("bi-sim-slash-fill");
  public static final ICSSClassProvider BI_SINA_WEIBO = DefaultCSSClassProvider.create ("bi-sina-weibo");
  ...
  public static final ICSSClassProvider BI_SOURCEFORGE = DefaultCSSClassProvider.create ("bi-sourceforge");
  ...
  public static final ICSSClassProvider BI_STRIPE = DefaultCSSClassProvider.create ("bi-stripe");
  public static final ICSSClassProvider BI_SUBSCRIPT = DefaultCSSClassProvider.create ("bi-subscript");
  public static final ICSSClassProvider BI_SUBSTACK = DefaultCSSClassProvider.create ("bi-substack");
  ...
  public static final ICSSClassProvider BI_SUITCASE = DefaultCSSClassProvider.create ("bi-suitcase");
  public static final ICSSClassProvider BI_SUITCASE_FILL = DefaultCSSClassProvider.create ("bi-suitcase-fill");
  public static final ICSSClassProvider BI_SUITCASE_LG = DefaultCSSClassProvider.create ("bi-suitcase-lg");
  public static final ICSSClassProvider BI_SUITCASE_LG_FILL = DefaultCSSClassProvider.create ("bi-suitcase-lg-fill");
  public static final ICSSClassProvider BI_SUITCASE2 = DefaultCSSClassProvider.create ("bi-suitcase2");
  public static final ICSSClassProvider BI_SUITCASE2_FILL = DefaultCSSClassProvider.create ("bi-suitcase2-fill");
  ...
  public static final ICSSClassProvider BI_SUPERSCRIPT = DefaultCSSClassProvider.create ("bi-superscript");
  ...
  public static final ICSSClassProvider BI_TAXI_FRONT = DefaultCSSClassProvider.create ("bi-taxi-front");
  public static final ICSSClassProvider BI_TAXI_FRONT_FILL = DefaultCSSClassProvider.create ("bi-taxi-front-fill");
  ...
  public static final ICSSClassProvider BI_TENCENT_QQ = DefaultCSSClassProvider.create ("bi-tencent-qq");
  ...
  public static final ICSSClassProvider BI_TEXT_WRAP = DefaultCSSClassProvider.create ("bi-text-wrap");
  ...
  public static final ICSSClassProvider BI_THREADS = DefaultCSSClassProvider.create ("bi-threads");
  public static final ICSSClassProvider BI_THREADS_FILL = DefaultCSSClassProvider.create ("bi-threads-fill");
  ...
  public static final ICSSClassProvider BI_TRAIN_FREIGHT_FRONT = DefaultCSSClassProvider.create ("bi-train-freight-front");
  public static final ICSSClassProvider BI_TRAIN_FREIGHT_FRONT_FILL = DefaultCSSClassProvider.create ("bi-train-freight-front-fill");
  public static final ICSSClassProvider BI_TRAIN_FRONT = DefaultCSSClassProvider.create ("bi-train-front");
  public static final ICSSClassProvider BI_TRAIN_FRONT_FILL = DefaultCSSClassProvider.create ("bi-train-front-fill");
  public static final ICSSClassProvider BI_TRAIN_LIGHTRAIL_FRONT = DefaultCSSClassProvider.create ("bi-train-lightrail-front");
  public static final ICSSClassProvider BI_TRAIN_LIGHTRAIL_FRONT_FILL = DefaultCSSClassProvider.create ("bi-train-lightrail-front-fill");
  public static final ICSSClassProvider BI_TRANSLATE = DefaultCSSClassProvider.create ("bi-translate");
  public static final ICSSClassProvider BI_TRANSPARENCY = DefaultCSSClassProvider.create ("bi-transparency");
  ...
  public static final ICSSClassProvider BI_TRELLO = DefaultCSSClassProvider.create ("bi-trello");
  ...
  public static final ICSSClassProvider BI_TRUCK_FRONT = DefaultCSSClassProvider.create ("bi-truck-front");
  public static final ICSSClassProvider BI_TRUCK_FRONT_FILL = DefaultCSSClassProvider.create ("bi-truck-front-fill");
  ...
  public static final ICSSClassProvider BI_TWITTER_X = DefaultCSSClassProvider.create ("bi-twitter-x");
  ...
  public static final ICSSClassProvider BI_TYPE_H4 = DefaultCSSClassProvider.create ("bi-type-h4");
  public static final ICSSClassProvider BI_TYPE_H5 = DefaultCSSClassProvider.create ("bi-type-h5");
  public static final ICSSClassProvider BI_TYPE_H6 = DefaultCSSClassProvider.create ("bi-type-h6");
  ...
  public static final ICSSClassProvider BI_UBUNTU = DefaultCSSClassProvider.create ("bi-ubuntu");
  ...
  public static final ICSSClassProvider BI_UNINDENT = DefaultCSSClassProvider.create ("bi-unindent");
  public static final ICSSClassProvider BI_UNION = DefaultCSSClassProvider.create ("bi-union");
  public static final ICSSClassProvider BI_UNITY = DefaultCSSClassProvider.create ("bi-unity");
  public static final ICSSClassProvider BI_UNIVERSAL_ACCESS = DefaultCSSClassProvider.create ("bi-universal-access");
  public static final ICSSClassProvider BI_UNIVERSAL_ACCESS_CIRCLE = DefaultCSSClassProvider.create ("bi-universal-access-circle");
  ...
  public static final ICSSClassProvider BI_VIGNETTE = DefaultCSSClassProvider.create ("bi-vignette");
  ...
  public static final ICSSClassProvider BI_VIRUS = DefaultCSSClassProvider.create ("bi-virus");
  public static final ICSSClassProvider BI_VIRUS2 = DefaultCSSClassProvider.create ("bi-virus2");
  ...
  public static final ICSSClassProvider BI_WECHAT = DefaultCSSClassProvider.create ("bi-wechat");
  ...
  public static final ICSSClassProvider BI_WIKIPEDIA = DefaultCSSClassProvider.create ("bi-wikipedia");
  ...
  public static final ICSSClassProvider BI_YELP = DefaultCSSClassProvider.create ("bi-yelp");
