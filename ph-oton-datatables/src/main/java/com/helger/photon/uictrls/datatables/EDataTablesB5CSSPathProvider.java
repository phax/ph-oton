 ...
 */
public enum EDataTablesB5CSSPathProvider implements ICSSPathProvider
{
  ...
  EDataTablesB5CSSPathProvider (@NonNull @Nonempty final String sPath)
  {
