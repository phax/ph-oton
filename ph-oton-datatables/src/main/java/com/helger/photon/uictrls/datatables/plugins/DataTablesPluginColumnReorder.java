...
public class DataTablesPluginColumnReorder extends AbstractDataTablesPlugin
{
  ...
  {
    PhotonJS.registerJSIncludeForThisRequest (EDataTablesJSPathProvider.DATATABLES_COL_REORDER);
    PhotonCSS.registerCSSIncludeForThisRequest (EDataTablesCSSPathProvider.DATATABLES_COL_REORDER);
  }
}
