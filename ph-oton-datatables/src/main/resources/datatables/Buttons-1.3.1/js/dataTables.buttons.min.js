...
v=b.length;f<v;f++){var l=this._resolveExtends(b[f]);if(l)if(d.isArray(l))this._expandButton(a,l,c,e);else{var t=this._buildButton(l,c);if(t){e!==n?(a.splice(e,0,t),e++):a.push(t);if(t.conf.buttons){var w=this.c.dom.collection;t.collection=d("<"+w.tag+"/>").addClass(w.className).attr("role","menu");t.conf._collection=t.collection;this._expandButton(t.buttons,t.conf.buttons,!0,e)}l.init&&l.init.call(g.button(t.node),g,d(t.node),l);k++}}}},_buildButton:function(a,b){var c=this.c.dom.button,e=this.c.dom.buttonLiner,
g=this.c.dom.collection,k=this.s.dt,f=function(b){return"function"===typeof b?b(k,l,a):b};b&&g.button&&(c=g.button);b&&g.buttonLiner&&(e=g.buttonLiner);if(a.available&&!a.available(k,a))return!1;var v=function(a,b,c,e){e.action.call(b.button(c),a,b,c,e);d(b.table().node()).triggerHandler("buttons-action.dt",[b.button(c),b,c,e])},l=d("<"+c.tag+"/>").addClass(c.className).attr("tabindex",this.s.dt.settings()[0].iTabIndex).attr("aria-controls",this.s.dt.table().node().id).on("click.dtb",function(b){b.preventDefault();
!l.hasClass(c.disabled)&&a.action&&v(b,k,l,a);l.blur()}).on("keyup.dtb",function(b){13===b.keyCode&&!l.hasClass(c.disabled)&&a.action&&v(b,k,l,a)});"a"===c.tag.toLowerCase()&&l.attr("href","#");e.tag?(g=d("<"+e.tag+"/>").html(f(a.text)).addClass(e.className),"a"===e.tag.toLowerCase()&&g.attr("href","#"),l.append(g)):l.html(f(a.text));!1===a.enabled&&l.addClass(c.disabled);a.className&&l.addClass(a.className);a.titleAttr&&l.attr("title",f(a.titleAttr));a.namespace||(a.namespace=".dt-button-"+z++);
...
this._nodeToHost(a,b[c].buttons);if(d)return d}}},_keypress:function(a,b){var c=function(e){for(var g=0,k=e.length;g<k;g++){var f=e[g].conf,v=e[g].node;f.key&&(f.key===a?d(v).click():!d.isPlainObject(f.key)||f.key.key!==a||f.key.shiftKey&&!b.shiftKey||f.key.altKey&&!b.altKey||f.key.ctrlKey&&!b.ctrlKey||f.key.metaKey&&!b.metaKey||d(v).click());e[g].buttons.length&&c(e[g].buttons)}};c(this.s.buttons)},_removeKey:function(a){if(a.key){var b=d.isPlainObject(a.key)?a.key.key:a.key;a=this.s.listenKeys.split("");
...
"none").appendTo("body").fadeIn(c):d("body > div."+b).fadeOut(c,function(){d(this).removeClass(b).remove()})};p.instanceSelector=function(a,b){if(!a)return d.map(b,function(a){return a.inst});var c=[],e=d.map(b,function(a){return a.name}),g=function(a){if(d.isArray(a))for(var f=0,v=a.length;f<v;f++)g(a[f]);else"string"===typeof a?-1!==a.indexOf(",")?g(a.split(",")):(a=d.inArray(d.trim(a),e),-1!==a&&c.push(b[a].inst)):"number"===typeof a&&c.push(b[a].inst)};g(a);return c};p.buttonSelector=function(a,
b){for(var c=[],e=function(a,b,c){for(var d,g,f=0,k=b.length;f<k;f++)if(d=b[f])g=c!==n?c+f:f+"",a.push({node:d.node,name:d.conf.name,idx:g}),d.buttons&&e(a,d.buttons,g+"-")},g=function(a,b){var f,k,h=[];e(h,b.s.buttons);f=d.map(h,function(a){return a.node});if(d.isArray(a)||a instanceof d)for(f=0,k=a.length;f<k;f++)g(a[f],b);else if(null===a||a===n||"*"===a)for(f=0,k=h.length;f<k;f++)c.push({inst:b,node:h[f].node});else if("number"===typeof a)c.push({inst:b,node:b.s.buttons[a].node});else if("string"===
typeof a)if(-1!==a.indexOf(","))for(h=a.split(","),f=0,k=h.length;f<k;f++)g(d.trim(h[f]),b);else if(a.match(/^\d+(\-\d+)*$/))f=d.map(h,function(a){return a.idx}),c.push({inst:b,node:h[d.inArray(a,f)].node});else if(-1!==a.indexOf(":name")){var m=a.replace(":name","");f=0;for(k=h.length;f<k;f++)h[f].name===m&&c.push({inst:b,node:h[f].node})}else d(f).filter(a).each(function(){c.push({inst:b,node:this})});else"object"===typeof a&&a.nodeName&&(h=d.inArray(a,f),-1!==h&&c.push({inst:b,node:f[h]}))},k=
...
this;a.on("length.dt"+c.namespace,function(){d.text(e(a))})},destroy:function(a,b,c){a.off("length.dt"+c.namespace)}}}});h.Api.register("buttons()",function(a,b){b===n&&(b=a,a=n);this.selector.buttonGroup=a;var c=this.iterator(!0,"table",function(c){if(c._buttons)return p.buttonSelector(p.instanceSelector(a,c._buttons),b)},!0);c._groupSelector=a;return c});h.Api.register("button()",function(a,b){var c=this.buttons(a,b);1<c.length&&c.splice(1,c.length);return c});h.Api.registerPlural("buttons().active()",
"button().active()",function(a){return a===n?this.map(function(a){return a.inst.active(a.node)}):this.each(function(b){b.inst.active(b.node,a)})});h.Api.registerPlural("buttons().action()","button().action()",function(a){return a===n?this.map(function(a){return a.inst.action(a.node)}):this.each(function(b){b.inst.action(b.node,a)})});h.Api.register(["buttons().enable()","button().enable()"],function(a){return this.each(function(b){b.inst.enable(b.node,a)})});h.Api.register(["buttons().disable()",
"button().disable()"],function(){return this.each(function(a){a.inst.disable(a.node)})});h.Api.registerPlural("buttons().nodes()","button().node()",function(){var a=d();d(this.each(function(b){a=a.add(b.inst.node(b.node))}));return a});h.Api.registerPlural("buttons().processing()","button().processing()",function(a){return a===n?this.map(function(a){return a.inst.processing(a.node)}):this.each(function(b){b.inst.processing(b.node,a)})});h.Api.registerPlural("buttons().text()","button().text()",function(a){return a===
n?this.map(function(a){return a.inst.text(a.node)}):this.each(function(b){b.inst.text(b.node,a)})});h.Api.registerPlural("buttons().trigger()","button().trigger()",function(){return this.each(function(a){a.inst.node(a.node).trigger("click")})});h.Api.registerPlural("buttons().containers()","buttons().container()",function(){var a=d(),b=this._groupSelector;this.iterator(!0,"table",function(c){if(c._buttons){c=p.instanceSelector(b,c._buttons);for(var d=0,g=c.length;d<g;d++)a=a.add(c[d].container())}});
return a});h.Api.register("button().add()",function(a,b){var c=this.context;c.length&&(c=p.instanceSelector(this._groupSelector,c[0]._buttons),c.length&&c[0].add(b,a));return this.button(this._groupSelector,a)});h.Api.register("buttons().destroy()",function(){this.pluck("inst").unique().each(function(a){a.destroy()});return this});h.Api.registerPlural("buttons().remove()","buttons().remove()",function(){this.each(function(a){a.inst.remove(a.node)});return this});var u;h.Api.register("buttons.info()",
function(a,b,c){var e=this;if(!1===a)return d("#datatables_buttons_info").fadeOut(function(){d(this).remove()}),clearTimeout(u),u=null,this;u&&clearTimeout(u);d("#datatables_buttons_info").length&&d("#datatables_buttons_info").remove();a=a?"<h2>"+a+"</h2>":"";d('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a).append(d("<div/>")["string"===typeof b?"html":"append"](b)).css("display","none").appendTo("body").fadeIn();c!==n&&0!==c&&(u=setTimeout(function(){e.buttons.info(!1)},c));
return this});h.Api.register("buttons.exportData()",function(a){if(this.context.length)return A(new h.Api(this.context[0]),a)});var x=d("<textarea/>")[0],A=function(a,b){for(var c=d.extend(!0,{},{rows:null,columns:"",modifier:{search:"applied",order:"applied"},orthogonal:"display",stripHtml:!0,stripNewlines:!0,decodeEntities:!0,trim:!0,format:{header:function(a){return e(a)},footer:function(a){return e(a)},body:function(a){return e(a)}}},b),e=function(a){if("string"!==typeof a)return a;a=a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
...
h=a.cells(f,c.columns),f=h.render(c.orthogonal).toArray(),h=h.nodes().toArray(),l=g.length,m=0<l?f.length/l:0,p=Array(m),n=0,q=0;q<m;q++){for(var r=Array(l),u=0;u<l;u++)r[u]=c.format.body(f[n],q,u,h[n]),n++;p[q]=r}return{header:g,footer:k,body:p}};d.fn.dataTable.Buttons=p;d.fn.DataTable.Buttons=p;d(r).on("init.dt plugin-init.dt",function(a,b){if("dt"===a.namespace){var c=b.oInit.buttons||h.defaults.buttons;c&&!b._buttons&&(new p(b,c)).container()}});h.ext.feature.push({fnInit:function(a){a=new h.Api(a);
var b=a.init().buttons||h.defaults.buttons;return(new p(a,b)).container()},cFeature:"B"});return p});
