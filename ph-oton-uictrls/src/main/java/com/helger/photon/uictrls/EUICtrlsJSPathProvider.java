...
public enum EUICtrlsJSPathProvider implements IJSPathProvider
{
  ...
  DATATABLES_1_10 ("datatables/1.10.11/js/jquery.dataTables.js"),
  DATATABLES_1_10_BOOTSTRAP ("datatables/1.10.11/js/dataTables.bootstrap.js"),
  DATATABLES_BUTTONS ("datatables/Buttons-1.1.2/js/dataTables.buttons.js"),
  DATATABLES_BUTTONS_COLVIS ("datatables/Buttons-1.1.2/js/buttons.colVis.js"),
  DATATABLES_BUTTONS_FLASH ("datatables/Buttons-1.1.2/js/buttons.flash.js"),
  DATATABLES_BUTTONS_HTML5 ("datatables/Buttons-1.1.2/js/buttons.html5.js"),
  DATATABLES_BUTTONS_PRINT ("datatables/Buttons-1.1.2/js/buttons.print.js"),
  DATATABLES_BUTTONS_BOOTSTRAP ("datatables/Buttons-1.1.2/js/buttons.bootstrap.js"),
  DATATABLES_FIXED_COLUMNS ("datatables/FixedColumns-3.2.1/js/dataTables.fixedColumns.js"),
  DATATABLES_FIXED_HEADER ("datatables/FixedHeader-3.1.1/js/dataTables.fixedHeader.js"),
  DATATABLES_RESPONSIVE ("datatables/Responsive-2.0.2/js/dataTables.responsive.js"),
  DATATABLES_RESPONSIVE_BOOTSTRAP ("datatables/Responsive-2.0.2/js/responsive.bootstrap.js"),
  DATATABLES_ROW_REORDER ("datatables/RowReorder-1.1.1/js/dataTables.rowReorder.js"),
