...
public class DTPButtonsDomButtonContainer
{
  /**
  ...
  @Nonnull
  public DTPButtonsDomButtonContainer setTag (@Nullable final EHTMLElement eTag)
  {
    m_eTag = eTag;
    return this;
  }
  ...
  @Nonnull
  public DTPButtonsDomButtonContainer addClassName (@Nullable final ICSSClassProvider aCSSClassProvider)
  {
  ...
  @Nonnull
  public DTPButtonsDomButtonContainer addClassName (@Nullable final ICSSClassProvider... aCSSClassProviders)
  {
  ...
  @Nonnull
  public DTPButtonsDomButtonContainer addClassName (@Nullable final Iterable <? extends ICSSClassProvider> aCSSClassProviders)
  {
    m_aClassNames.addClasses (aCSSClassProviders);
    return this;
  }
