...
k.version="1.1.1";d.fn.dataTable.RowReorder=k;d.fn.DataTable.RowReorder=k;d(h).on("init.dt.dtr",function(c,b,a){"dt"===c.namespace&&(c=b.oInit.rowReorder,a=l.defaults.rowReorder,c||a)&&(a=d.extend({},c,a),!1!==c&&new k(b,a))});return k});
