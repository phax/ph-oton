...
function(c,b,e,d){var f="css_right ui-icon ui-icon-carat-2-n-s",g=-1!==a.inArray("asc",e.asSorting),h=-1!==a.inArray("desc",e.asSorting);e.bSortable&&(g||h)?g&&!h?f="css_right ui-icon ui-icon-carat-1-n":!g&&h&&(f="css_right ui-icon ui-icon-carat-1-s"):f="";a("<div/>").addClass("DataTables_sort_wrapper").append(b.contents()).append(a("<span/>").addClass(d.sSortIcon+" "+f)).appendTo(b);a(c.nTable).on("order.dt",function(a,g,h,k){c===g&&(a=e.idx,b.removeClass(d.sSortAsc+" "+d.sSortDesc).addClass("asc"==
k[a]?d.sSortAsc:"desc"==k[a]?d.sSortDesc:e.sSortingClass),b.find("span."+d.sSortIcon).removeClass("css_right ui-icon ui-icon-triangle-1-n css_right ui-icon ui-icon-triangle-1-s css_right ui-icon ui-icon-carat-2-n-s css_right ui-icon ui-icon-carat-1-n css_right ui-icon ui-icon-carat-1-s").addClass("asc"==k[a]?"css_right ui-icon ui-icon-triangle-1-n":"desc"==k[a]?"css_right ui-icon ui-icon-triangle-1-s":f))})};c.TableTools&&a.extend(!0,c.TableTools.classes,{container:"DTTT_container ui-buttonset ui-buttonset-multi",
