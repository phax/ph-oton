...
*/
(function(u){"function"===typeof define&&define.amd?define(["jquery"],u):"object"===typeof exports?u(require("jquery")):u(jQuery)})(function(u){var z=function(){if(u&&u.fn&&u.fn.select2&&u.fn.select2.amd)var g=u.fn.select2.amd;(function(){if(!g||!g.requirejs){g?f=g:g={};var e,f,d;(function(c){function b(a,b){var c,m,r,d,e,q,f,k,n,l=b&&b.split("/"),g=w.map,p=g&&g["*"]||{};if(a&&"."===a.charAt(0))if(b){a=a.split("/");e=a.length-1;w.nodeIdCompat&&D.test(a[e])&&(a[e]=a[e].replace(D,""));a=l.slice(0,l.length-
1).concat(a);for(e=0;e<a.length;e+=1)if(c=a[e],"."===c)a.splice(e,1),--e;else if(".."===c)if(1!==e||".."!==a[2]&&".."!==a[0])0<e&&(a.splice(e-1,2),e-=2);else break;a=a.join("/")}else 0===a.indexOf("./")&&(a=a.substring(2));if((l||p)&&g){c=a.split("/");for(e=c.length;0<e;--e){m=c.slice(0,e).join("/");if(l)for(n=l.length;0<n;--n)if(r=g[l.slice(0,n).join("/")])if(r=r[m]){d=r;q=e;break}if(d)break;!f&&p&&p[m]&&(f=p[m],k=e)}!d&&f&&(d=f,q=k);d&&(c.splice(0,q,d),a=c.join("/"))}return a}function a(a,b){return function(){var m=
E.call(arguments,0);"string"!==typeof m[0]&&1===m.length&&m.push(null);return g.apply(c,m.concat([a,b]))}}function m(a){return function(c){return b(c,a)}}function r(a){return function(b){p[a]=b}}function q(a){if(x.call(v,a)){var b=v[a];delete v[a];u[a]=!0;l.apply(c,b)}if(!x.call(p,a)&&!x.call(u,a))throw Error("No "+a);return p[a]}function k(a){var b,c=a?a.indexOf("!"):-1;-1<c&&(b=a.substring(0,c),a=a.substring(c+1,a.length));return[b,a]}function n(a){return function(){return w&&w.config&&w.config[a]||
{}}}var l,g,y,t,p={},v={},w={},u={},x=Object.prototype.hasOwnProperty,E=[].slice,D=/\.js$/;y=function(a,c){var d,r=k(a),e=r[0];a=r[1];e&&(e=b(e,c),d=q(e));e?a=d&&d.normalize?d.normalize(a,m(c)):b(a,c):(a=b(a,c),r=k(a),e=r[0],a=r[1],e&&(d=q(e)));return{f:e?e+"!"+a:a,n:a,pr:e,p:d}};t={require:function(b){return a(b)},exports:function(a){var b=p[a];return"undefined"!==typeof b?b:p[a]={}},module:function(a){return{id:a,uri:"",exports:p[a],config:n(a)}}};l=function(b,m,d,e){var f,k,n,l,h=[];k=typeof d;
var g;e=e||b;if("undefined"===k||"function"===k){m=!m.length&&d.length?["require","exports","module"]:m;for(l=0;l<m.length;l+=1)if(n=y(m[l],e),k=n.f,"require"===k)h[l]=t.require(b);else if("exports"===k)h[l]=t.exports(b),g=!0;else if("module"===k)f=h[l]=t.module(b);else if(x.call(p,k)||x.call(v,k)||x.call(u,k))h[l]=q(k);else if(n.p)n.p.load(n.n,a(e,!0),r(k),{}),h[l]=p[k];else throw Error(b+" missing "+k);m=d?d.apply(p[b],h):void 0;b&&(f&&f.exports!==c&&f.exports!==p[b]?p[b]=f.exports:m===c&&g||(p[b]=
m))}else b&&(p[b]=d)};e=f=g=function(a,b,m,d,r){if("string"===typeof a)return t[a]?t[a](b):q(y(a,b).f);if(!a.splice){w=a;w.deps&&g(w.deps,w.callback);if(!b)return;b.splice?(a=b,b=m,m=null):a=c}b=b||function(){};"function"===typeof m&&(m=d,d=r);d?l(c,a,b,m):setTimeout(function(){l(c,a,b,m)},4);return g};g.config=function(a){return g(a)};e._defined=p;d=function(a,b,c){if("string"!==typeof a)throw Error("See almond README: incorrect module build, no module name");b.splice||(c=b,b=[]);x.call(p,a)||x.call(v,
a)||(v[a]=[a,b,c])};d.amd={jQuery:!0}})();g.requirejs=e;g.require=f;g.define=d}})();g.define("almond",function(){});g.define("jquery",[],function(){var e=u||$;null==e&&console&&console.error&&console.error("Select2: An instance of jQuery or a jQuery-compatible library was not found. Make sure that you are including jQuery before Select2 on your web page.");return e});g.define("select2/utils",["jquery"],function(e){function f(b){b=b.prototype;var a=[],c;for(c in b)"function"===typeof b[c]&&"constructor"!==
c&&a.push(c);return a}var d={Extend:function(b,a){function c(){this.constructor=b}var d={}.hasOwnProperty,e;for(e in a)d.call(a,e)&&(b[e]=a[e]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b},Decorate:function(b,a){function c(){var m=Array.prototype.unshift,d=b.prototype.constructor;0<a.prototype.constructor.length&&(m.call(arguments,b.prototype.constructor),d=a.prototype.constructor);d.apply(this,arguments)}var d=f(a),e=f(b);a.displayName=b.displayName;c.prototype=new function(){this.constructor=
c};for(var k=0;k<e.length;k++){var n=e[k];c.prototype[n]=b.prototype[n]}e=function(b){var d=function(){};b in c.prototype&&(d=c.prototype[b]);var r=a.prototype[b];return function(){Array.prototype.unshift.call(arguments,d);return r.apply(this,arguments)}};for(k=0;k<d.length;k++)n=d[k],c.prototype[n]=e(n);return c}},c=function(){this.listeners={}};c.prototype.on=function(b,a){this.listeners=this.listeners||{};b in this.listeners?this.listeners[b].push(a):this.listeners[b]=[a]};c.prototype.trigger=
...
this.options.get("multiple")&&c.attr("aria-multiselectable","true");return this.$results=c};d.prototype.clear=function(){this.$results.empty()};d.prototype.displayMessage=function(c){var b=this.options.get("escapeMarkup");this.clear();this.hideLoading();var a=e('<li role="treeitem" aria-live="assertive" class="select2-results__option"></li>'),m=this.options.get("translations").get(c.message);a.append(b(m(c.args)));a[0].className+=" select2-results__message";this.$results.append(a)};d.prototype.hideMessages=
...
d.prototype.setClasses=function(){var c=this;this.data.current(function(b){var a=e.map(b,function(a){return a.id.toString()});b=c.$results.find(".select2-results__option[aria-selected]");b.each(function(){var b=e(this),c=e.data(this,"data"),m=""+c.id;null!=c.element&&c.element.selected||null==c.element&&-1<e.inArray(m,a)?b.attr("aria-selected","true"):b.attr("aria-selected","false")});var m=b.filter("[aria-selected=true]");0<m.length?m.first().trigger("mouseenter"):b.first().trigger("mouseenter")})};
...
f.append(d);a.append(m);a.append(f)}else this.template(c,b);e.data(b,"data",c);return b};d.prototype.bind=function(c,b){var a=this;this.$results.attr("id",c.id+"-results");c.on("results:all",function(b){a.clear();a.append(b.data);c.isOpen()&&a.setClasses()});c.on("results:append",function(b){a.append(b.data);c.isOpen()&&a.setClasses()});c.on("query",function(b){a.hideMessages();a.showLoading(b)});c.on("select",function(){c.isOpen()&&a.setClasses()});c.on("unselect",function(){c.isOpen()&&a.setClasses()});
...
1)+"em";this.$search.css("width",b)};return c});g.define("select2/selection/eventRelay",["jquery"],function(e){function f(){}f.prototype.bind=function(d,c,b){var a=this,m="open opening close closing select selecting unselect unselecting".split(" "),f=["opening","closing","selecting","unselecting"];d.call(this,c,b);c.on("*",function(b,c){if(-1!==e.inArray(b,m)){c=c||{};var d=e.Event("select2:"+b,{params:c});a.$element.trigger(d);-1!==e.inArray(b,f)&&(c.prevented=d.isDefaultPrevented())}})};return f});
...
this,e=this.$element.find("option"),q=e.map(function(){return c.item(d(this)).id}).get(),k=[],n=0;n<b.length;n++){var l=this._normalizeItem(b[n]);if(0<=d.inArray(l.id,q)){var g=e.filter(a(l)),y=this.item(g),l=d.extend(!0,{},l,y),l=this.option(l);g.replaceWith(l)}else g=this.option(l),l.children&&(l=this.convertToOptions(l.children),f.appendMany(g,l)),k.push(g)}return k};return c});g.define("select2/data/ajax",["./array","../utils","jquery"],function(e,f,d){function c(b,a){this.ajaxOptions=this._applyDefaults(a.get("ajax"));
...
(f.data=f.data.call(this.$element,b));this.ajaxOptions.delay&&""!==b.term?(this._queryTimeout&&window.clearTimeout(this._queryTimeout),this._queryTimeout=window.setTimeout(c,this.ajaxOptions.delay)):c()};return c});g.define("select2/data/tags",["jquery"],function(e){function f(d,c,b){var a=b.get("tags"),f=b.get("createTag");void 0!==f&&(this.createTag=f);f=b.get("insertTag");void 0!==f&&(this.insertTag=f);d.call(this,c,b);if(e.isArray(a))for(d=0;d<a.length;d++)c=this._normalizeItem(a[d]),c=this.option(c),
this.$element.append(c)}f.prototype.query=function(d,c,b){function a(d,f){for(var k=d.results,n=0;n<k.length;n++){var l=k[n],g=null!=l.children&&!a({results:l.children},!0);if(l.text===c.term||g){if(f)return!1;d.data=k;b(d);return}}if(f)return!0;n=e.createTag(c);null!=n&&(l=e.option(n),l.attr("data-select2-tag",!0),e.addOptions([l]),e.insertTag(k,n));d.results=k;b(d)}var e=this;this._removeOldTags();null==c.term||null!=c.page?d.call(this,c,b):d.call(this,c,a)};f.prototype.createTag=function(d,c){var b=
...
f.prototype.query=function(d,c,b){var a=this;c.term=c.term||"";var e=this.tokenizer(c,this.options,function(b){a.trigger("select",{data:b})});e.term!==c.term&&(this.$search.length&&(this.$search.val(e.term),this.$search.focus()),c.term=e.term);d.call(this,c,b)};f.prototype.tokenizer=function(d,c,b,a){d=b.get("tokenSeparators")||[];b=c.term;for(var f=0,r=this.createTag||function(a){return{id:a.term,text:a.term}};f<b.length;)if(-1===e.inArray(b[f],d))f++;else{var g=b.substr(0,f),g=e.extend({},c,{term:g}),
g=r(g);null==g?f++:(a(g),b=b.substr(f+1)||"",f=0)}return{term:b}};return f});g.define("select2/data/minimumInputLength",[],function(){function e(e,d,c){this.minimumInputLength=c.get("minimumInputLength");e.call(this,d,c)}e.prototype.query=function(e,d,c){d.term=d.term||"";d.term.length<this.minimumInputLength?this.trigger("results:message",{message:"inputTooShort",args:{minimum:this.minimumInputLength,input:d.term,params:d}}):e.call(this,d,c)};return e});g.define("select2/data/maximumInputLength",
...
e("<span></span>");c=c.call(this);b.append(c);return this.$dropdownContainer=b};d.prototype._hideDropdown=function(c){this.$dropdownContainer.detach()};d.prototype._attachPositioningHandler=function(c,b){var a=this,d="scroll.select2."+b.id,r="resize.select2."+b.id,g="orientationchange.select2."+b.id,k=this.$container.parents().filter(f.hasScroll);k.each(function(){e(this).data("select2-scroll-position",{x:e(this).scrollLeft(),y:e(this).scrollTop()})});k.on(d,function(a){a=e(this).data("select2-scroll-position");
e(this).scrollTop(a.y)});e(window).on(d+" "+r+" "+g,function(b){a._positionDropdown();a._resizeDropdown()})};d.prototype._detachPositioningHandler=function(c,b){var a="scroll.select2."+b.id,d="resize.select2."+b.id,r="orientationchange.select2."+b.id;this.$container.parents().filter(f.hasScroll).off(a);e(window).off(a+" "+d+" "+r)};d.prototype._positionDropdown=function(){var c=e(window),b=this.$dropdown.hasClass("select2-dropdown--above"),a=this.$dropdown.hasClass("select2-dropdown--below"),d=null,
f=this.$container.offset();f.bottom=f.top+this.$container.outerHeight(!1);var g=this.$container.outerHeight(!1),k,n;k=f.top;n=f.top+g;var g=this.$dropdown.outerHeight(!1),l=c.scrollTop(),u=c.scrollTop()+c.height(),c=l<f.top-g,l=u>f.bottom+g,f={left:f.left,top:n};n=this.$dropdownParent;"static"===n.css("position")&&(n=n.offsetParent());n=n.offset();f.top-=n.top;f.left-=n.left;b||a||(d="below");l||!c||b?!c&&l&&b&&(d="below"):d="above";if("above"==d||b&&"below"!==d)f.top=k-g;null!=d&&(this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--"+
...
function(e,f,d,c,b,a,m,r,g,k,n,l,u,y,t,p,v,w,N,x,E,D,z,H,J,K,L,M,I){function A(){this.reset()}A.prototype.apply=function(h){h=e.extend(!0,{},this.defaults,h);if(null==h.dataAdapter){h.dataAdapter=null!=h.ajax?t:null!=h.data?y:u;0<h.minimumInputLength&&(h.dataAdapter=k.Decorate(h.dataAdapter,w));0<h.maximumInputLength&&(h.dataAdapter=k.Decorate(h.dataAdapter,N));0<h.maximumSelectionLength&&(h.dataAdapter=k.Decorate(h.dataAdapter,x));h.tags&&(h.dataAdapter=k.Decorate(h.dataAdapter,p));if(null!=h.tokenSeparators||
null!=h.tokenizer)h.dataAdapter=k.Decorate(h.dataAdapter,v);if(null!=h.query){var l=f(h.amdBase+"compat/query");h.dataAdapter=k.Decorate(h.dataAdapter,l)}null!=h.initSelection&&(l=f(h.amdBase+"compat/initSelection"),h.dataAdapter=k.Decorate(h.dataAdapter,l))}null==h.resultsAdapter&&(h.resultsAdapter=d,null!=h.ajax&&(h.resultsAdapter=k.Decorate(h.resultsAdapter,H)),null!=h.placeholder&&(h.resultsAdapter=k.Decorate(h.resultsAdapter,z)),h.selectOnClose&&(h.resultsAdapter=k.Decorate(h.resultsAdapter,
...
(l=h.language.split("-")[0],h.language=[h.language,l]):h.language=[h.language]);if(e.isArray(h.language)){l=new n;h.language.push("en");for(var B=h.language,F=0;F<B.length;F++){var C=B[F],G={};try{G=n.loadPath(C)}catch(A){try{C=this.defaults.amdLanguageBase+C,G=n.loadPath(C)}catch(I){h.debug&&window.console&&console.warn&&console.warn('Select2: The language file for "'+C+'" could not be automatically loaded. A fallback will be used instead.');continue}}l.extend(G)}h.translations=l}else l=n.loadPath(this.defaults.amdLanguageBase+
"en"),B=new n(h.language),B.extend(l),h.translations=B;return h};A.prototype.reset=function(){function a(b){return b.replace(/[^\u0000-\u007E]/g,function(a){return l[a]||a})}function b(c,d){if(""===e.trim(c.term))return d;if(d.children&&0<d.children.length){for(var f=e.extend(!0,{},d),m=d.children.length-1;0<=m;m--)null==b(c,d.children[m])&&f.children.splice(m,1);return 0<f.children.length?f:b(c,f)}f=a(d.text).toUpperCase();m=a(c.term).toUpperCase();return-1<f.indexOf(m)?d:null}this.defaults={amdBase:"./",
...
[],function(){function e(){}e.prototype.bind=function(e,d,c){e.call(this,d,c);this.$selection.on("blur change click dblclick focus focusin focusout input keydown keyup keypress mousedown mouseenter mouseleave mousemove mouseover mouseup search touchend touchstart",function(b){b.stopPropagation()})};return e});(function(e){"function"===typeof g.define&&g.define.amd?g.define("jquery-mousewheel",["jquery"],e):"object"===typeof exports?module.exports=e:e(u)})(function(e){function f(b){var c=b||window.event,
f=a.call(arguments,1),q=0,t=0,p=0,v=0,u=0,z=0;b=e.event.fix(c);b.type="mousewheel";"detail"in c&&(p=-1*c.detail);"wheelDelta"in c&&(p=c.wheelDelta);"wheelDeltaY"in c&&(p=c.wheelDeltaY);"wheelDeltaX"in c&&(t=-1*c.wheelDeltaX);"axis"in c&&c.axis===c.HORIZONTAL_AXIS&&(t=-1*p,p=0);q=0===p?t:p;"deltaY"in c&&(q=p=-1*c.deltaY);"deltaX"in c&&(t=c.deltaX,0===p&&(q=-1*t));if(0!==p||0!==t){1===c.deltaMode?(v=e.data(this,"mousewheel-line-height"),q*=v,p*=v,t*=v):2===c.deltaMode&&(v=e.data(this,"mousewheel-page-height"),
q*=v,p*=v,t*=v);v=Math.max(Math.abs(p),Math.abs(t));if(!r||v<r)r=v,k.settings.adjustOldDeltas&&"mousewheel"===c.type&&0===v%120&&(r/=40);k.settings.adjustOldDeltas&&"mousewheel"===c.type&&0===v%120&&(q/=40,t/=40,p/=40);q=Math[1<=q?"floor":"ceil"](q/r);t=Math[1<=t?"floor":"ceil"](t/r);p=Math[1<=p?"floor":"ceil"](p/r);k.settings.normalizeOffset&&this.getBoundingClientRect&&(c=this.getBoundingClientRect(),u=b.clientX-c.left,z=b.clientY-c.top);b.deltaX=t;b.deltaY=p;b.deltaFactor=r;b.offsetX=u;b.offsetY=
z;b.deltaMode=0;f.unshift(b,q,t,p);g&&clearTimeout(g);g=setTimeout(d,200);return(e.event.dispatch||e.event.handle).apply(this,f)}}function d(){r=null}var c=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],b="onwheel"in document||9<=document.documentMode?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],a=Array.prototype.slice,g,r;if(e.event.fixHooks)for(var q=c.length;q;)e.event.fixHooks[c[--q]]=e.event.mouseHooks;var k=e.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener)for(var a=
b.length;a;)this.addEventListener(b[--a],f,!1);else this.onmousewheel=f;e.data(this,"mousewheel-line-height",k.getLineHeight(this));e.data(this,"mousewheel-page-height",k.getPageHeight(this))},teardown:function(){if(this.removeEventListener)for(var a=b.length;a;)this.removeEventListener(b[--a],f,!1);else this.onmousewheel=null;e.removeData(this,"mousewheel-line-height");e.removeData(this,"mousewheel-page-height")},getLineHeight:function(a){a=e(a);var b=a["offsetParent"in e.fn?"offsetParent":"parent"]();
...
a);}}null==e.fn.select2.defaults&&(e.fn.select2.defaults=c);return d});return{define:g.define,require:g.require}}(),H=z.require("jquery.select2");u.fn.select2.amd=z;return H});
