...
b();while(b)},attach:function(){this.addDisposer(b(arguments[0]).attach.apply(this,Array.prototype.slice.call(arguments,1)))},addDisposer:function(b){a.push(b)}}}})();(function(){"function"===typeof define&&define.amd?define(function(){return b}):"undefined"!==typeof module&&module.exports?module.exports=b:K.qq=b})();(function(){b.Error=function(a){this.message="[Fine Uploader "+b.version+"] "+a};b.Error.prototype=Error()})();b.version="5.11.8";b.supportedFeatures=function(){function a(){var a=document.createElement("span");
return("draggable"in a||"ondragstart"in a&&"ondrop"in a)&&!b.android()&&!b.ios()}var d,c,e,f,g,h,k,l,m,n,q,p,r,y,v;c=(f=(d=function(){var a=!0,c;try{c=document.createElement("input"),c.type="file",b(c).hide(),c.disabled&&(a=!1)}catch(d){a=!1}return a}())&&b.isXhrUploadSupported())&&!b.androidStock();g=(e=f&&a())&&(b.chrome()||b.opera())&&void 0!==navigator.userAgent.match(/Chrome\/[2][1-9]|Chrome\/[3-9][0-9]/);h=f&&b.isFileChunkingSupported();if(k=f&&h)try{k=!!window.localStorage&&b.isFunction(window.localStorage.setItem)}catch(w){k=
!1}l=f&&(b.chrome()||b.opera())&&void 0!==navigator.userAgent.match(/Chrome\/[1][4-9]|Chrome\/[2-9][0-9]/);m=d&&(void 0!==window.postMessage||f);q=window.XMLHttpRequest?void 0!==b.createXhrInstance().withCredentials:!1;n=void 0!==window.XDomainRequest;p=window.XMLHttpRequest&&void 0!==b.createXhrInstance().withCredentials?!0:void 0!==window.XDomainRequest;r=void 0!==document.createElement("input").webkitdirectory;y=f&&void 0!==window.FileReader;v=f?!b.androidStock()&&!b.iosChrome():!1;return{ajaxUploading:f,
blobUploading:c,canDetermineSize:f,chunking:h,deleteFileCors:p,deleteFileCorsXdr:n,deleteFileCorsXhr:q,dialogElement:!!window.HTMLDialogElement,fileDrop:e,folderDrop:g,folderSelection:r,imagePreviews:y,imageValidation:y,itemSizeValidation:f,pause:h,progressBar:v,resume:k,scaling:y&&c,tiffPreviews:b.safari(),unlimitedScaledImageSize:!b.ios(),uploading:d,uploadCors:m,uploadCustomHeaders:f,uploadNonMultipart:f,uploadViaPaste:l}}();b.isGenericPromise=function(a){return!!(a&&a.then&&b.isFunction(a.then))};
...
if(window.XMLHttpRequest||window.ActiveXObject)a=b.createXhrInstance(),void 0===a.withCredentials&&(a=new XDomainRequest,a.onload=function(){},a.onerror=function(){},a.ontimeout=function(){},a.onprogress=function(){});return a}function f(a,c){var d=x[a].xhr;d||(d=c?c:t.cors.expected?e():b.createXhrInstance(),x[a].xhr=d);return d}function g(a){var c=b.indexOf(w,a),d=t.maxConnections;delete x[a];w.splice(c,1);w.length>=d&&c<d&&(a=w[d-1],l(a))}function h(a,d){var e=f(a),r=t.method,h=!0===d;g(a);h?y(r+
" request for "+a+" has failed","error"):c(e)||0<=b.indexOf(t.successfulResponseCodes[t.method],e.status)||(h=!0,y(r+" request for "+a+" has failed - response code "+e.status,"error"));t.onComplete(a,e,h)}function k(a){var c=x[a].additionalParams,d=t.mandatedParams,e;t.paramsStore.get&&(e=t.paramsStore.get(a));c&&b.each(c,function(a,b){e=e||{};e[a]=b});d&&b.each(d,function(a,b){e=e||{};e[a]=b});return e}function l(a,d){var e=f(a,d),g=t.method,h=k(a),l=x[a].payload,w;t.onSend(a);w=x[a].additionalQueryParams;
var u=t.endpointStore.get(a),F=x[a].addToPath;void 0!=F&&(u+="/"+F);v&&h&&(u=b.obj2url(h,u));w&&(u=b.obj2url(w,u));w=u;c(e)?(e.onload=q(a),e.onerror=p(a)):e.onreadystatechange=m(a);n(a);e.open(g,w,!0);t.cors.expected&&t.cors.sendCredentials&&!c(e)&&(e.withCredentials=!0);r(a);y("Sending "+g+" request for "+a);l?e.send(l):v||!h?e.send():h&&t.contentType&&0<=t.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded")?e.send(b.obj2url(h,"")):h&&t.contentType&&0<=t.contentType.toLowerCase().indexOf("application/json")?
...
0<=b.indexOf(["GET","POST","HEAD"],t.method)&&!d(g)||(e.setRequestHeader("X-Requested-With","XMLHttpRequest"),e.setRequestHeader("Cache-Control","no-cache")),!t.contentType||"POST"!==h&&"PUT"!==h||e.setRequestHeader("Content-Type",t.contentType),b.extend(k,b.isFunction(g)?g(a):g),b.extend(k,r),b.each(k,function(a,b){e.setRequestHeader(a,b)}))}var y,v,w=[],x={},t={acceptHeader:null,validMethods:["PATCH","POST","PUT"],method:"POST",contentType:"application/x-www-form-urlencoded",maxConnections:3,customHeaders:{},
endpointStore:{},paramsStore:{},mandatedParams:{},allowXRequestedWithAndCacheControl:!0,successfulResponseCodes:{DELETE:[200,202,204],PATCH:[200,201,202,203,204],POST:[200,201,202,203,204],PUT:[200,201,202,203,204],GET:[200]},cors:{expected:!1,sendCredentials:!1},log:function(a,b){},onSend:function(a){},onComplete:function(a,b,c){},onProgress:null};b.extend(t,a);y=t.log;if(0>b.indexOf(t.validMethods,t.method))throw Error("'"+t.method+"' is not a supported method for this type of request!");v="GET"===
...
[];null==k._getFileState(a).loaded&&(k._getFileState(a).loaded=0);q&&!1===l.onResume(a,d,g)&&(m.reset(a),e=m.nextPart(a),g=k._getChunkData(a,e),q=!1);null==e&&0===C.length?m.finalize(a):(h(b.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.",a,e,g.start+1,g.end,c)),l.onUploadChunk(a,d,k._getChunkDataForCallback(g)),C.push(e),k._getFileState(a).chunking.inProgress=C,f&&n.open(a,e),f&&n.available()&&k._getFileState(a).chunking.remaining.length&&m.sendNext(a),k.uploadChunk(a,
e,q).then(function(c,d){h("Chunked upload request succeeded for "+a+", chunk "+e);k.clearCachedChunk(a,e);var g=k._getFileState(a).chunking.inProgress||[],f=p.normalizeResponse(c,!0),x=b.indexOf(g,e);h(b.format("Chunk {} for file {} uploaded successfully.",e,a));m.done(a,e,f,d);0<=x&&g.splice(x,1);k._maybePersistChunkedState(a);m.hasMoreParts(a)||0!==g.length?m.hasMoreParts(a)?m.sendNext(a):h(b.format("File ID {} has no more chunks to send and these chunk indexes are still marked as in-progress: {}",
a,JSON.stringify(g))):m.finalize(a)},function(c,g){h("Chunked upload request failed for "+a+", chunk "+e);k.clearCachedChunk(a,e);var x=p.normalizeResponse(c,!1),q;x.reset?m.reset(a):(q=b.indexOf(k._getFileState(a).chunking.inProgress,e),0<=q&&(k._getFileState(a).chunking.inProgress.splice(q,1),k._getFileState(a).chunking.remaining.unshift(e)));k._getFileState(a).temp.ignoreFailure||(f&&(k._getFileState(a).temp.ignoreFailure=!0,h(b.format("Going to attempt to abort these chunks: {}. These are currently in-progress: {}.",
...
(a=d[a])&&a()}})};b.FormUploadHandler=function(a){function d(a,c){var d=a.id,g=d.split("_")[0],f=q(g);h[f]=c;k[g]=b(a).attach("load",function(){e.getInput(g)&&(p("Received iframe load event for CORS upload request (iframe name "+d+")"),l[d]=setTimeout(function(){var a="No valid message received from loaded iframe for iframe name "+d;p(a,"error");c({error:a})},1E3))});r.receiveMessage(d,function(a){p("Received the following window message: '"+a+"'");d.split("_");var b=e._parseJsonResponse(a),c=b.uuid;
c&&h[c]?(p("Handling response for iframe name "+d),clearTimeout(l[d]),delete l[d],e._detachLoadEvent(d),a=h[c],delete h[c],r.stopReceivingMessages(d),a(b)):c||p("'"+a+"' does not contain a UUID - ignoring.")})}var c=a.options,e=this,f=a.proxy,g=b.getUniqueId(),h={},k={},l={},m=c.isCors,n=c.inputName,q=f.getUuid,p=f.log,r=new b.WindowReceiveMessage({log:p});b.extend(this,new b.UploadHandler(a));b.override(this,function(a){return{add:function(c,d){a.add(c,{input:d});d.setAttribute("name",n);d.parentNode&&
b(d).remove()},expunge:function(c){delete k[c];m&&(clearTimeout(l[c]),delete l[c],r.stopReceivingMessages(c));var d=document.getElementById(e._getIframeName(c));d&&(d.setAttribute("src","javascript:false;"),b(d).remove());a.expunge(c)},isValid:function(b){return a.isValid(b)&&void 0!==e._getFileState(b).input}}});b.extend(this,{getInput:function(a){return e._getFileState(a).input},_attachLoadEvent:function(a,c){var e;m?d(a,c):k[a.id]=b(a).attach("load",function(){p("Received response for "+a.id);
if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){p("Error when attempting to access iframe during handling of upload response ("+b.message+")","error"),e={success:!1}}c(e)}})},_createIframe:function(a){a=e._getIframeName(a);var c=b.toElement("<iframe src='javascript:false;' name='"+a+"' />");c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c},_detachLoadEvent:function(a){void 0!==k[a]&&(k[a](),
delete k[a])},_getIframeName:function(a){return a+"_"+g},_initFormForUpload:function(a){var c=a.endpoint,d=a.params,e=a.paramsInBody,g=a.targetName;a=b.toElement("<form method='"+a.method+"' enctype='multipart/form-data'></form>");var f=c;e?b.obj2Inputs(d,a):f=b.obj2url(d,c);a.setAttribute("action",f);a.setAttribute("target",g);a.style.display="none";document.body.appendChild(a);return a},_parseJsonResponse:function(a){var c={};try{c=b.parseJson(a)}catch(d){p("Error when attempting to parse iframe upload response ("+
d.message+")","error")}return c}})};b.XhrUploadHandler=function(a){function d(a){b.each(c._getXhrs(a),function(b,d){var e=c._getAjaxRequester(a,b);d.onreadystatechange=null;d.upload.onprogress=null;d.abort();e&&e.canceled&&e.canceled(a)})}var c=this,e=a.options.namespace,f=a.proxy,g=a.options.chunking,h=a.options.resume,k=g&&a.options.chunking.enabled&&b.supportedFeatures.chunking,l=h&&a.options.resume.enabled&&k&&b.supportedFeatures.resume,m=f.getName,n=f.getSize,q=f.getUuid,p=f.getEndpoint,r=f.getDataByUuid,
y=f.onUuidChanged,v=f.onProgress,w=f.log;b.extend(this,new b.UploadHandler(a));b.override(this,function(a){return{add:function(d,e){if(b.isFile(e)||b.isBlob(e))a.add(d,{file:e});else if(e instanceof b.BlobProxy)a.add(d,{proxy:e});else throw Error("Passed obj is not a File, Blob, or proxy");c._initTempState(d);l&&c._maybePrepareForResume(d)},expunge:function(b){d(b);c._maybeDeletePersistedChunkData(b);c._clearXhrs(b);a.expunge(b)}}});b.extend(this,{clearCachedChunk:function(a,b){delete c._getFileState(a).temp.cachedChunks[b]},
clearXhr:function(a,b){var d=c._getFileState(a).temp;d.xhrs&&delete d.xhrs[b];d.ajaxRequesters&&delete d.ajaxRequesters[b]},finalizeChunks:function(a,d){var e=c._getTotalChunks(a)-1,e=c._getXhr(a,e);return d?(new b.Promise).success(d(e),e):(new b.Promise).success({},e)},getFile:function(a){return c.isValid(a)&&c._getFileState(a).file},getProxy:function(a){return c.isValid(a)&&c._getFileState(a).proxy},getResumableFilesData:function(){var a=[];c._iterateResumeRecords(function(b,d){c.moveInProgressToRemaining(null,
d.chunking.inProgress,d.chunking.remaining);var e={name:d.name,remaining:d.chunking.remaining,size:d.size,uuid:d.uuid};d.key&&(e.key=d.key);a.push(e)});return a},isResumable:function(a){return!!g&&c.isValid(a)&&!c._getFileState(a).notResumable},moveInProgressToRemaining:function(a,d,e){d=d||c._getFileState(a).chunking.inProgress;var g=e||c._getFileState(a).chunking.remaining;d&&(w(b.format("Moving these chunks from in-progress {}, to remaining.",JSON.stringify(d))),d.reverse(),b.each(d,function(a,
b){g.unshift(b)}),d.length=0)},pause:function(a){if(c.isValid(a))return w(b.format("Aborting XHR upload for {} '{}' due to pause instruction.",a,m(a))),c._getFileState(a).paused=!0,d(a),!0},reevaluateChunking:function(a){if(g&&c.isValid(a)){var b=c._getFileState(a),d,e;delete b.chunking;b.chunking={};d=c._getTotalChunks(a);if(1<d||g.mandatory){b.chunking.enabled=!0;b.chunking.parts=d;b.chunking.remaining=[];for(e=0;e<d;e++)b.chunking.remaining.push(e);c._initTempState(a)}else b.chunking.enabled=!1}},
updateBlob:function(a,b){c.isValid(a)&&(c._getFileState(a).file=b)},_clearXhrs:function(a){var d=c._getFileState(a).temp;b.each(d.ajaxRequesters,function(a){delete d.ajaxRequesters[a]});b.each(d.xhrs,function(a){delete d.xhrs[a]})},_createXhr:function(a,d){return c._registerXhr(a,d,b.createXhrInstance())},_getAjaxRequester:function(a,b){var d=null==b?-1:b;return c._getFileState(a).temp.ajaxRequesters[d]},_getChunkData:function(a,d){var e=g.partSize,f=n(a),h=c.getFile(a),k=e*d,e=k+e>=f?f:k+e,f=c._getTotalChunks(a),
l=this._getFileState(a).temp.cachedChunks,h=l[d]||b.sliceBlob(h,k,e);l[d]=h;return{part:d,start:k,end:e,count:f,blob:h,size:e-k}},_getChunkDataForCallback:function(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}},_getLocalStorageId:function(a){var c=m(a),d=n(a),f=g.partSize;a=p(a);return b.format("qq{}resume{}-{}-{}-{}-{}",e,"5.0",c,d,f,a)},_getMimeType:function(a){return c.getFile(a).type},_getPersistableData:function(a){return c._getFileState(a).chunking},_getTotalChunks:function(a){if(g)return a=
n(a),Math.ceil(a/g.partSize)},_getXhr:function(a,b){var d=null==b?-1:b;return c._getFileState(a).temp.xhrs[d]},_getXhrs:function(a){return c._getFileState(a).temp.xhrs},_iterateResumeRecords:function(a){l&&b.each(localStorage,function(c,d){if(0===c.indexOf(b.format("qq{}resume",e))){var g=JSON.parse(d);a(c,g)}})},_initTempState:function(a){c._getFileState(a).temp={ajaxRequesters:{},chunkProgress:{},xhrs:{},cachedChunks:{}}},_markNotResumable:function(a){c._getFileState(a).notResumable=!0},_maybeDeletePersistedChunkData:function(a){return l&&
c.isResumable(a)&&(a=c._getLocalStorageId(a))&&localStorage.getItem(a)?(localStorage.removeItem(a),!0):!1},_maybePrepareForResume:function(a){var d=c._getFileState(a),e;l&&void 0===d.key&&(e=c._getLocalStorageId(a),e=localStorage.getItem(e))&&(e=JSON.parse(e),r(e.uuid)?c._markNotResumable(a):(w(b.format("Identified file with ID {} and name of {} as resumable.",a,m(a))),y(a,e.uuid),d.key=e.key,d.chunking=e.chunking,d.loaded=e.loaded,d.attemptingResume=!0,c.moveInProgressToRemaining(a)))},_maybePersistChunkedState:function(a){var d=
c._getFileState(a),e;if(l&&c.isResumable(a)){e=c._getLocalStorageId(a);d={name:m(a),size:n(a),uuid:q(a),key:d.key,chunking:d.chunking,loaded:d.loaded,lastUpdated:Date.now()};try{localStorage.setItem(e,JSON.stringify(d))}catch(g){w(b.format("Unable to save resume data for '{}' due to error: '{}'.",a,g.toString()),"warn")}}},_registerProgressHandler:function(a,d,e){var g=c._getXhr(a,d),f=m(a),h={simple:function(b,c){var d=n(a);b===c?v(a,f,d,d):v(a,f,b>=d?d-1:b,d)},chunked:function(g,h){var k=c._getFileState(a).temp.chunkProgress,
l=c._getFileState(a).loaded,q=n(a),p=l;k[d]=g-(h-e);b.each(k,function(a,b){p+=b});v(a,f,p,q)}};g.upload.onprogress=function(a){if(a.lengthComputable)h[null==e?"simple":"chunked"](a.loaded,a.total)}},_registerXhr:function(a,b,d,e){b=null==b?-1:b;a=c._getFileState(a).temp;a.xhrs=a.xhrs||{};a.ajaxRequesters=a.ajaxRequesters||{};a.xhrs[b]=d;e&&(a.ajaxRequesters[b]=e);return d},_removeExpiredChunkingRecords:function(){var a=h.recordsExpireIn;c._iterateResumeRecords(function(b,c){var d=new Date(c.lastUpdated);
d.setDate(d.getDate()+a);d.getTime()<=Date.now()&&(w("Removing expired resume record with key "+b),localStorage.removeItem(b))})},_shouldChunkThisFile:function(a){var b=c._getFileState(a);b.chunking||c.reevaluateChunking(a);return b.chunking.enabled}})};b.DeleteFileAjaxRequester=function(a){var d,c={method:"DELETE",uuidParamName:"qquuid",endpointStore:{},maxConnections:3,customHeaders:function(a){return{}},paramsStore:{},cors:{expected:!1,sendCredentials:!1},log:function(a,b){},onDelete:function(a){},
onDeleteComplete:function(a,b,c){}};b.extend(c,a);d=b.extend(this,new b.AjaxRequester({acceptHeader:"application/json",validMethods:["POST","DELETE"],method:c.method,endpointStore:c.endpointStore,paramsStore:c.paramsStore,mandatedParams:"POST"===c.method.toUpperCase()?{_method:"DELETE"}:{},maxConnections:c.maxConnections,customHeaders:function(a){return c.customHeaders.get(a)},log:c.log,onSend:c.onDelete,onComplete:c.onDeleteComplete,cors:c.cors}));b.extend(this,{sendDelete:function(a,b,g){g=g||{};
c.log("Submitting delete file request for "+a);"DELETE"===c.method?d.initTransport(a).withPath(b).withParams(g).send():(g[c.uuidParamName]=b,d.initTransport(a).withParams(g).send())}})};(function(){function a(a,c,e,f){var m=document.createElement("canvas"),n=e.mime||"image/jpeg",q=new b.Promise;d(a,c,m,e,f).then(function(){q.success(m.toDataURL(n,e.quality||.8))});return q}function d(a,d,f,l,m){var n=a.naturalWidth,q=a.naturalHeight,p=l.width,r=l.height,y=f.getContext("2d"),v=new b.Promise;y.save();
if(l.resize)return c({blob:d,canvas:f,image:a,imageHeight:q,imageWidth:n,orientation:l.orientation,resize:l.resize,targetHeight:r,targetWidth:p});if(!b.supportedFeatures.unlimitedScaledImageSize){d=p;var w=r;if(!b.ios())throw new b.Error("Downsampled dimensions can only be reliably calculated for iOS!");d=5241E3<w*d?{newHeight:Math.round(Math.sqrt(w/d*5241E3)),newWidth:Math.round(Math.sqrt(d/w*5241E3))}:void 0;d&&(b.log(b.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h",
p,r,d.newWidth,d.newHeight),"warn"),p=d.newWidth,r=d.newHeight)}e(f,p,r,l.orientation);if(b.ios()){l=a.naturalWidth;d=a.naturalHeight;w=document.createElement("canvas");1048576<l*d?(w.width=w.height=1,d=w.getContext("2d"),d.drawImage(a,-l+1,0),l=0===d.getImageData(0,0,1,1).data[3]):l=!1;l&&(n/=2,q/=2);l=document.createElement("canvas");if(m){m=q;var x=document.createElement("canvas");d=0;var t=w=m,C;x.width=1;x.height=m;x=x.getContext("2d");x.drawImage(a,0,0);for(x=x.getImageData(0,0,1,m).data;t>
d;)C=x[4*(t-1)+3],0===C?w=t:d=t,t=w+d>>1;m=t/m;m=0===m?1:m}else m=1;p=Math.ceil(1024*p/n);r=Math.ceil(1024*r/q/m);d=m=0;l.width=l.height=1024;for(w=l.getContext("2d");m<q;){for(x=t=0;t<n;)w.clearRect(0,0,1024,1024),w.drawImage(a,-t,-m),y.drawImage(l,0,0,1024,1024,x,d,p,r),t+=1024,x+=p;m+=1024;d+=r}y.restore()}else y.drawImage(a,0,0,p,r);f.qqImageRendered&&f.qqImageRendered();v.success();return v}function c(a){var c=a.blob,d=a.image,f=a.imageHeight,m=a.imageWidth,n=a.orientation,q=new b.Promise,p=
a.resize,r=document.createElement("canvas"),y=r.getContext("2d"),v=a.canvas,w=a.targetHeight;a=a.targetWidth;e(r,m,f,n);v.height=w;v.width=a;y.drawImage(d,0,0);p({blob:c,height:w,image:d,sourceCanvas:r,targetCanvas:v,width:a}).then(function(){v.qqImageRendered&&v.qqImageRendered();q.success()},q.failure);return q}function e(a,b,c,d){switch(d){case 5:case 6:case 7:case 8:a.width=c;a.height=b;break;default:a.width=b,a.height=c}a=a.getContext("2d");switch(d){case 2:a.translate(b,0);a.scale(-1,1);break;
...
e.maxHeight,y=!this.blob||"image/jpeg"===this.blob.type,v=c.tagName.toLowerCase(),w;if(this.imageLoadListeners)this.imageLoadListeners.push(function(){f.render(c,e)});else if(n&&!q?q=m*n/l<<0:q&&!n?n=l*q/m<<0:(n=l,q=m),p&&n>p&&(n=p,q=m*n/l<<0),r&&q>r&&(q=r,n=l*q/m<<0),w={width:n,height:q},b.each(e,function(a,b){w[a]=b}),"img"===v?function(){var b=c.src;a(f.srcImage,f.blob,w,y).then(function(a){c.src=a;b===c.src&&c.onload()})}():"canvas"===v&&d(this.srcImage,this.blob,c,w,y),"function"===typeof this.onrender)this.onrender(c)};
b.MegaPixImage=f})();b.ImageGenerator=function(a){function d(a){return"img"===a.tagName.toLowerCase()}function c(a){return"canvas"===a.tagName.toLowerCase()}function e(a){a=a.split("/");a=a[a.length-1].split("?")[0];a=(a=b.getExtension(a))&&a.toLowerCase();switch(a){case "jpeg":case "jpg":return"image/jpeg";case "png":return"image/png";case "bmp":return"image/bmp";case "gif":return"image/gif";case "tiff":case "tif":return"image/tiff"}}function f(a){var c=document.createElement("a"),d;c.href=a;a=c.protocol;
...
a));c.failure(a)};f().then(function(f){d(b.format("Moving forward with EXIF header parsing for '{}'",void 0===a.name?"blob":a.name));g(f).then(function(g){d(b.format("EXIF Byte order is {} endian",g?"little":"big"));h(f,g).then(function(h){d(b.format("Found {} APP1 directory entries",h));b.readBlobToHex(a,f+20,12*h).then(function(a){for(var b=[],e=0;e+24<=a.length;)b.push(a.slice(e,e+24)),e+=24;a=k(g,b);d("Successfully parsed some EXIF tags");c.success(a)},e)},e)},e)},e);return c}});this._testing=
{};this._testing.parseLittleEndian=c};b.Identify=function(a,d){function c(a,c){var d=!1,h=[].concat(a);b.each(h,function(a,b){if(0===c.indexOf(b))return d=!0,!1});return d}b.extend(this,{isPreviewable:function(){var e=this,f=new b.Promise,g=!1,h=void 0===a.name?"blob":a.name;d(b.format("Attempting to determine if {} can be rendered in this browser",h));d("First pass: check type attribute of blob object.");this.isPreviewableSync()?(d("Second pass: check for magic bytes in file header."),b.readBlobToHex(a,
0,4).then(function(a){b.each(e.PREVIEWABLE_MIME_TYPES,function(d,e){if(c(e,a)){if("image/tiff"!==d||b.supportedFeatures.tiffPreviews)g=!0,f.success(d);return!1}});d(b.format("'{}' is {} able to be rendered in this browser",h,g?"":"NOT"));g||f.failure()},function(){d("Error reading file w/ name '"+h+"'.  Not able to be rendered in this browser.");f.failure()})):f.failure();return f},isPreviewableSync:function(){var c=a.type,f=0<=b.indexOf(Object.keys(this.PREVIEWABLE_MIME_TYPES),c),g=!1,h=void 0===
a.name?"blob":a.name;f&&(g="image/tiff"===c?b.supportedFeatures.tiffPreviews:!0);!g&&d(h+" is not previewable in this browser per the blob's type attr");return g}})};b.Identify.prototype.PREVIEWABLE_MIME_TYPES={"image/jpeg":"ffd8ff","image/gif":"474946","image/png":"89504e","image/bmp":"424d","image/tiff":["49492a00","4d4d002a"]};b.Identify=function(a,d){function c(a,c){var d=!1,h=[].concat(a);b.each(h,function(a,b){if(0===c.indexOf(b))return d=!0,!1});return d}b.extend(this,{isPreviewable:function(){var e=
this,f=new b.Promise,g=!1,h=void 0===a.name?"blob":a.name;d(b.format("Attempting to determine if {} can be rendered in this browser",h));d("First pass: check type attribute of blob object.");this.isPreviewableSync()?(d("Second pass: check for magic bytes in file header."),b.readBlobToHex(a,0,4).then(function(a){b.each(e.PREVIEWABLE_MIME_TYPES,function(d,e){if(c(e,a)){if("image/tiff"!==d||b.supportedFeatures.tiffPreviews)g=!0,f.success(d);return!1}});d(b.format("'{}' is {} able to be rendered in this browser",
h,g?"":"NOT"));g||f.failure()},function(){d("Error reading file w/ name '"+h+"'.  Not able to be rendered in this browser.");f.failure()})):f.failure();return f},isPreviewableSync:function(){var c=a.type,f=0<=b.indexOf(Object.keys(this.PREVIEWABLE_MIME_TYPES),c),g=!1,h=void 0===a.name?"blob":a.name;f&&(g="image/tiff"===c?b.supportedFeatures.tiffPreviews:!0);!g&&d(h+" is not previewable in this browser per the blob's type attr");return g}})};b.Identify.prototype.PREVIEWABLE_MIME_TYPES={"image/jpeg":"ffd8ff",
...
"error");c.failure()},b.onload=function(){c.success({width:this.width,height:this.height})},b.src=e.createObjectURL(a)):(d("No createObjectURL function available to generate image URL!","error"),c.failure())},c.failure);return c}function f(a,c){var d;b.each(a,function(a,b){if(0<b){var e=/(max|min)(Width|Height)/.exec(a),f=e[2].charAt(0).toLowerCase()+e[2].slice(1),f=c[f];switch(e[1]){case "min":if(f<b)return d=a,!1;break;case "max":if(f>b)return d=a,!1}}});return d}this.validate=function(a){var h=
new b.Promise;d("Attempting to validate image.");c(a)?e().then(function(b){(b=f(a,b))?h.failure(b):h.success()},h.success):h.success();return h}};b.Session=function(a){function d(a,d,g,h){var k=!1;d&&(b.isArray(a)?d=!0:(c.log("Session response is not an array.","error"),d=void 0));d&&b.each(a,function(a,d){if(null==d.uuid)k=!0,c.log(b.format("Session response item {} did not include a valid UUID - ignoring.",a),"error");else if(null==d.name)k=!0,c.log(b.format("Session response item {} did not include a valid name - ignoring.",
a),"error");else try{return c.addFileRecord(d),!0}catch(e){k=!0,c.log(e.message,"error")}return!1});h[d&&!k?"success":"failure"](a,g)}var c={endpoint:null,params:{},customHeaders:{},cors:{},addFileRecord:function(a){},log:function(a,b){}};b.extend(c,a,!0);this.refresh=function(){var a=new b.Promise,f=b.extend({},c);(new b.SessionAjaxRequester(b.extend(f,{onComplete:function(b,c,f){d(b,c,f,a)}}))).queryServer();return a}};b.SessionAjaxRequester=function(a){var d,c={endpoint:null,customHeaders:{},params:{},
cors:{expected:!1,sendCredentials:!1},onComplete:function(a,b,c){},log:function(a,b){}};b.extend(c,a);d=b.extend(this,new b.AjaxRequester({acceptHeader:"application/json",validMethods:["GET"],method:"GET",endpointStore:{get:function(){return c.endpoint}},customHeaders:c.customHeaders,log:c.log,onComplete:function(a,d,g){a=null;if(null!=d.responseText)try{a=b.parseJson(d.responseText)}catch(h){c.log("Problem parsing session response: "+h.message,"error"),g=!0}c.onComplete(a,!g,d)},cors:c.cors}));b.extend(this,
{queryServer:function(){var a=b.extend({},c.params);c.log("Session query request.");d.initTransport("sessionRefresh").withParams(a).withCacheBuster().send()}})};b.Scaler=function(a,d){var c=a.customResizer,e=a.sendOriginal,f=a.orient,g=a.defaultType,h=a.defaultQuality/100,k=a.failureText,l=a.includeExif,m=this._getSortedSizes(a.sizes);b.extend(this,{enabled:b.supportedFeatures.scaling&&0<m.length,getFileRecords:function(a,q,p){var r=this,y=[],v=p.blob?p.blob:p;(new b.Identify(v,d)).isPreviewableSync()?
(b.each(m,function(a,e){var m=r._determineOutputType({defaultType:g,requestedType:e.type,refType:v.type});y.push({uuid:b.getUniqueId(),name:r._getName(q,{name:e.name,type:m,refType:v.type}),blob:new b.BlobProxy(v,b.bind(r._generateScaledImage,r,{customResizeFunction:c,maxSize:e.maxSize,orient:f,type:m,quality:h,failedText:k,includeExif:l,log:d}))})}),y.push({uuid:a,name:q,size:v.size,blob:e?v:null})):y.push({uuid:a,name:q,size:v.size,blob:v});return y},handleNewFile:function(a,c,d,e,f,g,h,k){var l=
...
m=function(a){var b=d(a);0<b&&(n(a,0,b),c[a]={loaded:0,total:b})},n=function(a,b,d){var g=c[a]?c[a].loaded:0;a=c[a]?c[a].total:0;-1===b&&-1===d?(e-=g,f-=a):(b&&(e+=b-g),d&&(f+=d-a));k(e,f)};b.extend(this,{onAllComplete:function(a,b,c){if(0===b.length||l(b,c))k(f,f),this.reset()},onStatusChange:function(a,d,e){e===b.status.CANCELED||e===b.status.REJECTED?(n(a,-1,-1),delete c[a]):e===b.status.SUBMITTING&&m(a)},onIndividualProgress:function(a,b,d){n(a,b,d);c[a]={loaded:b,total:d}},onNewSize:function(a){m(a)},
reset:function(){c={};f=e=0}})};b.PasteSupport=function(a){var d,c;d={targetElement:null,callbacks:{log:function(a,b){},pasteReceived:function(a){}}};b.extend(d,a);(function(){c=b(d.targetElement).attach("paste",function(a){(a=a.clipboardData)&&b.each(a.items,function(a,b){if(b.type&&0===b.type.indexOf("image/")){var c=b.getAsFile();d.callbacks.pasteReceived(c)}})})})();b.extend(this,{reset:function(){c&&c()}})};b.FormSupport=function(a,d,c){function e(a,b){if(a.checkValidity&&!a.checkValidity())c("Form did not pass validation checks - will not upload.",
"error"),b();else return!0}function f(a){var c=a.submit;b(a).attach("submit",function(b){b=b||window.event;b.preventDefault?b.preventDefault():b.returnValue=!1;e(a,c)&&d()});a.submit=function(){e(a,c)&&d()}}var g=this,h=a.interceptSubmit,k=a.element;b.extend(this,{newEndpoint:null,newAutoUpload:a.autoUpload,attachedToForm:!1,getFormInputsAsObject:function(){return null==k?null:g._form2Obj(k)}});k=function(a){if(a&&(b.isString(a)&&(a=document.getElementById(a)),a)){c("Attaching to form element.");
var d=a;d.getAttribute("action")&&(g.newEndpoint=d.getAttribute("action"));h&&f(a)}return a}(k);this.attachedToForm=!!k};b.extend(b.FormSupport.prototype,{_form2Obj:function(a){var d={},c=function(a){return 0<=b.indexOf(["checkbox","radio"],a.type.toLowerCase())&&!a.checked?!0:a.disabled&&"hidden"!==a.type.toLowerCase()},e=function(a){var c=null;b.each(b(a).children(),function(a,b){if("option"===b.tagName.toLowerCase()&&b.selected)return c=b.value,!1});return c};b.each(a.elements,function(a,g){var h;
if(h=b.isInput(g,!0)||"textarea"===g.tagName.toLowerCase())h=0>b.indexOf(["button","image","reset","submit"],g.type.toLowerCase());h&&!c(g)?d[g.name]=g.value:"select"!==g.tagName.toLowerCase()||c(g)||(h=e(g),null!==h&&(d[g.name]=h))});return d}});b.traditional=b.traditional||{};b.traditional.FormUploadHandler=function(a,d){function c(b,c){var d=a.paramsStore.get(b),h="get"===a.method.toLowerCase()?"GET":"POST",q=a.endpointStore.get(b),p=f(b);d[a.uuidName]=g(b);d[a.filenameParam]=p;return e._initFormForUpload({method:h,
endpoint:q,params:d,paramsInBody:a.paramsInBody,targetName:c.name})}var e=this,f=d.getName,g=d.getUuid,h=d.log;this.uploadFile=function(d){var f=e.getInput(d),g=e._createIframe(d),n=new b.Promise,q;q=c(d,g);q.appendChild(f);e._attachLoadEvent(g,function(c){h("iframe loaded");if(!c){var f,l,q;try{l=g.contentDocument||g.contentWindow.document,q=l.body.innerHTML,h("converting iframe's innerHTML to JSON"),h("innerHTML = "+q),q&&q.match(/^<pre/i)&&(q=l.body.firstChild.firstChild.nodeValue),f=e._parseJsonResponse(q)}catch(w){h("Error when attempting to parse form upload response ("+
w.message+")","error"),f={success:!1}}c=f}e._detachLoadEvent(d);a.cors.expected||b(g).remove();c.success?n.success(c):n.failure(c)});h("Sending upload request for "+d);q.submit();b(q).remove();return n};b.extend(this,new b.FormUploadHandler({options:{isCors:a.cors.expected,inputName:a.inputName},proxy:{onCancel:a.onCancel,getName:f,getUuid:g,log:h}}))};b.traditional=b.traditional||{};b.traditional.XhrUploadHandler=function(a,d){var c=this,e=d.getName,f=d.getSize,g=d.getUuid,h=d.log,k=a.forceMultipart||
a.paramsInBody,l=new b.traditional.AllChunksDoneAjaxRequester({cors:a.cors,endpoint:a.chunking.success.endpoint,log:h}),m=function(a,c){var d=new b.Promise;c.onreadystatechange=function(){var e;if(4===c.readyState){var f;h("xhr - server response received for "+a);h("responseText = "+c.responseText);f=q(!0,c);(e=!(0>b.indexOf([200,201,202,203,204],c.status)||!f.success||f.reset))?d.success(f,c):d.failure(f,c)}};return d},n=function(b){var d=a.paramsStore.get(b),h=e(b),k=f(b);d[a.uuidName]=g(b);d[a.filenameParam]=
h;d[a.totalFileSizeName]=k;d[a.chunking.paramNames.totalParts]=c._getTotalChunks(b);return d},q=function(a,c){var d={};try{h(b.format("Received response status {} with body: {}",c.status,c.responseText)),d=b.parseJson(c.responseText)}catch(e){a&&h("Error when attempting to parse xhr response text ("+e.message+")","error")}return d},p=function(d){var e=new b.Promise;l.complete(d,c._createXhr(d),n(d),a.customHeaders.get(d)).then(function(a){e.success(q(!1,a),a)},function(a){e.failure(q(!1,a),a)});return e},
r=function(c,d,h,l){var m=new FormData,n=a.method,q=a.endpointStore.get(l),p=e(l),r=f(l);c[a.uuidName]=g(l);c[a.filenameParam]=p;k&&(c[a.totalFileSizeName]=r);a.paramsInBody||(k||(c[a.inputName]=p),q=b.obj2url(c,q));d.open(n,q,!0);a.cors.expected&&a.cors.sendCredentials&&(d.withCredentials=!0);return k?(a.paramsInBody&&b.obj2FormData(c,m),m.append(a.inputName,h),m):h},y=function(d,e){var f=a.customHeaders.get(d),g=c.getFile(d);e.setRequestHeader("Accept","application/json");e.setRequestHeader("X-Requested-With",
"XMLHttpRequest");e.setRequestHeader("Cache-Control","no-cache");k||(e.setRequestHeader("Content-Type","application/octet-stream"),e.setRequestHeader("X-Mime-Type",g.type));b.each(f,function(a,b){e.setRequestHeader(a,b)})};b.extend(this,{uploadChunk:function(b,d,g){var h=c._getChunkData(b,d),l=c._createXhr(b,d);f(b);var n;n=m(b,l);c._registerProgressHandler(b,d,h.size);d=a.paramsStore.get(b);var q=f(b),p=e(b);d[a.chunking.paramNames.partIndex]=h.part;d[a.chunking.paramNames.partByteOffset]=h.start;
d[a.chunking.paramNames.chunkSize]=h.size;d[a.chunking.paramNames.totalParts]=h.count;d[a.totalFileSizeName]=q;k&&(d[a.filenameParam]=p);g&&(d[a.resume.paramNames.resuming]=!0);g=r(d,l,h.blob,b);y(b,l);l.send(g);return n},uploadFile:function(b){var d=c.getFile(b),e,f,g;f=c._createXhr(b);c._registerProgressHandler(b);e=m(b,f);g=a.paramsStore.get(b);d=r(g,f,d,b);y(b,f);f.send(d);return e}});b.extend(this,new b.XhrUploadHandler({options:b.extend({namespace:"traditional"},a),proxy:b.extend({getEndpoint:a.endpointStore.get},
...
cors:c.cors,log:c.log,onComplete:function(a,b,c){var d=e[a];delete e[a];c?d.failure(b):d.success(b)}}));b.extend(this,{complete:function(a,g,h,k){var l=new b.Promise;c.log("Submitting All Chunks Done request for "+a);e[a]=l;d.initTransport(a).withParams(h).withHeaders(k).send(g);return l}})};b.DragAndDrop=function(a){function d(a){var e=new b.Promise;a.isFile?a.file(function(b){var c=a.fullPath,d=c.indexOf(a.name),c=c.substr(0,d);"/"===c.charAt(0)&&(c=c.substr(1));b.qqPath=c;l.push(b);e.success()},
function(b){h.callbacks.dropLog("Problem parsing '"+a.fullPath+"'.  FileError code "+b.code+".","error");e.failure()}):a.isDirectory&&c(a).then(function(a){var c=a.length;b.each(a,function(a,b){d(b).done(function(){--c;0===c&&e.success()})});a.length||e.success()},function(b){h.callbacks.dropLog("Problem parsing '"+a.fullPath+"'.  FileError code "+b.code+".","error");e.failure()});return e}function c(a,d,e,f){var g=f||new b.Promise,h=d||a.createReader();h.readEntries(function(b){var d=e?e.concat(b):
b;b.length?setTimeout(function(){c(a,h,d,g)},0):g.success(d)},g.failure);return g}function e(a,c){var e=[],f=new b.Promise;h.callbacks.processingDroppedFiles();c.dropDisabled(!0);1<a.files.length&&!h.allowMultipleItems?(h.callbacks.processingDroppedFilesComplete([]),h.callbacks.dropError("tooManyFilesError",""),c.dropDisabled(!1),f.failure()):(l=[],b.isFolderDropSupported(a)?b.each(a.items,function(a,b){var c=b.webkitGetAsEntry();c&&(c.isFile?l.push(b.getAsFile()):e.push(d(c).done(function(){e.pop();
...
thumbnail:"qq-thumbnail-selector"},n={},q=new b.Promise,p=new b.Promise,r,y,v,w,x,t,C,H,E=function(a){var c=new b.Promise;p.then(function(b){L(b,a);a.src?c.success():(a.src=b.src,a.onload=function(){a.onload=null;B(a);c.success()})},function(){A(a);c.success()});return c},I=function(a,b,c){var d=F(a);r("Generating new thumbnail for "+a);b.qqThumbnailId=a;return l.imageGenerator.generate(b,d,c).then(function(){f++;B(d);n[a].success()},function(){n[a].failure();l.placeholders.waitUntilUpdate||G(a,d)})},
D=function(){if(h.length){g=!0;var a=h.shift();a.update?N(a):O(a)}else g=!1},z=function(a){return c[a]||b(t).getFirstByClass("qq-file-id-"+a)},J=function(a){return null==a?u(x,m.totalProgressBarContainer)||u(x,m.totalProgressBar):u(z(a),m.progressBarContainer)||u(z(a),m.progressBar)},u=function(a,c){return a&&b(a).getFirstByClass(c)},F=function(a){return C&&u(z(a),m.thumbnail)},A=function(a){a&&b(a).addClass(l.classes.hide)},L=function(a,c){var d=a.style.maxWidth,e=a.style.maxHeight;e&&d&&!c.style.maxWidth&&
...
k=0<k?k:null,H=b(c).hasAttribute("qq-server-scale")):c&&b(c).remove();C=C&&c;y=0<b(a).getByClass(m.editFilenameInput).length;v=0<b(a).getByClass(m.retry).length;c=b(a).getFirstByClass(m.list);if(null==c)throw Error("Could not find the file list container in the template!");d=c.innerHTML;c.innerHTML="";a.getElementsByTagName("DIALOG").length&&document.createElement("dialog");r("Template parsing complete");return{template:b.trimStr(a.innerHTML),fileTemplate:b.trimStr(d)}}();(function(){var a=l.placeholders.thumbnailNotAvailable,
...
f=0;x.innerHTML=w.template;A(u(x,m.dropProcessing));this.hideTotalProgress();t=l.fileContainerEl||u(x,m.list);r("Template rendering complete")},renderFailure:function(a){a=b.toElement(a);x.innerHTML="";x.appendChild(a)},reset:function(){this.render()},clearFiles:function(){t.innerHTML=""},disableCancel:function(){e=!0},addFile:function(a,f,g,h,k){var l=b.toElement(w.fileTemplate),n=u(l,m.file),q=u(x,m.uploader),r=k?d:t,v;k&&(c[a]=l);b(l).addClass("qq-file-id-"+a);q.removeAttribute("qq-drop-area-text");
n&&(b(n).setText(f),n.setAttribute("title",f));l.setAttribute("qq-file-id",a);g?K(l,g.index,r):r.appendChild(l);h?(l.style.display="none",b(l).addClass("qq-hidden-forever")):(A(J(a)),A(u(z(a),m.size)),A(u(z(a),m.deleteButton)),A(u(z(a),m.retry)),A(u(z(a),m.pause)),A(u(z(a),m.continueButton)),e&&this.hideCancel(a),(v=F(a))&&!v.src&&p.then(function(a){v.src=a.src;a.style.maxHeight&&a.style.maxWidth&&b(v).css({maxHeight:a.style.maxHeight,maxWidth:a.style.maxWidth});B(v)}))},addFileToCache:function(a,
b,c,d){this.addFile(a,b,c,d,!0)},addCacheToDom:function(){t.appendChild(d);d=document.createDocumentFragment();c={}},removeFile:function(a){b(z(a)).remove()},getFileId:function(a){if(a){for(;null==a.getAttribute("qq-file-id");)a=a.parentNode;return parseInt(a.getAttribute("qq-file-id"))}},getFileList:function(){return t},markFilenameEditable:function(a){(a=u(z(a),m.file))&&b(a).addClass(l.classes.editable)},updateFilename:function(a,c){var d=u(z(a),m.file);d&&(b(d).setText(c),d.setAttribute("title",
c))},hideFilename:function(a){A(u(z(a),m.file))},showFilename:function(a){B(u(z(a),m.file))},isFileName:function(a){return b(a).hasClass(m.file)},getButton:function(){return l.button||u(x,m.button)},hideDropProcessing:function(){A(u(x,m.dropProcessing))},showDropProcessing:function(){B(u(x,m.dropProcessing))},getDropZone:function(){return u(x,m.drop)},isEditFilenamePossible:function(){return y},hideRetry:function(a){A(u(z(a),m.retry))},isRetryPossible:function(){return v},showRetry:function(a){B(u(z(a),
...
d);a.textContent=c;e.showModal();return k}})};b.UiEventHandler=function(a,d){function c(a){e.attach(a,f.eventType,function(a){a=a||window.event;f.onHandled(a.target||a.srcElement,a)})}var e=new b.DisposeSupport,f={eventType:"click",attachTo:null,onHandled:function(a,b){}};b.extend(this,{addHandler:function(a){c(a)},dispose:function(){e.dispose()}});b.extend(d,{getFileIdFromItem:function(a){return a.qqFileId},getDisposeSupport:function(){return e}});b.extend(f,a);f.attachTo&&c(f.attachTo)};b.FileButtonsClickHandler=
function(a){var d={templating:null,log:function(a,b){},onDeleteFile:function(a){},onCancel:function(a){},onRetry:function(a){},onPause:function(a){},onContinue:function(a){},onGetName:function(a){}},c={cancel:function(a){d.onCancel(a)},retry:function(a){d.onRetry(a)},deleteButton:function(a){d.onDeleteFile(a)},pause:function(a){d.onPause(a)},continueButton:function(a){d.onContinue(a)}};b.extend(d,a);d.eventType="click";d.onHandled=function(a,f){b.each(c,function(c,h){var k=c.charAt(0).toUpperCase()+
c.slice(1);if(d.templating["is"+k](a))return k=d.templating.getFileId(a),b.preventDefault(f),d.log(b.format("Detected valid file button click event on file '{}', ID: {}.",d.onGetName(k),k)),h(k),!1})};d.attachTo=d.templating.getFileList();b.extend(this,new b.UiEventHandler(d,{}))};b.FilenameClickHandler=function(a){var d={},c={templating:null,log:function(a,b){},classes:{file:"qq-upload-file",editNameIcon:"qq-edit-filename-icon"},onGetUploadStatus:function(a){},onGetName:function(a){}};b.extend(c,
a);c.eventType="click";c.onHandled=function(a,f){if(c.templating.isFileName(a)||c.templating.isEditIcon(a)){var g=c.templating.getFileId(a);c.onGetUploadStatus(g)===b.status.SUBMITTED&&(c.log(b.format("Detected valid filename click event on file '{}', ID: {}.",c.onGetName(g),g)),b.preventDefault(f),d.handleFilenameEdit(g,a,!0))}};b.extend(this,new b.FilenameEditHandler(c,d))};b.FilenameInputFocusInHandler=function(a,d){var c={templating:null,onGetUploadStatus:function(a){},log:function(a,b){}};d||
(d={});c.eventType="focusin";c.onHandled=function(a,f){if(c.templating.isEditInput(a)){var g=c.templating.getFileId(a);c.onGetUploadStatus(g)===b.status.SUBMITTED&&(c.log(b.format("Detected valid filename input focus event on file '{}', ID: {}.",c.onGetName(g),g)),d.handleFilenameEdit(g,a))}};b.extend(c,a);b.extend(this,new b.FilenameEditHandler(c,d))};b.FilenameInputFocusHandler=function(a){a.eventType="focus";a.attachTo=null;b.extend(this,new b.FilenameInputFocusInHandler(a,{}))};b.FilenameEditHandler=
function(a,d){function c(a,c){var d=a.value,e;void 0!==d&&0<b.trimStr(d).length&&(e=g.onGetName(c),e=b.getExtension(e),void 0!==e&&(d=d+"."+e),g.onSetName(c,d));g.onEditingStatusChange(c,!1)}function e(a,b){d.getDisposeSupport().attach(a,"blur",function(){c(a,b)})}function f(a,b){d.getDisposeSupport().attach(a,"keyup",function(d){13===(d.keyCode||d.which)&&c(a,b)})}var g={templating:null,log:function(a,b){},onGetUploadStatus:function(a){},onGetName:function(a){},onSetName:function(a,b){},onEditingStatusChange:function(a,
b){}};b.extend(g,a);g.attachTo=g.templating.getFileList();b.extend(this,new b.UiEventHandler(g,d));b.extend(d,{handleFilenameEdit:function(a,b,c){b=g.templating.getEditInput(a);g.onEditingStatusChange(a,!0);var d=g.onGetName(a),n=d.lastIndexOf(".");0<n&&(d=d.substr(0,n));b.value=d;c&&b.focus();e(b,a);f(b,a)}})}})(window);
