...
try{e.sldM.style.cursor="pointer"}catch(g){e.sldM.style.cursor="hand"}e.btn.style.display=c.pickerClosable?"block":"none";e.btn.style.position="absolute";e.btn.style.left=c.pickerFace+"px";e.btn.style.bottom=c.pickerFace+"px";e.btn.style.padding="0 15px";e.btn.style.height="18px";e.btn.style.border=c.pickerInset+"px solid";(function(){var d=c.pickerInsetColor.split(/\s+/);e.btn.style.borderColor=2>d.length?d[0]:d[1]+" "+d[0]+" "+d[0]+" "+d[1]})();e.btn.style.color=c.pickerButtonColor;e.btn.style.font=
"12px sans-serif";e.btn.style.textAlign="center";try{e.btn.style.cursor="pointer"}catch(g){e.btn.style.cursor="hand"}e.btn.onmousedown=function(){c.hidePicker()};e.btnS.style.lineHeight=e.btn.style.height;switch(u){case 0:var m="hs.png";break;case 1:m="hv.png"}e.padM.style.backgroundImage="url('"+jscolor.getDir()+"cross.gif')";e.padM.style.backgroundRepeat="no-repeat";e.sldM.style.backgroundImage="url('"+jscolor.getDir()+"arrow.gif')";e.sldM.style.backgroundRepeat="no-repeat";e.pad.style.backgroundImage=
"url('"+jscolor.getDir()+m+"')";e.pad.style.backgroundRepeat="no-repeat";e.pad.style.backgroundPosition="0 0";A();G();jscolor.picker.owner=c;document.getElementsByTagName("body")[0].appendChild(e.boxB)}function v(d){return[2*d.pickerInset+2*d.pickerFace+jscolor.images.pad[0]+(d.slider?2*d.pickerInset+2*jscolor.images.arrow[0]+jscolor.images.sld[0]:0),d.pickerClosable?4*d.pickerInset+3*d.pickerFace+jscolor.images.pad[1]+d.pickerButtonHeight:2*d.pickerInset+2*d.pickerFace+jscolor.images.pad[1]]}function A(){switch(u){case 0:var d=
1;break;case 1:d=2}jscolor.picker.padM.style.backgroundPosition=c.pickerFace+c.pickerInset+Math.round(c.hsv[0]/6*(jscolor.images.pad[0]-1))-Math.floor(jscolor.images.cross[0]/2)+"px "+(c.pickerFace+c.pickerInset+Math.round((1-c.hsv[d])*(jscolor.images.pad[1]-1))-Math.floor(jscolor.images.cross[1]/2))+"px";d=jscolor.picker.sld.childNodes;switch(u){case 0:for(var a=b(c.hsv[0],c.hsv[1],1),l=0;l<d.length;l+=1)d[l].style.backgroundColor="rgb("+a[0]*(1-l/d.length)*100+"%,"+a[1]*(1-l/d.length)*100+"%,"+
a[2]*(1-l/d.length)*100+"%)";break;case 1:var f,e=[c.hsv[2],0,0],l=Math.floor(c.hsv[0]),m=l%2?c.hsv[0]-l:1-(c.hsv[0]-l);switch(l){case 6:case 0:a=[0,1,2];break;case 1:a=[1,0,2];break;case 2:a=[2,0,1];break;case 3:a=[2,1,0];break;case 4:a=[1,2,0];break;case 5:a=[0,2,1]}for(l=0;l<d.length;l+=1)f=1-1/(d.length-1)*l,e[1]=e[0]*(1-f*m),e[2]=e[0]*(1-f),d[l].style.backgroundColor="rgb("+100*e[a[0]]+"%,"+100*e[a[1]]+"%,"+100*e[a[2]]+"%)"}}function G(){switch(u){case 0:var d=2;break;case 1:d=1}jscolor.picker.sldM.style.backgroundPosition=
"0 "+(c.pickerFace+c.pickerInset+Math.round((1-c.hsv[d])*(jscolor.images.sld[1]-1))-Math.floor(jscolor.images.arrow[1]/2))+"px"}function z(){return jscolor.picker&&jscolor.picker.owner===c}function H(){k!==a&&c.importColor()}function B(d){var a=jscolor.getRelMousePos(d);d=a.x-c.pickerFace-c.pickerInset;a=a.y-c.pickerFace-c.pickerInset;switch(u){case 0:c.fromHSV(6/(jscolor.images.pad[0]-1)*d,1-a/(jscolor.images.pad[1]-1),null,D);break;case 1:c.fromHSV(6/(jscolor.images.pad[0]-1)*d,null,1-a/(jscolor.images.pad[1]-
1),D)}}function C(d){d=jscolor.getRelMousePos(d).y-c.pickerFace-c.pickerInset;switch(u){case 0:c.fromHSV(null,null,1-d/(jscolor.images.sld[1]-1),E);break;case 1:c.fromHSV(null,1-d/(jscolor.images.sld[1]-1),null,E)}}function x(){c.onImmediateChange&&("string"===typeof c.onImmediateChange?new Function(c.onImmediateChange):c.onImmediateChange).call(c)}this.adjust=this.required=!0;this.hash=!1;this.slider=this.caps=!0;this.styleElement=this.valueElement=a;this.onImmediateChange=null;this.hsv=[0,0,1];
this.rgb=[1,1,1];this.minH=0;this.maxH=6;this.minS=0;this.maxS=1;this.minV=0;this.maxV=1;this.pickerOnfocus=!0;this.pickerMode="HSV";this.pickerPosition="bottom";this.pickerSmartPosition=!0;this.pickerButtonHeight=20;this.pickerClosable=!1;this.pickerCloseText="Close";this.pickerButtonColor="ButtonText";this.pickerFace=10;this.pickerFaceColor="ThreeDFace";this.pickerBorder=1;this.pickerBorderColor="ThreeDHighlight ThreeDShadow ThreeDShadow ThreeDHighlight";this.pickerInset=1;this.pickerInsetColor=
"ThreeDShadow ThreeDHighlight ThreeDHighlight ThreeDShadow";this.pickerZIndex=1E4;for(var p in f)f.hasOwnProperty(p)&&(this[p]=f[p]);this.hidePicker=function(){z()&&(delete jscolor.picker.owner,document.getElementsByTagName("body")[0].removeChild(jscolor.picker.boxB))};this.showPicker=function(){if(!z()){var d=jscolor.getElementPos(a),b=jscolor.getElementSize(a),c=jscolor.getViewPos(),f=jscolor.getViewSize(),e=v(this),m,g,h;switch(this.pickerPosition.toLowerCase()){case "left":m=1;g=0;h=-1;break;
case "right":m=1;g=0;h=1;break;case "top":m=0;g=1;h=-1;break;default:m=0,h=g=1}var k=(b[g]+e[g])/2,d=this.pickerSmartPosition?[-c[m]+d[m]+e[m]>f[m]?-c[m]+d[m]+b[m]/2>f[m]/2&&0<=d[m]+b[m]-e[m]?d[m]+b[m]-e[m]:d[m]:d[m],-c[g]+d[g]+b[g]+e[g]-k+k*h>f[g]?-c[g]+d[g]+b[g]/2>f[g]/2&&0<=d[g]+b[g]-k-k*h?d[g]+b[g]-k-k*h:d[g]+b[g]-k+k*h:0<=d[g]+b[g]-k+k*h?d[g]+b[g]-k+k*h:d[g]+b[g]-k-k*h]:[d[m],d[g]+b[g]-k+k*h];n(d[m],d[g])}};this.importColor=function(){k?this.adjust?!this.required&&/^\s*$/.test(k.value)?(k.value=
"",h.style.backgroundImage=h.jscStyle.backgroundImage,h.style.backgroundColor=h.jscStyle.backgroundColor,h.style.color=h.jscStyle.color,this.exportColor(y|F)):this.fromString(k.value)||this.exportColor():this.fromString(k.value,y)||(h.style.backgroundImage=h.jscStyle.backgroundImage,h.style.backgroundColor=h.jscStyle.backgroundColor,h.style.color=h.jscStyle.color,this.exportColor(y|F)):this.exportColor()};this.exportColor=function(d){if(!(d&y)&&k){var a=this.toString();this.caps&&(a=a.toUpperCase());
this.hash&&(a="#"+a);k.value=a}d&F||!h||(h.style.backgroundImage="none",h.style.backgroundColor="#"+this.toString(),h.style.color=.5>.213*this.rgb[0]+.715*this.rgb[1]+.072*this.rgb[2]?"#FFF":"#000");d&E||!z()||A();d&D||!z()||G()};this.fromHSV=function(d,a,c,f){null!==d&&(d=Math.max(0,this.minH,Math.min(6,this.maxH,d)));null!==a&&(a=Math.max(0,this.minS,Math.min(1,this.maxS,a)));null!==c&&(c=Math.max(0,this.minV,Math.min(1,this.maxV,c)));this.rgb=b(null===d?this.hsv[0]:this.hsv[0]=d,null===a?this.hsv[1]:
this.hsv[1]=a,null===c?this.hsv[2]:this.hsv[2]=c);this.exportColor(f)};this.fromRGB=function(a,c,f,k){null!==a&&(a=Math.max(0,Math.min(1,a)));null!==c&&(c=Math.max(0,Math.min(1,c)));null!==f&&(f=Math.max(0,Math.min(1,f)));a=null===a?this.rgb[0]:a;c=null===c?this.rgb[1]:c;var e=null===f?this.rgb[2]:f,h=Math.min(Math.min(a,c),e);f=Math.max(Math.max(a,c),e);var g=f-h;0===g?a=[null,0,f]:(a=a===h?3+(e-c)/g:c===h?5+(a-e)/g:1+(c-a)/g,a=[6===a?0:a,g/f,f]);null!==a[0]&&(this.hsv[0]=Math.max(0,this.minH,Math.min(6,
this.maxH,a[0])));0!==a[2]&&(this.hsv[1]=null===a[1]?null:Math.max(0,this.minS,Math.min(1,this.maxS,a[1])));this.hsv[2]=null===a[2]?null:Math.max(0,this.minV,Math.min(1,this.maxV,a[2]));a=b(this.hsv[0],this.hsv[1],this.hsv[2]);this.rgb[0]=a[0];this.rgb[1]=a[1];this.rgb[2]=a[2];this.exportColor(k)};this.fromString=function(a,b){var c=a.match(/^\W*([0-9A-F]{3}([0-9A-F]{3})?)\W*$/i);return c?(6===c[1].length?this.fromRGB(parseInt(c[1].substr(0,2),16)/255,parseInt(c[1].substr(2,2),16)/255,parseInt(c[1].substr(4,
2),16)/255,b):this.fromRGB(parseInt(c[1].charAt(0)+c[1].charAt(0),16)/255,parseInt(c[1].charAt(1)+c[1].charAt(1),16)/255,parseInt(c[1].charAt(2)+c[1].charAt(2),16)/255,b),!0):!1};this.toString=function(){return(256|Math.round(255*this.rgb[0])).toString(16).substr(1)+(256|Math.round(255*this.rgb[1])).toString(16).substr(1)+(256|Math.round(255*this.rgb[2])).toString(16).substr(1)};var c=this,u="hvs"===this.pickerMode.toLowerCase()?1:0,w=!1,k=jscolor.fetchElement(this.valueElement),h=jscolor.fetchElement(this.styleElement),
q=!1,r=!1,t={},y=1,F=2,E=4,D=8;jscolor.isColorAttrSupported=!1;p=document.createElement("input");p.setAttribute&&(p.setAttribute("type","color"),"color"==p.type.toLowerCase()&&(jscolor.isColorAttrSupported=!0));jscolor.addEvent(a,"focus",function(){c.pickerOnfocus&&c.showPicker()});jscolor.addEvent(a,"blur",function(){w?w=!1:window.setTimeout(function(){w||(k===a&&c.importColor(),c.pickerOnfocus&&c.hidePicker());w=!1},0)});k&&(p=function(){c.fromString(k.value,y);x()},jscolor.addEvent(k,"keyup",p),
jscolor.addEvent(k,"input",p),jscolor.addEvent(k,"blur",H),k.setAttribute("autocomplete","off"));h&&(h.jscStyle={backgroundImage:h.style.backgroundImage,backgroundColor:h.style.backgroundColor,color:h.style.color});switch(u){case 0:jscolor.requireImage("hs.png");break;case 1:jscolor.requireImage("hv.png")}jscolor.requireImage("cross.gif");jscolor.requireImage("arrow.gif");this.importColor()}};jscolor.install();
