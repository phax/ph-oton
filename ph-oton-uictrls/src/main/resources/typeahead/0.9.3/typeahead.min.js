...
b.el||f.error("EventBus initialized without el");this.$el=f(b.el)}b.mixin(l.prototype,{trigger:function(b){var a=[].slice.call(arguments,1);this.$el.trigger("typeahead:"+b,a)}});return l}(),u=function(){function f(a){this.prefix=["__",a,"__"].join("");this.ttlKey="__ttl__";this.keyMatcher=new RegExp("^"+this.prefix)}function d(a){return JSON.stringify(b.isUndefined(a)?null:a)}var a;try{a=window.localStorage,a.setItem("~~~","!"),a.removeItem("~~~")}catch(c){a=null}b.mixin(f.prototype,a&&window.JSON?
{_prefix:function(a){return this.prefix+a},_ttlKey:function(a){return this._prefix(a)+this.ttlKey},get:function(b){this.isExpired(b)&&this.remove(b);b=a.getItem(this._prefix(b));return JSON.parse(b)},set:function(c,e,h){b.isNumber(h)?a.setItem(this._ttlKey(c),d((new Date).getTime()+h)):a.removeItem(this._ttlKey(c));return a.setItem(this._prefix(c),d(e))},remove:function(b){a.removeItem(this._ttlKey(b));a.removeItem(this._prefix(b));return this},clear:function(){var b,e,h=[],k=a.length;for(b=0;b<k;b++)(e=
a.key(b)).match(this.keyMatcher)&&h.push(e.replace(this.keyMatcher,""));for(b=h.length;b--;)this.remove(h[b]);return this},isExpired:function(c){c=a.getItem(this._ttlKey(c));c=JSON.parse(c);return b.isNumber(c)&&(new Date).getTime()>c?!0:!1}}:{get:b.noop,set:b.noop,remove:b.noop,clear:b.noop,isExpired:b.noop});return f}(),v=function(){function f(d){b.bindAll(this);d=d||{};this.sizeLimit=d.sizeLimit||10;this.cache={};this.cachedKeysByAge=[]}b.mixin(f.prototype,{get:function(b){return this.cache[b]},
set:function(b,a){var c;this.cachedKeysByAge.length===this.sizeLimit&&(c=this.cachedKeysByAge.shift(),delete this.cache[c]);this.cache[b]=a;this.cachedKeysByAge.push(b)}});return f}(),w=function(){function l(a){b.bindAll(this);a=b.isString(a)?{url:a}:a;e=e||new v;c=b.isNumber(a.maxParallelRequests)?a.maxParallelRequests:c||6;this.url=a.url;this.wildcard=a.wildcard||"%QUERY";this.filter=a.filter;this.replace=a.replace;this.ajaxSettings={type:"get",cache:a.cache,timeout:a.timeout,dataType:a.dataType||
"json",beforeSend:a.beforeSend};this._get=(/^throttle$/i.test(a.rateLimitFn)?b.throttle:b.debounce)(this._get,a.rateLimitWait||300)}var d=0,a={},c,e;b.mixin(l.prototype,{_get:function(a,b){function g(c){var g=f.filter?f.filter(c):c;b&&b(g);e.set(a,c)}var f=this;d<c?this._sendRequest(a).done(g):this.onDeckRequestArgs=[].slice.call(arguments,0)},_sendRequest:function(b){function e(){d--;a[b]=null;c.onDeckRequestArgs&&(c._get.apply(c,c.onDeckRequestArgs),c.onDeckRequestArgs=null)}var c=this,p=a[b];p||
(d++,p=a[b]=f.ajax(b,this.ajaxSettings).always(e));return p},get:function(a,c){var g=this,f=encodeURIComponent(a||""),d;c=c||b.noop;f=this.replace?this.replace(this.url,f):this.url.replace(this.wildcard,f);(d=e.get(f))?b.defer(function(){c(g.filter?g.filter(d):d)}):this._get(f,c);return!!d}});return l}(),x=function(){function l(a){b.bindAll(this);b.isString(a.template)&&!a.engine&&f.error("no template engine specified");a.local||a.prefetch||a.remote||f.error("one of local, prefetch, or remote is required");
this.name=a.name||b.getUniqueId();this.limit=a.limit||5;this.minLength=a.minLength||1;this.header=a.header;this.footer=a.footer;this.valueKey=a.valueKey||"value";this.template=d(a.template,a.engine,this.valueKey);this.local=a.local;this.prefetch=a.prefetch;this.remote=a.remote;this.itemHash={};this.adjacencyList={};this.storage=a.name?new u(a.name):null}function d(a,c,e){b.isFunction(a)||(b.isString(a)?(a=c.compile(a),a=b.bind(a.render,a)):a=function(a){return"<p>"+a[e]+"</p>"});return a}b.mixin(l.prototype,
{_processLocalData:function(a){this._mergeProcessedData(this._processData(a))},_loadPrefetchData:function(a){function c(c){c=a.filter?a.filter(c):c;c=e._processData(c);var k=c.itemHash,g=c.adjacencyList;e.storage&&(e.storage.set("itemHash",k,a.ttl),e.storage.set("adjacencyList",g,a.ttl),e.storage.set("thumbprint",h,a.ttl),e.storage.set("protocol",b.getProtocol(),a.ttl));e._mergeProcessedData(c)}var e=this,h="0.9.3"+(a.thumbprint||""),k,g,d,m;this.storage&&(k=this.storage.get("thumbprint"),g=this.storage.get("protocol"),
d=this.storage.get("itemHash"),m=this.storage.get("adjacencyList"));k=k!==h||g!==b.getProtocol();a=b.isString(a)?{url:a}:a;a.ttl=b.isNumber(a.ttl)?a.ttl:864E5;d&&m&&!k?(this._mergeProcessedData({itemHash:d,adjacencyList:m}),d=f.Deferred().resolve()):d=f.getJSON(a.url).done(c);return d},_transformDatum:function(a){var c=b.isString(a)?a:a[this.valueKey],e=a.tokens||b.tokenizeText(c),c={value:c,tokens:e};b.isString(a)?(c.datum={},c.datum[this.valueKey]=a):c.datum=a;c.tokens=b.filter(c.tokens,function(a){return!b.isBlankString(a)});
c.tokens=b.map(c.tokens,function(a){return a.toLowerCase()});return c},_processData:function(a){var c=this,e={},h={};b.each(a,function(a,g){var f=c._transformDatum(g),d=b.getUniqueId(f.value);e[d]=f;b.each(f.tokens,function(a,c){var e=c.charAt(0),e=h[e]||(h[e]=[d]);!~b.indexOf(e,d)&&e.push(d)})});return{itemHash:e,adjacencyList:h}},_mergeProcessedData:function(a){var c=this;b.mixin(this.itemHash,a.itemHash);b.each(a.adjacencyList,function(a,b){var k=c.adjacencyList[a];c.adjacencyList[a]=k?k.concat(b):
b})},_getLocalSuggestions:function(a){var c=this,e=[],h=[],k,g=[];b.each(a,function(a,c){var h=c.charAt(0);!~b.indexOf(e,h)&&e.push(h)});b.each(e,function(a,b){var e=c.adjacencyList[b];if(!e)return!1;h.push(e);if(!k||e.length<k.length)k=e});if(h.length<e.length)return[];b.each(k,function(e,k){var f=c.itemHash[k];b.every(h,function(a){return~b.indexOf(a,k)})&&b.every(a,function(a){return b.some(f.tokens,function(b){return 0===b.indexOf(a)})})&&g.push(f)});return g},initialize:function(){var a;this.local&&
this._processLocalData(this.local);this.transport=this.remote?new w(this.remote):null;a=this.prefetch?this._loadPrefetchData(this.prefetch):f.Deferred().resolve();this.local=this.prefetch=this.remote=null;this.initialize=function(){return a};return a},getSuggestions:function(a,c){function e(a){g=g.slice(0);b.each(a,function(a,e){var c=h._transformDatum(e);!b.some(g,function(a){return c.value===a.value})&&g.push(c);return g.length<h.limit});c&&c(g)}var h=this,k,g,f=!1;a.length<this.minLength||(k=b.tokenizeQuery(a),
g=this._getLocalSuggestions(k).slice(0,this.limit),g.length<this.limit&&this.transport&&(f=this.transport.get(a,e)),!f&&c&&c(g))}});return l}(),y=function(){function l(a){var c=this;b.bindAll(this);this.specialKeyCodeMap={9:"tab",27:"esc",37:"left",39:"right",13:"enter",38:"up",40:"down"};this.$hint=f(a.hint);this.$input=f(a.input).on("blur.tt",this._handleBlur).on("focus.tt",this._handleFocus).on("keydown.tt",this._handleSpecialKeyEvent);if(b.isMsie())this.$input.on("keydown.tt keypress.tt cut.tt paste.tt",
...
_moveCursor:function(a){var b,e;this.isVisible()&&(b=this._getSuggestions(),e=b.filter(".tt-is-under-cursor"),e.removeClass("tt-is-under-cursor"),a=b.index(e)+a,a=(a+1)%(b.length+1)-1,-1===a?this.trigger("cursorRemoved"):(-1>a&&(a=b.length-1),b=b.eq(a).addClass("tt-is-under-cursor"),this._ensureVisibility(b),this.trigger("cursorMoved",d(b))))},_getSuggestions:function(){return this.$menu.find(".tt-suggestions > .tt-suggestion")},_ensureVisibility:function(a){var b=this.$menu.height()+parseInt(this.$menu.css("paddingTop"),
10)+parseInt(this.$menu.css("paddingBottom"),10),e=this.$menu.scrollTop(),c=a.position().top;a=c+a.outerHeight(!0);0>c?this.$menu.scrollTop(e+c):b<a&&this.$menu.scrollTop(e+(a-b))},destroy:function(){this.$menu.off(".tt");this.$menu=null},isVisible:function(){return this.isOpen&&!this.isEmpty},closeUnlessMouseIsOverDropdown:function(){this.isMouseOverDropdown||this.close()},close:function(){this.isOpen&&(this.isMouseOverDropdown=this.isOpen=!1,this._hide(),this.$menu.find(".tt-suggestions > .tt-suggestion").removeClass("tt-is-under-cursor"),
this.trigger("closed"))},open:function(){this.isOpen||(this.isOpen=!0,!this.isEmpty&&this._show(),this.trigger("opened"))},setLanguageDirection:function(a){var b={left:"0",right:"auto"},e={left:"auto",right:" 0"};"ltr"===a?this.$menu.css(b):this.$menu.css(e)},moveCursorUp:function(){this._moveCursor(-1)},moveCursorDown:function(){this._moveCursor(1)},getSuggestionUnderCursor:function(){var a=this._getSuggestions().filter(".tt-is-under-cursor").first();return 0<a.length?d(a):null},getFirstSuggestion:function(){var a=
this._getSuggestions().first();return 0<a.length?d(a):null},renderSuggestions:function(h,k){var d="tt-dataset-"+h.name,l,m;m=this.$menu.find("."+d);var n,q,r;0===m.length&&(m=f('<span class="tt-suggestions"></span>').css(a),m=f("<div></div>").addClass(d).append(h.header).append(m).append(h.footer).appendTo(this.$menu));0<k.length?(this.isEmpty=!1,this.isOpen&&this._show(),n=document.createElement("div"),q=document.createDocumentFragment(),b.each(k,function(a,b){b.dataset=h.name;l=h.template(b.datum);
n.innerHTML='<div class="tt-suggestion">%body</div>'.replace("%body",l);r=f(n.firstChild).css(c).data("suggestion",b);r.children().each(function(){f(this).css(e)});q.appendChild(r[0])}),m.show().find(".tt-suggestions").html(q)):this.clearSuggestions(h.name);this.trigger("suggestionsRendered")},clearSuggestions:function(a){a=a?this.$menu.find(".tt-dataset-"+a):this.$menu.find('[class^="tt-dataset-"]');var b=a.find(".tt-suggestions");a.hide();b.empty();0===this._getSuggestions().length&&(this.isEmpty=
!0,this._hide())}});return l}(),A=function(){function l(e){var h,d;b.bindAll(this);var g=e.input;h=f(a.wrapper);d=f(a.dropdown);var g=f(g),l=f(a.hint);h=h.css(c.wrapper);d=d.css(c.dropdown);l.css(c.hint).css({backgroundAttachment:g.css("background-attachment"),backgroundClip:g.css("background-clip"),backgroundColor:g.css("background-color"),backgroundImage:g.css("background-image"),backgroundOrigin:g.css("background-origin"),backgroundPosition:g.css("background-position"),backgroundRepeat:g.css("background-repeat"),
backgroundSize:g.css("background-size")});g.data("ttAttrs",{dir:g.attr("dir"),autocomplete:g.attr("autocomplete"),spellcheck:g.attr("spellcheck"),style:g.attr("style")});g.addClass("tt-query").attr({autocomplete:"off",spellcheck:!1}).css(c.query);try{!g.attr("dir")&&g.attr("dir","auto")}catch(m){}this.$node=g.wrap(h).parent().prepend(l).append(d);this.datasets=e.datasets;this.dir=null;this.eventBus=e.eventBus;e=this.$node.find(".tt-dropdown-menu");h=this.$node.find(".tt-query");d=this.$node.find(".tt-hint");
this.dropdownView=(new z({menu:e})).on("suggestionSelected",this._handleSelection).on("cursorMoved",this._clearHint).on("cursorMoved",this._setInputValueToSuggestionUnderCursor).on("cursorRemoved",this._setInputValueToQuery).on("cursorRemoved",this._updateHint).on("suggestionsRendered",this._updateHint).on("opened",this._updateHint).on("closed",this._clearHint).on("opened closed",this._propagateEvent);this.inputView=(new y({input:h,hint:d})).on("focused",this._openDropdown).on("blured",this._closeDropdown).on("blured",
...
this.$node=null},setQuery:function(a){this.inputView.setQuery(a);this.inputView.setInputValue(a);this._clearHint();this._clearSuggestions();this._getSuggestions()}});return l}();(function(){var l={},d;d={initialize:function(a){var c;a=b.isArray(a)?a:[a];0===a.length&&f.error("no datasets provided");c=b.map(a,function(a){var b=l[a.name]?l[a.name]:new x(a);a.name&&(l[a.name]=b);return b});return this.each(function(){var a=f(this),d,k=new t({el:a});d=b.map(c,function(a){return a.initialize()});a.data("ttView",
new A({input:a,eventBus:k=new t({el:a}),datasets:c}));f.when.apply(f,d).always(function(){b.defer(function(){k.trigger("initialized")})})})},destroy:function(){return this.each(function(){var a=f(this),b=a.data("ttView");b&&(b.destroy(),a.removeData("ttView"))})},setQuery:function(a){return this.each(function(){var b=f(this).data("ttView");b&&b.setQuery(a)})}};jQuery.fn.typeahead=function(a){return d[a]?d[a].apply(this,[].slice.call(arguments,1)):d.initialize.apply(this,arguments)}})()})(window.jQuery);
