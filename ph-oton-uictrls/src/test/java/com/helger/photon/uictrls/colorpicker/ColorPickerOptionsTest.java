 ...
 */
public final class ColorPickerOptionsTest
{
  @Test
  public void testBasic ()
  {
    final JSWriterSettings aJSWS = new JSWriterSettings ().setIndentAndAlign (false);
    final ColorPickerOptions c = new ColorPickerOptions ();
    assertNotNull (c.getJSOptions ());
    assertEquals ("{}", c.getJSOptions ().getJSCode (aJSWS));
  }
}
