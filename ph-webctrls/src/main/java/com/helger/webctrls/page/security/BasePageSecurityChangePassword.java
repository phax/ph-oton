  ...
  protected void fillContent (@Nonnull final WPECTYPE aWPEC)
  {
    ...
    if (aCurrentUser == null)
    {
      aNodeList.addChild (getStyler ().createErrorBox (aWPEC,
                                                       EText.ERROR_NO_USER_PRESENT.getDisplayText (aDisplayLocale)));
    }
    else
    {
        ...
        if (checkCSRFNonce (aWPEC).isContinue ())
        {
          ...
          if (aFormErrors.isEmpty ())
          {
            ...
            aNodeList.addChild (getStyler ().createSuccessBox (aWPEC,
                                                               EText.SUCCESS_CHANGE_PW.getDisplayText (aDisplayLocale)));
            // Always show form
          }
        }
      }
      if (bShowForm)
      {
        ...
        aTable.createItemRow ()
              ...
              .setNote (getStyler ().createPasswordConstraintToolTip (aWPEC))
