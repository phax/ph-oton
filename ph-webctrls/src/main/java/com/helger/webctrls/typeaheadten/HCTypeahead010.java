...
import com.helger.webctrls.typeahead.TypeaheadDataset;
...
public class HCTypeahead010 implements IHCNodeBuilder
{
  ...
  {
    PerRequestJSIncludes.registerJSIncludeForThisRequest (EWebCtrlsJSPathProvider.TYPEAHEAD_0_10);
    PerRequestJSIncludes.registerJSIncludeForThisRequest (EWebCtrlsJSPathProvider.TYPEAHEAD_PH);
    PerRequestCSSIncludes.registerCSSIncludeForThisRequest (EWebCtrlsCSSPathProvider.TYPEAHEAD_BOOTSTRAP);
  }
}
