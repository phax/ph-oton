(function(){if(jQuery&&jQuery.fn&&jQuery.fn.select2&&jQuery.fn.select2.amd)var b=jQuery.fn.select2.amd;return b.define("select2/i18n/hr",[],function(){function b(a){var c=" "+a+" znak";return 5>a%10&&0<a%10&&(5>a%100||19<a%100)?1<a%10&&(c+="a"):c+="ova",c}return{inputTooLong:function(a){return"Unesite "+b(a.input.length-a.maximum)},inputTooShort:function(a){return"Unesite još "+b(a.minimum-a.input.length)},loadingMore:function(){return"Učitavanje rezultata…"},maximumSelected:function(a){return"Maksimalan broj odabranih stavki je "+
