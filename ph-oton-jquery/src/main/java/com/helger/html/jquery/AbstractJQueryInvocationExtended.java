...
@Nonnull
public THISTYPE add(@Nonnull final IJSExpression selector) { return add ().arg (selector); }

@Nonnull
public THISTYPE add(@Nonnull final IJQuerySelector selector) { return add ().arg (selector); }

@Nonnull
public THISTYPE add(@Nonnull final JQuerySelectorList selector) { return add ().arg (selector); }

@Nonnull
public THISTYPE add(@Nonnull final EHTMLElement selector) { return add ().arg (selector); }

@Nonnull
public THISTYPE add(@Nonnull final ICSSClassProvider selector) { return add ().arg (selector); }

@Nonnull
public THISTYPE add(@Nonnull final String elements) { return add ().arg (elements); }

@Nonnull
public THISTYPE add(@Nonnull final IHCNode html) { return add ().arg (html); }

@Nonnull
public THISTYPE add(@Nonnull final JQueryInvocation selection) { return add ().arg (selection); }
...
@Nonnull
public THISTYPE addBack(@Nonnull final IJSExpression selector) { return addBack ().arg (selector); }

@Nonnull
public THISTYPE addBack(@Nonnull final IJQuerySelector selector) { return addBack ().arg (selector); }

@Nonnull
public THISTYPE addBack(@Nonnull final JQuerySelectorList selector) { return addBack ().arg (selector); }

@Nonnull
public THISTYPE addBack(@Nonnull final EHTMLElement selector) { return addBack ().arg (selector); }

@Nonnull
public THISTYPE addBack(@Nonnull final ICSSClassProvider selector) { return addBack ().arg (selector); }

@Nonnull
public THISTYPE addClass(@Nonnull final IJSExpression className) { return addClass ().arg (className); }

@Nonnull
public THISTYPE addClass(@Nonnull final IJson className) { return addClass ().arg (className); }

@Nonnull
public THISTYPE addClass(@Nonnull final IHCNode className) { return addClass ().arg (className); }

@Nonnull
public THISTYPE addClass(@Nonnull final String className) { return addClass ().arg (className); }

@Nonnull
public THISTYPE addClass(@Nonnull final JSAnonymousFunction function) { return addClass ().arg (function); }

@Nonnull
public THISTYPE after(@Nonnull final IJSExpression content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final IHCNode content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final String content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final EHTMLElement content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final IJson content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final JSArray content) { return after ().arg (content); }

@Nonnull
public THISTYPE after(@Nonnull final JQueryInvocation content) { return after ().arg (content); }
...
@Nonnull
public THISTYPE after(@Nonnull final JSAnonymousFunction function) { return after ().arg (function); }

@Nonnull
public THISTYPE ajaxComplete(@Nonnull final IJSExpression handler) { return ajaxComplete ().arg (handler); }

@Nonnull
public THISTYPE ajaxComplete(@Nonnull final JSAnonymousFunction handler) { return ajaxComplete ().arg (handler); }

@Nonnull
public THISTYPE ajaxError(@Nonnull final IJSExpression handler) { return ajaxError ().arg (handler); }

@Nonnull
public THISTYPE ajaxError(@Nonnull final JSAnonymousFunction handler) { return ajaxError ().arg (handler); }

@Nonnull
public THISTYPE ajaxSend(@Nonnull final IJSExpression handler) { return ajaxSend ().arg (handler); }

@Nonnull
public THISTYPE ajaxSend(@Nonnull final JSAnonymousFunction handler) { return ajaxSend ().arg (handler); }

@Nonnull
public THISTYPE ajaxStart(@Nonnull final IJSExpression handler) { return ajaxStart ().arg (handler); }

@Nonnull
public THISTYPE ajaxStart(@Nonnull final JSAnonymousFunction handler) { return ajaxStart ().arg (handler); }

@Nonnull
public THISTYPE ajaxStop(@Nonnull final IJSExpression handler) { return ajaxStop ().arg (handler); }

@Nonnull
public THISTYPE ajaxStop(@Nonnull final JSAnonymousFunction handler) { return ajaxStop ().arg (handler); }

@Nonnull
public THISTYPE ajaxSuccess(@Nonnull final IJSExpression handler) { return ajaxSuccess ().arg (handler); }

@Nonnull
public THISTYPE ajaxSuccess(@Nonnull final JSAnonymousFunction handler) { return ajaxSuccess ().arg (handler); }

@Nonnull
public THISTYPE animate(@Nonnull final IJSExpression properties) { return animate ().arg (properties); }

@Nonnull
public THISTYPE append(@Nonnull final IJSExpression content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final IHCNode content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final String content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final EHTMLElement content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final IJson content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final JSArray content) { return append ().arg (content); }

@Nonnull
public THISTYPE append(@Nonnull final JQueryInvocation content) { return append ().arg (content); }
...
@Nonnull
public THISTYPE append(@Nonnull final JSAnonymousFunction function) { return append ().arg (function); }

@Nonnull
public THISTYPE appendTo(@Nonnull final IJSExpression target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final IJQuerySelector target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final JQuerySelectorList target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final EHTMLElement target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final ICSSClassProvider target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final IHCNode target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final String target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final JSArray target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE appendTo(@Nonnull final JQueryInvocation target) { return appendTo ().arg (target); }

@Nonnull
public THISTYPE attr(@Nonnull final IJSExpression attributeName) { return attr ().arg (attributeName); }

@Nonnull
public THISTYPE attr(@Nonnull final IJson attributeName) { return attr ().arg (attributeName); }

@Nonnull
public THISTYPE attr(@Nonnull final IHCNode attributeName) { return attr ().arg (attributeName); }
...
@Nonnull
public THISTYPE before(@Nonnull final IHCNode content) { return before ().arg (content); }

@Nonnull
public THISTYPE before(@Nonnull final String content) { return before ().arg (content); }

@Nonnull
public THISTYPE before(@Nonnull final EHTMLElement content) { return before ().arg (content); }

@Nonnull
public THISTYPE before(@Nonnull final IJson content) { return before ().arg (content); }

@Nonnull
public THISTYPE before(@Nonnull final JSArray content) { return before ().arg (content); }

@Nonnull
public THISTYPE before(@Nonnull final JQueryInvocation content) { return before ().arg (content); }
...
@Nonnull
public THISTYPE before(@Nonnull final JSAnonymousFunction function) { return before ().arg (function); }
...
@Deprecated
@Nonnull
public THISTYPE bind(@Nonnull final IJSExpression eventType) { return bind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE bind(@Nonnull final IJson eventType) { return bind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE bind(@Nonnull final IHCNode eventType) { return bind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE bind(@Nonnull final String eventType) { return bind ().arg (eventType); }
...
@Nonnull
public THISTYPE blur(@Nonnull final IJSExpression handler) { return blur ().arg (handler); }

@Nonnull
public THISTYPE blur(@Nonnull final JSAnonymousFunction handler) { return blur ().arg (handler); }
...
@Nonnull
public THISTYPE callbacks_add(@Nonnull final IJSExpression callbacks) { return callbacks_add ().arg (callbacks); }

@Nonnull
public THISTYPE callbacks_add(@Nonnull final JSAnonymousFunction callbacks) { return callbacks_add ().arg (callbacks); }

@Nonnull
public THISTYPE callbacks_add(@Nonnull final JSArray callbacks) { return callbacks_add ().arg (callbacks); }

@Nonnull
public THISTYPE callbacks_fire(@Nonnull final IJSExpression arguments) { return callbacks_fire ().arg (arguments); }

@Nonnull
public THISTYPE callbacks_fireWith(@Nonnull final IJSExpression context) { return callbacks_fireWith ().arg (context); }
...
@Nonnull
public THISTYPE callbacks_has(@Nonnull final IJSExpression callback) { return callbacks_has ().arg (callback); }

@Nonnull
public THISTYPE callbacks_has(@Nonnull final JSAnonymousFunction callback) { return callbacks_has ().arg (callback); }

@Nonnull
public THISTYPE callbacks_remove(@Nonnull final IJSExpression callbacks) { return callbacks_remove ().arg (callbacks); }

@Nonnull
public THISTYPE callbacks_remove(@Nonnull final JSAnonymousFunction callbacks) { return callbacks_remove ().arg (callbacks); }

@Nonnull
public THISTYPE callbacks_remove(@Nonnull final JSArray callbacks) { return callbacks_remove ().arg (callbacks); }

@Nonnull
public THISTYPE change(@Nonnull final IJSExpression handler) { return change ().arg (handler); }

@Nonnull
public THISTYPE change(@Nonnull final JSAnonymousFunction handler) { return change ().arg (handler); }
...
@Nonnull
public THISTYPE children(@Nonnull final IJSExpression selector) { return children ().arg (selector); }

@Nonnull
public THISTYPE children(@Nonnull final IJQuerySelector selector) { return children ().arg (selector); }

@Nonnull
public THISTYPE children(@Nonnull final JQuerySelectorList selector) { return children ().arg (selector); }

@Nonnull
public THISTYPE children(@Nonnull final EHTMLElement selector) { return children ().arg (selector); }

@Nonnull
public THISTYPE children(@Nonnull final ICSSClassProvider selector) { return children ().arg (selector); }

@Nonnull
public THISTYPE clearQueue(@Nonnull final IJSExpression queueName) { return clearQueue ().arg (queueName); }

@Nonnull
public THISTYPE clearQueue(@Nonnull final IJson queueName) { return clearQueue ().arg (queueName); }

@Nonnull
public THISTYPE clearQueue(@Nonnull final IHCNode queueName) { return clearQueue ().arg (queueName); }

@Nonnull
public THISTYPE clearQueue(@Nonnull final String queueName) { return clearQueue ().arg (queueName); }

@Nonnull
public THISTYPE click(@Nonnull final IJSExpression handler) { return click ().arg (handler); }

@Nonnull
public THISTYPE click(@Nonnull final JSAnonymousFunction handler) { return click ().arg (handler); }
...
@Nonnull
public THISTYPE _clone(@Nonnull final IJSExpression withDataAndEvents) { return _clone ().arg (withDataAndEvents); }

@Nonnull
public THISTYPE _clone(final boolean withDataAndEvents) { return _clone ().arg (withDataAndEvents); }
...
@Nonnull
public THISTYPE closest(@Nonnull final IJSExpression selector) { return closest ().arg (selector); }

@Nonnull
public THISTYPE closest(@Nonnull final IJQuerySelector selector) { return closest ().arg (selector); }

@Nonnull
public THISTYPE closest(@Nonnull final JQuerySelectorList selector) { return closest ().arg (selector); }

@Nonnull
public THISTYPE closest(@Nonnull final EHTMLElement selector) { return closest ().arg (selector); }

@Nonnull
public THISTYPE closest(@Nonnull final ICSSClassProvider selector) { return closest ().arg (selector); }
...
@Nonnull
public THISTYPE closest(@Nonnull final JQueryInvocation selection) { return closest ().arg (selection); }

@Nonnull
public THISTYPE closest(@Nonnull final String element) { return closest ().arg (element); }

@Deprecated
@Nonnull
public THISTYPE closest(@Nonnull final JSArray selectors) { return closest ().arg (selectors); }
...
@Nonnull
public THISTYPE contextmenu(@Nonnull final IJSExpression handler) { return contextmenu ().arg (handler); }

@Nonnull
public THISTYPE contextmenu(@Nonnull final JSAnonymousFunction handler) { return contextmenu ().arg (handler); }
...
@Nonnull
public THISTYPE css(@Nonnull final IJSExpression propertyName) { return css ().arg (propertyName); }

@Nonnull
public THISTYPE css(@Nonnull final IJson propertyName) { return css ().arg (propertyName); }

@Nonnull
public THISTYPE css(@Nonnull final IHCNode propertyName) { return css ().arg (propertyName); }

@Nonnull
public THISTYPE css(@Nonnull final String propertyName) { return css ().arg (propertyName); }

@Nonnull
public THISTYPE css(@Nonnull final JSArray propertyNames) { return css ().arg (propertyNames); }
...
@Nonnull
public THISTYPE data(@Nonnull final IJSExpression obj) { return data ().arg (obj); }

@Nonnull
public THISTYPE data(@Nonnull final IJson key) { return data ().arg (key); }

@Nonnull
public THISTYPE data(@Nonnull final IHCNode key) { return data ().arg (key); }

@Nonnull
public THISTYPE data(@Nonnull final String key) { return data ().arg (key); }

@Nonnull
public THISTYPE dblclick(@Nonnull final IJSExpression handler) { return dblclick ().arg (handler); }

@Nonnull
public THISTYPE dblclick(@Nonnull final JSAnonymousFunction handler) { return dblclick ().arg (handler); }
...
@Nonnull
public THISTYPE deferred_always(@Nonnull final IJSExpression alwaysCallbacks) { return deferred_always ().arg (alwaysCallbacks); }

@Nonnull
public THISTYPE deferred_always(@Nonnull final JSAnonymousFunction alwaysCallbacks) { return deferred_always ().arg (alwaysCallbacks); }
...
@Nonnull
public THISTYPE deferred_done(@Nonnull final IJSExpression doneCallbacks) { return deferred_done ().arg (doneCallbacks); }

@Nonnull
public THISTYPE deferred_done(@Nonnull final JSAnonymousFunction doneCallbacks) { return deferred_done ().arg (doneCallbacks); }
...
@Nonnull
public THISTYPE deferred_fail(@Nonnull final IJSExpression failCallbacks) { return deferred_fail ().arg (failCallbacks); }

@Nonnull
public THISTYPE deferred_fail(@Nonnull final JSAnonymousFunction failCallbacks) { return deferred_fail ().arg (failCallbacks); }
...
@Nonnull
public THISTYPE deferred_notify(@Nonnull final IJSExpression args) { return deferred_notify ().arg (args); }

@Nonnull
public THISTYPE deferred_notifyWith(@Nonnull final IJSExpression context) { return deferred_notifyWith ().arg (context); }
...
@Deprecated
@Nonnull
public THISTYPE deferred_pipe(@Nonnull final IJSExpression doneFilter) { return deferred_pipe ().arg (doneFilter); }

@Deprecated
@Nonnull
public THISTYPE deferred_pipe(@Nonnull final JSAnonymousFunction doneFilter) { return deferred_pipe ().arg (doneFilter); }
...
@Nonnull
public THISTYPE deferred_progress(@Nonnull final IJSExpression progressCallbacks) { return deferred_progress ().arg (progressCallbacks); }

@Nonnull
public THISTYPE deferred_progress(@Nonnull final JSAnonymousFunction progressCallbacks) { return deferred_progress ().arg (progressCallbacks); }

@Nonnull
public THISTYPE deferred_progress(@Nonnull final JSArray progressCallbacks) { return deferred_progress ().arg (progressCallbacks); }
...
@Nonnull
public THISTYPE deferred_promise(@Nonnull final IJSExpression target) { return deferred_promise ().arg (target); }

@Nonnull
public THISTYPE deferred_reject(@Nonnull final IJSExpression args) { return deferred_reject ().arg (args); }

@Nonnull
public THISTYPE deferred_rejectWith(@Nonnull final IJSExpression context) { return deferred_rejectWith ().arg (context); }
...
@Nonnull
public THISTYPE deferred_resolve(@Nonnull final IJSExpression args) { return deferred_resolve ().arg (args); }

@Nonnull
public THISTYPE deferred_resolveWith(@Nonnull final IJSExpression context) { return deferred_resolveWith ().arg (context); }
...
@Nonnull
public THISTYPE deferred_then(@Nonnull final IJSExpression doneFilter) { return deferred_then ().arg (doneFilter); }

@Nonnull
public THISTYPE deferred_then(@Nonnull final JSAnonymousFunction doneFilter) { return deferred_then ().arg (doneFilter); }
...
@Nonnull
public THISTYPE delay(@Nonnull final IJSExpression duration) { return delay ().arg (duration); }

@Nonnull
public THISTYPE delay(final int duration) { return delay ().arg (duration); }

@Nonnull
public THISTYPE delay(final long duration) { return delay ().arg (duration); }

@Nonnull
public THISTYPE delay(@Nonnull final BigInteger duration) { return delay ().arg (duration); }
...
@Nonnull
public THISTYPE dequeue(@Nonnull final IJSExpression queueName) { return dequeue ().arg (queueName); }

@Nonnull
public THISTYPE dequeue(@Nonnull final IJson queueName) { return dequeue ().arg (queueName); }

@Nonnull
public THISTYPE dequeue(@Nonnull final IHCNode queueName) { return dequeue ().arg (queueName); }

@Nonnull
public THISTYPE dequeue(@Nonnull final String queueName) { return dequeue ().arg (queueName); }

@Nonnull
public THISTYPE detach(@Nonnull final IJSExpression selector) { return detach ().arg (selector); }

@Nonnull
public THISTYPE detach(@Nonnull final IJQuerySelector selector) { return detach ().arg (selector); }

@Nonnull
public THISTYPE detach(@Nonnull final JQuerySelectorList selector) { return detach ().arg (selector); }

@Nonnull
public THISTYPE detach(@Nonnull final EHTMLElement selector) { return detach ().arg (selector); }

@Nonnull
public THISTYPE detach(@Nonnull final ICSSClassProvider selector) { return detach ().arg (selector); }

@Deprecated
@Nonnull
public THISTYPE die(@Nonnull final IJSExpression eventType) { return die ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE die(@Nonnull final IJson eventType) { return die ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE die(@Nonnull final IHCNode eventType) { return die ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE die(@Nonnull final String eventType) { return die ().arg (eventType); }
...
@Nonnull
public THISTYPE each(@Nonnull final IJSExpression function) { return each ().arg (function); }

@Nonnull
public THISTYPE each(@Nonnull final JSAnonymousFunction function) { return each ().arg (function); }

@Nonnull
public THISTYPE _eq(@Nonnull final IJSExpression index) { return _eq ().arg (index); }

@Nonnull
public THISTYPE _eq(final int index) { return _eq ().arg (index); }

@Nonnull
public THISTYPE _eq(final long index) { return _eq ().arg (index); }

@Nonnull
public THISTYPE _eq(@Nonnull final BigInteger index) { return _eq ().arg (index); }

@Deprecated
@Nonnull
public THISTYPE error(@Nonnull final IJSExpression handler) { return error ().arg (handler); }

@Deprecated
@Nonnull
public THISTYPE error(@Nonnull final JSAnonymousFunction handler) { return error ().arg (handler); }
...
@Nonnull
public THISTYPE filter(@Nonnull final IJSExpression selector) { return filter ().arg (selector); }

@Nonnull
public THISTYPE filter(@Nonnull final IJQuerySelector selector) { return filter ().arg (selector); }

@Nonnull
public THISTYPE filter(@Nonnull final JQuerySelectorList selector) { return filter ().arg (selector); }

@Nonnull
public THISTYPE filter(@Nonnull final EHTMLElement selector) { return filter ().arg (selector); }

@Nonnull
public THISTYPE filter(@Nonnull final ICSSClassProvider selector) { return filter ().arg (selector); }

@Nonnull
public THISTYPE filter(@Nonnull final JSAnonymousFunction function) { return filter ().arg (function); }

@Nonnull
public THISTYPE filter(@Nonnull final String elements) { return filter ().arg (elements); }

@Nonnull
public THISTYPE filter(@Nonnull final JQueryInvocation selection) { return filter ().arg (selection); }

@Nonnull
public THISTYPE find(@Nonnull final IJSExpression selector) { return find ().arg (selector); }

@Nonnull
public THISTYPE find(@Nonnull final IJQuerySelector selector) { return find ().arg (selector); }

@Nonnull
public THISTYPE find(@Nonnull final JQuerySelectorList selector) { return find ().arg (selector); }

@Nonnull
public THISTYPE find(@Nonnull final EHTMLElement selector) { return find ().arg (selector); }

@Nonnull
public THISTYPE find(@Nonnull final ICSSClassProvider selector) { return find ().arg (selector); }

@Nonnull
public THISTYPE find(@Nonnull final String element) { return find ().arg (element); }

@Nonnull
public THISTYPE find(@Nonnull final JQueryInvocation element) { return find ().arg (element); }

@Nonnull
public THISTYPE finish(@Nonnull final IJSExpression queue) { return finish ().arg (queue); }

@Nonnull
public THISTYPE finish(@Nonnull final IJson queue) { return finish ().arg (queue); }

@Nonnull
public THISTYPE finish(@Nonnull final IHCNode queue) { return finish ().arg (queue); }

@Nonnull
public THISTYPE finish(@Nonnull final String queue) { return finish ().arg (queue); }

@Nonnull
public THISTYPE focus(@Nonnull final IJSExpression handler) { return focus ().arg (handler); }

@Nonnull
public THISTYPE focus(@Nonnull final JSAnonymousFunction handler) { return focus ().arg (handler); }
...
@Nonnull
public THISTYPE focusin(@Nonnull final IJSExpression handler) { return focusin ().arg (handler); }

@Nonnull
public THISTYPE focusin(@Nonnull final JSAnonymousFunction handler) { return focusin ().arg (handler); }
...
@Nonnull
public THISTYPE focusout(@Nonnull final IJSExpression handler) { return focusout ().arg (handler); }

@Nonnull
public THISTYPE focusout(@Nonnull final JSAnonymousFunction handler) { return focusout ().arg (handler); }
...
@Nonnull
public THISTYPE get(@Nonnull final IJSExpression index) { return get ().arg (index); }

@Nonnull
public THISTYPE get(final int index) { return get ().arg (index); }

@Nonnull
public THISTYPE get(final long index) { return get ().arg (index); }

@Nonnull
public THISTYPE get(@Nonnull final BigInteger index) { return get ().arg (index); }

@Nonnull
public THISTYPE has(@Nonnull final IJSExpression selector) { return has ().arg (selector); }

@Nonnull
public THISTYPE has(@Nonnull final IJson selector) { return has ().arg (selector); }

@Nonnull
public THISTYPE has(@Nonnull final IHCNode selector) { return has ().arg (selector); }

@Nonnull
public THISTYPE has(@Nonnull final String selector) { return has ().arg (selector); }

@Nonnull
public THISTYPE has(@Nonnull final EHTMLElement contained) { return has ().arg (contained); }

@Nonnull
public THISTYPE hasClass(@Nonnull final IJSExpression className) { return hasClass ().arg (className); }

@Nonnull
public THISTYPE hasClass(@Nonnull final IJson className) { return hasClass ().arg (className); }

@Nonnull
public THISTYPE hasClass(@Nonnull final IHCNode className) { return hasClass ().arg (className); }

@Nonnull
public THISTYPE hasClass(@Nonnull final String className) { return hasClass ().arg (className); }

@Nonnull
public THISTYPE height(@Nonnull final IJSExpression value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final IJson value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final IHCNode value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final String value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(final int value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(final long value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final BigInteger value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(final double value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final BigDecimal value) { return height ().arg (value); }

@Nonnull
public THISTYPE height(@Nonnull final JSAnonymousFunction function) { return height ().arg (function); }

@Nonnull
public THISTYPE hide(@Nonnull final IJSExpression duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(final int duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(final long duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(@Nonnull final BigInteger duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(final double duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(@Nonnull final BigDecimal duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(@Nonnull final IJson duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(@Nonnull final IHCNode duration) { return hide ().arg (duration); }

@Nonnull
public THISTYPE hide(@Nonnull final String duration) { return hide ().arg (duration); }
...
@Nonnull
public THISTYPE hover(@Nonnull final IJSExpression handlerInOut) { return hover ().arg (handlerInOut); }

@Nonnull
public THISTYPE hover(@Nonnull final JSAnonymousFunction handlerInOut) { return hover ().arg (handlerInOut); }

@Nonnull
public THISTYPE html(@Nonnull final IJSExpression htmlString) { return html ().arg (htmlString); }

@Nonnull
public THISTYPE html(@Nonnull final IHCNode htmlString) { return html ().arg (htmlString); }

@Nonnull
public THISTYPE html(@Nonnull final String htmlString) { return html ().arg (htmlString); }

@Nonnull
public THISTYPE html(@Nonnull final JSAnonymousFunction function) { return html ().arg (function); }

@Nonnull
public THISTYPE index(@Nonnull final IJSExpression selector) { return index ().arg (selector); }

@Nonnull
public THISTYPE index(@Nonnull final IJQuerySelector selector) { return index ().arg (selector); }

@Nonnull
public THISTYPE index(@Nonnull final JQuerySelectorList selector) { return index ().arg (selector); }

@Nonnull
public THISTYPE index(@Nonnull final EHTMLElement selector) { return index ().arg (selector); }

@Nonnull
public THISTYPE index(@Nonnull final ICSSClassProvider selector) { return index ().arg (selector); }

@Nonnull
public THISTYPE index(@Nonnull final String element) { return index ().arg (element); }

@Nonnull
public THISTYPE index(@Nonnull final JQueryInvocation element) { return index ().arg (element); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final IJSExpression value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final IJson value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final IHCNode value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final String value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(final int value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(final long value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final BigInteger value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(final double value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final BigDecimal value) { return innerHeight ().arg (value); }

@Nonnull
public THISTYPE innerHeight(@Nonnull final JSAnonymousFunction function) { return innerHeight ().arg (function); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final IJSExpression value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final IJson value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final IHCNode value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final String value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(final int value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(final long value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final BigInteger value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(final double value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final BigDecimal value) { return innerWidth ().arg (value); }

@Nonnull
public THISTYPE innerWidth(@Nonnull final JSAnonymousFunction function) { return innerWidth ().arg (function); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final IJSExpression target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final IJQuerySelector target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final JQuerySelectorList target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final EHTMLElement target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final ICSSClassProvider target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final IHCNode target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final String target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final JSArray target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertAfter(@Nonnull final JQueryInvocation target) { return insertAfter ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final IJSExpression target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final IJQuerySelector target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final JQuerySelectorList target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final EHTMLElement target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final ICSSClassProvider target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final IHCNode target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final String target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final JSArray target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE insertBefore(@Nonnull final JQueryInvocation target) { return insertBefore ().arg (target); }

@Nonnull
public THISTYPE is(@Nonnull final IJSExpression selector) { return is ().arg (selector); }

@Nonnull
public THISTYPE is(@Nonnull final IJQuerySelector selector) { return is ().arg (selector); }

@Nonnull
public THISTYPE is(@Nonnull final JQuerySelectorList selector) { return is ().arg (selector); }

@Nonnull
public THISTYPE is(@Nonnull final EHTMLElement selector) { return is ().arg (selector); }

@Nonnull
public THISTYPE is(@Nonnull final ICSSClassProvider selector) { return is ().arg (selector); }

@Nonnull
public THISTYPE is(@Nonnull final JSAnonymousFunction function) { return is ().arg (function); }

@Nonnull
public THISTYPE is(@Nonnull final JQueryInvocation selection) { return is ().arg (selection); }

@Nonnull
public THISTYPE is(@Nonnull final String elements) { return is ().arg (elements); }

@Nonnull
public THISTYPE keydown(@Nonnull final IJSExpression handler) { return keydown ().arg (handler); }

@Nonnull
public THISTYPE keydown(@Nonnull final JSAnonymousFunction handler) { return keydown ().arg (handler); }
...
@Nonnull
public THISTYPE keypress(@Nonnull final IJSExpression handler) { return keypress ().arg (handler); }

@Nonnull
public THISTYPE keypress(@Nonnull final JSAnonymousFunction handler) { return keypress ().arg (handler); }
...
@Nonnull
public THISTYPE keyup(@Nonnull final IJSExpression handler) { return keyup ().arg (handler); }

@Nonnull
public THISTYPE keyup(@Nonnull final JSAnonymousFunction handler) { return keyup ().arg (handler); }
...
@Deprecated
@Nonnull
public THISTYPE live(@Nonnull final IJSExpression events) { return live ().arg (events); }

@Deprecated
@Nonnull
public THISTYPE load(@Nonnull final IJSExpression handler) { return load ().arg (handler); }

@Deprecated
@Nonnull
public THISTYPE load(@Nonnull final JSAnonymousFunction handler) { return load ().arg (handler); }
...
@Nonnull
public THISTYPE load(@Nonnull final IJson url) { return load ().arg (url); }

@Nonnull
public THISTYPE load(@Nonnull final IHCNode url) { return load ().arg (url); }

@Nonnull
public THISTYPE load(@Nonnull final String url) { return load ().arg (url); }
...
@Nonnull
public THISTYPE map(@Nonnull final IJSExpression callback) { return map ().arg (callback); }

@Nonnull
public THISTYPE map(@Nonnull final JSAnonymousFunction callback) { return map ().arg (callback); }

@Nonnull
public THISTYPE mousedown(@Nonnull final IJSExpression handler) { return mousedown ().arg (handler); }

@Nonnull
public THISTYPE mousedown(@Nonnull final JSAnonymousFunction handler) { return mousedown ().arg (handler); }
...
@Nonnull
public THISTYPE mouseenter(@Nonnull final IJSExpression handler) { return mouseenter ().arg (handler); }

@Nonnull
public THISTYPE mouseenter(@Nonnull final JSAnonymousFunction handler) { return mouseenter ().arg (handler); }
...
@Nonnull
public THISTYPE mouseleave(@Nonnull final IJSExpression handler) { return mouseleave ().arg (handler); }

@Nonnull
public THISTYPE mouseleave(@Nonnull final JSAnonymousFunction handler) { return mouseleave ().arg (handler); }
...
@Nonnull
public THISTYPE mousemove(@Nonnull final IJSExpression handler) { return mousemove ().arg (handler); }

@Nonnull
public THISTYPE mousemove(@Nonnull final JSAnonymousFunction handler) { return mousemove ().arg (handler); }
...
@Nonnull
public THISTYPE mouseout(@Nonnull final IJSExpression handler) { return mouseout ().arg (handler); }

@Nonnull
public THISTYPE mouseout(@Nonnull final JSAnonymousFunction handler) { return mouseout ().arg (handler); }
...
@Nonnull
public THISTYPE mouseover(@Nonnull final IJSExpression handler) { return mouseover ().arg (handler); }

@Nonnull
public THISTYPE mouseover(@Nonnull final JSAnonymousFunction handler) { return mouseover ().arg (handler); }
...
@Nonnull
public THISTYPE mouseup(@Nonnull final IJSExpression handler) { return mouseup ().arg (handler); }

@Nonnull
public THISTYPE mouseup(@Nonnull final JSAnonymousFunction handler) { return mouseup ().arg (handler); }
...
@Nonnull
public THISTYPE next(@Nonnull final IJSExpression selector) { return next ().arg (selector); }

@Nonnull
public THISTYPE next(@Nonnull final IJQuerySelector selector) { return next ().arg (selector); }

@Nonnull
public THISTYPE next(@Nonnull final JQuerySelectorList selector) { return next ().arg (selector); }

@Nonnull
public THISTYPE next(@Nonnull final EHTMLElement selector) { return next ().arg (selector); }

@Nonnull
public THISTYPE next(@Nonnull final ICSSClassProvider selector) { return next ().arg (selector); }

@Nonnull
public THISTYPE nextAll(@Nonnull final IJSExpression selector) { return nextAll ().arg (selector); }

@Nonnull
public THISTYPE nextAll(@Nonnull final IJson selector) { return nextAll ().arg (selector); }

@Nonnull
public THISTYPE nextAll(@Nonnull final IHCNode selector) { return nextAll ().arg (selector); }

@Nonnull
public THISTYPE nextAll(@Nonnull final String selector) { return nextAll ().arg (selector); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final IJSExpression selector) { return nextUntil ().arg (selector); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final IJQuerySelector selector) { return nextUntil ().arg (selector); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final JQuerySelectorList selector) { return nextUntil ().arg (selector); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final EHTMLElement selector) { return nextUntil ().arg (selector); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final ICSSClassProvider selector) { return nextUntil ().arg (selector); }
...
@Nonnull
public THISTYPE nextUntil(@Nonnull final String element) { return nextUntil ().arg (element); }

@Nonnull
public THISTYPE nextUntil(@Nonnull final JQueryInvocation element) { return nextUntil ().arg (element); }
...
@Nonnull
public THISTYPE _not(@Nonnull final IJSExpression selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final IJQuerySelector selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final JQuerySelectorList selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final EHTMLElement selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final ICSSClassProvider selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final String selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final JSArray selector) { return _not ().arg (selector); }

@Nonnull
public THISTYPE _not(@Nonnull final JSAnonymousFunction function) { return _not ().arg (function); }

@Nonnull
public THISTYPE _not(@Nonnull final JQueryInvocation selection) { return _not ().arg (selection); }

@Nonnull
public THISTYPE off(@Nonnull final IJSExpression events) { return off ().arg (events); }

@Nonnull
public THISTYPE off(@Nonnull final IJson events) { return off ().arg (events); }

@Nonnull
public THISTYPE off(@Nonnull final IHCNode events) { return off ().arg (events); }

@Nonnull
public THISTYPE off(@Nonnull final String events) { return off ().arg (events); }
...
@Nonnull
public THISTYPE offset(@Nonnull final IJSExpression coordinates) { return offset ().arg (coordinates); }

@Nonnull
public THISTYPE offset(@Nonnull final JSAnonymousFunction function) { return offset ().arg (function); }
...
@Nonnull
public THISTYPE on(@Nonnull final IJSExpression events) { return on ().arg (events); }
...
@Nonnull
public THISTYPE one(@Nonnull final IJSExpression events) { return one ().arg (events); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final IJSExpression includeMargin) { return outerHeight ().arg (includeMargin); }

@Nonnull
public THISTYPE outerHeight(final boolean includeMargin) { return outerHeight ().arg (includeMargin); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final IJson value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final IHCNode value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final String value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(final int value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(final long value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final BigInteger value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(final double value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final BigDecimal value) { return outerHeight ().arg (value); }

@Nonnull
public THISTYPE outerHeight(@Nonnull final JSAnonymousFunction function) { return outerHeight ().arg (function); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final IJSExpression includeMargin) { return outerWidth ().arg (includeMargin); }

@Nonnull
public THISTYPE outerWidth(final boolean includeMargin) { return outerWidth ().arg (includeMargin); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final IJson value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final IHCNode value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final String value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(final int value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(final long value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final BigInteger value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(final double value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final BigDecimal value) { return outerWidth ().arg (value); }

@Nonnull
public THISTYPE outerWidth(@Nonnull final JSAnonymousFunction function) { return outerWidth ().arg (function); }

@Nonnull
public THISTYPE parent(@Nonnull final IJSExpression selector) { return parent ().arg (selector); }

@Nonnull
public THISTYPE parent(@Nonnull final IJQuerySelector selector) { return parent ().arg (selector); }

@Nonnull
public THISTYPE parent(@Nonnull final JQuerySelectorList selector) { return parent ().arg (selector); }

@Nonnull
public THISTYPE parent(@Nonnull final EHTMLElement selector) { return parent ().arg (selector); }

@Nonnull
public THISTYPE parent(@Nonnull final ICSSClassProvider selector) { return parent ().arg (selector); }

@Nonnull
public THISTYPE parents(@Nonnull final IJSExpression selector) { return parents ().arg (selector); }

@Nonnull
public THISTYPE parents(@Nonnull final IJQuerySelector selector) { return parents ().arg (selector); }

@Nonnull
public THISTYPE parents(@Nonnull final JQuerySelectorList selector) { return parents ().arg (selector); }

@Nonnull
public THISTYPE parents(@Nonnull final EHTMLElement selector) { return parents ().arg (selector); }

@Nonnull
public THISTYPE parents(@Nonnull final ICSSClassProvider selector) { return parents ().arg (selector); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final IJSExpression selector) { return parentsUntil ().arg (selector); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final IJQuerySelector selector) { return parentsUntil ().arg (selector); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final JQuerySelectorList selector) { return parentsUntil ().arg (selector); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final EHTMLElement selector) { return parentsUntil ().arg (selector); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final ICSSClassProvider selector) { return parentsUntil ().arg (selector); }
...
@Nonnull
public THISTYPE parentsUntil(@Nonnull final String element) { return parentsUntil ().arg (element); }

@Nonnull
public THISTYPE parentsUntil(@Nonnull final JQueryInvocation element) { return parentsUntil ().arg (element); }
...
@Nonnull
public THISTYPE prepend(@Nonnull final IJSExpression content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final IHCNode content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final String content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final EHTMLElement content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final IJson content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final JSArray content) { return prepend ().arg (content); }

@Nonnull
public THISTYPE prepend(@Nonnull final JQueryInvocation content) { return prepend ().arg (content); }
...
@Nonnull
public THISTYPE prepend(@Nonnull final JSAnonymousFunction function) { return prepend ().arg (function); }

@Nonnull
public THISTYPE prependTo(@Nonnull final IJSExpression target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final IJQuerySelector target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final JQuerySelectorList target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final EHTMLElement target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final ICSSClassProvider target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final IHCNode target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final String target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final JSArray target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prependTo(@Nonnull final JQueryInvocation target) { return prependTo ().arg (target); }

@Nonnull
public THISTYPE prev(@Nonnull final IJSExpression selector) { return prev ().arg (selector); }

@Nonnull
public THISTYPE prev(@Nonnull final IJQuerySelector selector) { return prev ().arg (selector); }

@Nonnull
public THISTYPE prev(@Nonnull final JQuerySelectorList selector) { return prev ().arg (selector); }

@Nonnull
public THISTYPE prev(@Nonnull final EHTMLElement selector) { return prev ().arg (selector); }

@Nonnull
public THISTYPE prev(@Nonnull final ICSSClassProvider selector) { return prev ().arg (selector); }

@Nonnull
public THISTYPE prevAll(@Nonnull final IJSExpression selector) { return prevAll ().arg (selector); }

@Nonnull
public THISTYPE prevAll(@Nonnull final IJQuerySelector selector) { return prevAll ().arg (selector); }

@Nonnull
public THISTYPE prevAll(@Nonnull final JQuerySelectorList selector) { return prevAll ().arg (selector); }

@Nonnull
public THISTYPE prevAll(@Nonnull final EHTMLElement selector) { return prevAll ().arg (selector); }

@Nonnull
public THISTYPE prevAll(@Nonnull final ICSSClassProvider selector) { return prevAll ().arg (selector); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final IJSExpression selector) { return prevUntil ().arg (selector); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final IJQuerySelector selector) { return prevUntil ().arg (selector); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final JQuerySelectorList selector) { return prevUntil ().arg (selector); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final EHTMLElement selector) { return prevUntil ().arg (selector); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final ICSSClassProvider selector) { return prevUntil ().arg (selector); }
...
@Nonnull
public THISTYPE prevUntil(@Nonnull final String element) { return prevUntil ().arg (element); }

@Nonnull
public THISTYPE prevUntil(@Nonnull final JQueryInvocation element) { return prevUntil ().arg (element); }
...
@Nonnull
public THISTYPE promise(@Nonnull final IJSExpression type) { return promise ().arg (type); }

@Nonnull
public THISTYPE promise(@Nonnull final IJson type) { return promise ().arg (type); }

@Nonnull
public THISTYPE promise(@Nonnull final IHCNode type) { return promise ().arg (type); }

@Nonnull
public THISTYPE promise(@Nonnull final String type) { return promise ().arg (type); }
...
@Nonnull
public THISTYPE prop(@Nonnull final IJSExpression propertyName) { return prop ().arg (propertyName); }

@Nonnull
public THISTYPE prop(@Nonnull final IJson propertyName) { return prop ().arg (propertyName); }

@Nonnull
public THISTYPE prop(@Nonnull final IHCNode propertyName) { return prop ().arg (propertyName); }

@Nonnull
public THISTYPE prop(@Nonnull final String propertyName) { return prop ().arg (propertyName); }
...
@Nonnull
public THISTYPE pushStack(@Nonnull final IJSExpression elements) { return pushStack ().arg (elements); }

@Nonnull
public THISTYPE pushStack(@Nonnull final JSArray elements) { return pushStack ().arg (elements); }
...
@Nonnull
public THISTYPE queue(@Nonnull final IJSExpression queueName) { return queue ().arg (queueName); }

@Nonnull
public THISTYPE queue(@Nonnull final IJson queueName) { return queue ().arg (queueName); }

@Nonnull
public THISTYPE queue(@Nonnull final IHCNode queueName) { return queue ().arg (queueName); }

@Nonnull
public THISTYPE queue(@Nonnull final String queueName) { return queue ().arg (queueName); }
...
@Nonnull
public THISTYPE ready(@Nonnull final IJSExpression handler) { return ready ().arg (handler); }

@Nonnull
public THISTYPE ready(@Nonnull final JSAnonymousFunction handler) { return ready ().arg (handler); }

@Nonnull
public THISTYPE remove(@Nonnull final IJSExpression selector) { return remove ().arg (selector); }

@Nonnull
public THISTYPE remove(@Nonnull final IJson selector) { return remove ().arg (selector); }

@Nonnull
public THISTYPE remove(@Nonnull final IHCNode selector) { return remove ().arg (selector); }

@Nonnull
public THISTYPE remove(@Nonnull final String selector) { return remove ().arg (selector); }

@Nonnull
public THISTYPE removeAttr(@Nonnull final IJSExpression attributeName) { return removeAttr ().arg (attributeName); }

@Nonnull
public THISTYPE removeAttr(@Nonnull final IJson attributeName) { return removeAttr ().arg (attributeName); }

@Nonnull
public THISTYPE removeAttr(@Nonnull final IHCNode attributeName) { return removeAttr ().arg (attributeName); }
...
@Nonnull
public THISTYPE removeClass(@Nonnull final IJson className) { return removeClass ().arg (className); }

@Nonnull
public THISTYPE removeClass(@Nonnull final IHCNode className) { return removeClass ().arg (className); }

@Nonnull
public THISTYPE removeClass(@Nonnull final String className) { return removeClass ().arg (className); }

@Nonnull
public THISTYPE removeClass(@Nonnull final JSAnonymousFunction function) { return removeClass ().arg (function); }

@Nonnull
public THISTYPE removeData(@Nonnull final IJSExpression name) { return removeData ().arg (name); }

@Nonnull
public THISTYPE removeData(@Nonnull final IJson name) { return removeData ().arg (name); }

@Nonnull
public THISTYPE removeData(@Nonnull final IHCNode name) { return removeData ().arg (name); }

@Nonnull
public THISTYPE removeData(@Nonnull final String name) { return removeData ().arg (name); }

@Nonnull
public THISTYPE removeData(@Nonnull final JSArray list) { return removeData ().arg (list); }

@Nonnull
public THISTYPE removeProp(@Nonnull final IJSExpression propertyName) { return removeProp ().arg (propertyName); }

@Nonnull
public THISTYPE removeProp(@Nonnull final IJson propertyName) { return removeProp ().arg (propertyName); }

@Nonnull
public THISTYPE removeProp(@Nonnull final IHCNode propertyName) { return removeProp ().arg (propertyName); }

@Nonnull
public THISTYPE removeProp(@Nonnull final String propertyName) { return removeProp ().arg (propertyName); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final IJSExpression target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final IJQuerySelector target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final JQuerySelectorList target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final EHTMLElement target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final ICSSClassProvider target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final JQueryInvocation target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final JSArray target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceAll(@Nonnull final String target) { return replaceAll ().arg (target); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final IJSExpression newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final IHCNode newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final String newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final EHTMLElement newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final JSArray newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final JQueryInvocation newContent) { return replaceWith ().arg (newContent); }

@Nonnull
public THISTYPE replaceWith(@Nonnull final JSAnonymousFunction function) { return replaceWith ().arg (function); }

@Nonnull
public THISTYPE resize(@Nonnull final IJSExpression handler) { return resize ().arg (handler); }

@Nonnull
public THISTYPE resize(@Nonnull final JSAnonymousFunction handler) { return resize ().arg (handler); }
...
@Nonnull
public THISTYPE scroll(@Nonnull final IJSExpression handler) { return scroll ().arg (handler); }

@Nonnull
public THISTYPE scroll(@Nonnull final JSAnonymousFunction handler) { return scroll ().arg (handler); }
...
@Nonnull
public THISTYPE scrollLeft(@Nonnull final IJSExpression value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollLeft(final int value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollLeft(final long value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollLeft(@Nonnull final BigInteger value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollLeft(final double value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollLeft(@Nonnull final BigDecimal value) { return scrollLeft ().arg (value); }

@Nonnull
public THISTYPE scrollTop(@Nonnull final IJSExpression value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE scrollTop(final int value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE scrollTop(final long value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE scrollTop(@Nonnull final BigInteger value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE scrollTop(final double value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE scrollTop(@Nonnull final BigDecimal value) { return scrollTop ().arg (value); }

@Nonnull
public THISTYPE select(@Nonnull final IJSExpression handler) { return select ().arg (handler); }

@Nonnull
public THISTYPE select(@Nonnull final JSAnonymousFunction handler) { return select ().arg (handler); }
...
@Nonnull
public THISTYPE show(@Nonnull final IJSExpression duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(final int duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(final long duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(@Nonnull final BigInteger duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(final double duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(@Nonnull final BigDecimal duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(@Nonnull final IJson duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(@Nonnull final IHCNode duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE show(@Nonnull final String duration) { return show ().arg (duration); }

@Nonnull
public THISTYPE siblings(@Nonnull final IJSExpression selector) { return siblings ().arg (selector); }

@Nonnull
public THISTYPE siblings(@Nonnull final IJQuerySelector selector) { return siblings ().arg (selector); }

@Nonnull
public THISTYPE siblings(@Nonnull final JQuerySelectorList selector) { return siblings ().arg (selector); }

@Nonnull
public THISTYPE siblings(@Nonnull final EHTMLElement selector) { return siblings ().arg (selector); }

@Nonnull
public THISTYPE siblings(@Nonnull final ICSSClassProvider selector) { return siblings ().arg (selector); }

@Nonnull
public THISTYPE slice(@Nonnull final IJSExpression start) { return slice ().arg (start); }

@Nonnull
public THISTYPE slice(final int start) { return slice ().arg (start); }

@Nonnull
public THISTYPE slice(final long start) { return slice ().arg (start); }

@Nonnull
public THISTYPE slice(@Nonnull final BigInteger start) { return slice ().arg (start); }
...
@Nonnull
public THISTYPE stop(@Nonnull final IJSExpression clearQueue) { return stop ().arg (clearQueue); }

@Nonnull
public THISTYPE stop(final boolean clearQueue) { return stop ().arg (clearQueue); }
...
@Nonnull
public THISTYPE stop(@Nonnull final IJson queue) { return stop ().arg (queue); }

@Nonnull
public THISTYPE stop(@Nonnull final IHCNode queue) { return stop ().arg (queue); }

@Nonnull
public THISTYPE stop(@Nonnull final String queue) { return stop ().arg (queue); }
...
@Nonnull
public THISTYPE submit(@Nonnull final IJSExpression handler) { return submit ().arg (handler); }

@Nonnull
public THISTYPE submit(@Nonnull final JSAnonymousFunction handler) { return submit ().arg (handler); }
...
@Nonnull
public THISTYPE text(@Nonnull final IJSExpression text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final IJson text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final IHCNode text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final String text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(final int text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(final long text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final BigInteger text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(final double text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final BigDecimal text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(final boolean text) { return text ().arg (text); }

@Nonnull
public THISTYPE text(@Nonnull final JSAnonymousFunction function) { return text ().arg (function); }
...
@Nonnull
public THISTYPE toggle(@Nonnull final IJSExpression duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(final int duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(final long duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(@Nonnull final BigInteger duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(final double duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(@Nonnull final BigDecimal duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(@Nonnull final IJson duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(@Nonnull final IHCNode duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(@Nonnull final String duration) { return toggle ().arg (duration); }

@Nonnull
public THISTYPE toggle(final boolean display) { return toggle ().arg (display); }

@Nonnull
public THISTYPE toggleClass(@Nonnull final IJSExpression className) { return toggleClass ().arg (className); }

@Nonnull
public THISTYPE toggleClass(@Nonnull final IJson className) { return toggleClass ().arg (className); }

@Nonnull
public THISTYPE toggleClass(@Nonnull final IHCNode className) { return toggleClass ().arg (className); }

@Nonnull
public THISTYPE toggleClass(@Nonnull final String className) { return toggleClass ().arg (className); }
...
@Nonnull
public THISTYPE toggleClass(@Nonnull final JSAnonymousFunction function) { return toggleClass ().arg (function); }
...
@Deprecated
@Nonnull
public THISTYPE toggleClass(final boolean state) { return toggleClass ().arg (state); }

@Nonnull
public THISTYPE trigger(@Nonnull final IJSExpression eventType) { return trigger ().arg (eventType); }

@Nonnull
public THISTYPE trigger(@Nonnull final IJson eventType) { return trigger ().arg (eventType); }

@Nonnull
public THISTYPE trigger(@Nonnull final IHCNode eventType) { return trigger ().arg (eventType); }

@Nonnull
public THISTYPE trigger(@Nonnull final String eventType) { return trigger ().arg (eventType); }
...
@Nonnull
public THISTYPE triggerHandler(@Nonnull final IJSExpression eventType) { return triggerHandler ().arg (eventType); }

@Nonnull
public THISTYPE triggerHandler(@Nonnull final IJson eventType) { return triggerHandler ().arg (eventType); }

@Nonnull
public THISTYPE triggerHandler(@Nonnull final IHCNode eventType) { return triggerHandler ().arg (eventType); }

@Nonnull
public THISTYPE triggerHandler(@Nonnull final String eventType) { return triggerHandler ().arg (eventType); }
...
@Deprecated
@Nonnull
public THISTYPE unbind(@Nonnull final IJSExpression eventType) { return unbind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE unbind(@Nonnull final IJson eventType) { return unbind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE unbind(@Nonnull final IHCNode eventType) { return unbind ().arg (eventType); }

@Deprecated
@Nonnull
public THISTYPE unbind(@Nonnull final String eventType) { return unbind ().arg (eventType); }
...
@Deprecated
@Nonnull
public THISTYPE undelegate(@Nonnull final IJSExpression namespace) { return undelegate ().arg (namespace); }

@Deprecated
@Nonnull
public THISTYPE undelegate(@Nonnull final IJson namespace) { return undelegate ().arg (namespace); }

@Deprecated
@Nonnull
public THISTYPE undelegate(@Nonnull final IHCNode namespace) { return undelegate ().arg (namespace); }

@Deprecated
@Nonnull
public THISTYPE undelegate(@Nonnull final String namespace) { return undelegate ().arg (namespace); }

@Deprecated
@Nonnull
public THISTYPE unload(@Nonnull final IJSExpression handler) { return unload ().arg (handler); }

@Deprecated
@Nonnull
public THISTYPE unload(@Nonnull final JSAnonymousFunction handler) { return unload ().arg (handler); }
...
@Nonnull
public THISTYPE unwrap(@Nonnull final IJSExpression selector) { return unwrap ().arg (selector); }

@Nonnull
public THISTYPE unwrap(@Nonnull final IJson selector) { return unwrap ().arg (selector); }

@Nonnull
public THISTYPE unwrap(@Nonnull final IHCNode selector) { return unwrap ().arg (selector); }

@Nonnull
public THISTYPE unwrap(@Nonnull final String selector) { return unwrap ().arg (selector); }

@Nonnull
public THISTYPE val(@Nonnull final IJSExpression value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final IJson value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final IHCNode value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final String value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(final int value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(final long value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final BigInteger value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(final double value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final BigDecimal value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final JSArray value) { return val ().arg (value); }

@Nonnull
public THISTYPE val(@Nonnull final JSAnonymousFunction function) { return val ().arg (function); }

@Nonnull
public THISTYPE width(@Nonnull final IJSExpression value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final IJson value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final IHCNode value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final String value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(final int value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(final long value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final BigInteger value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(final double value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final BigDecimal value) { return width ().arg (value); }

@Nonnull
public THISTYPE width(@Nonnull final JSAnonymousFunction function) { return width ().arg (function); }

@Nonnull
public THISTYPE wrap(@Nonnull final IJSExpression wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final IJQuerySelector wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final JQuerySelectorList wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final EHTMLElement wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final ICSSClassProvider wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final IHCNode wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final String wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final JQueryInvocation wrappingElement) { return wrap ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrap(@Nonnull final JSAnonymousFunction function) { return wrap ().arg (function); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final IJSExpression wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final IJQuerySelector wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final JQuerySelectorList wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final EHTMLElement wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final ICSSClassProvider wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final IHCNode wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final String wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final JQueryInvocation wrappingElement) { return wrapAll ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapAll(@Nonnull final JSAnonymousFunction function) { return wrapAll ().arg (function); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final IJSExpression wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final IHCNode wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final String wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final IJQuerySelector wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final JQuerySelectorList wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final EHTMLElement wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final ICSSClassProvider wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final JQueryInvocation wrappingElement) { return wrapInner ().arg (wrappingElement); }

@Nonnull
public THISTYPE wrapInner(@Nonnull final JSAnonymousFunction function) { return wrapInner ().arg (function); }
