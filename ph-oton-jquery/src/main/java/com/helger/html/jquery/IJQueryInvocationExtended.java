 ...
 *        Implementation type
 */
public interface IJQueryInvocationExtended <IMPLTYPE extends IJQueryInvocationExtended <IMPLTYPE>> extends
                                           IJQueryInvocation <IMPLTYPE>
{
  @NonNull
  ...
  @NonNull
  default IMPLTYPE deferred_always (@NonNull JSAnonymousFunction alwaysCallbacks,
                                    @NonNull IJSExpression alwaysCallbacks1)
  {
    return deferred_always ().arg (alwaysCallbacks).arg (alwaysCallbacks1);
  }

  @NonNull
  default IMPLTYPE deferred_always (@NonNull IJSExpression alwaysCallbacks,
  ...
  @NonNull
  default IMPLTYPE deferred_done (@NonNull JSAnonymousFunction doneCallbacks,
                                  @NonNull JSAnonymousFunction doneCallbacks1)
  {
    return deferred_done ().arg (doneCallbacks).arg (doneCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_fail (@NonNull JSAnonymousFunction failCallbacks,
                                  @NonNull JSAnonymousFunction failCallbacks1)
  {
    return deferred_fail ().arg (failCallbacks).arg (failCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_progress (@NonNull IJSExpression progressCallbacks,
                                      @NonNull IJSExpression progressCallbacks1)
  {
    return deferred_progress ().arg (progressCallbacks).arg (progressCallbacks1);
  }

  @NonNull
  default IMPLTYPE deferred_progress (@NonNull JSAnonymousFunction progressCallbacks,
                                      @NonNull IJSExpression progressCallbacks1)
  {
    return deferred_progress ().arg (progressCallbacks).arg (progressCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_progress (@NonNull IJSExpression progressCallbacks,
                                      @NonNull JSAnonymousFunction progressCallbacks1)
  {
    return deferred_progress ().arg (progressCallbacks).arg (progressCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_progress (@NonNull JSArray progressCallbacks,
                                      @NonNull JSAnonymousFunction progressCallbacks1)
  {
    return deferred_progress ().arg (progressCallbacks).arg (progressCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_progress (@NonNull JSAnonymousFunction progressCallbacks,
                                      @NonNull JSArray progressCallbacks1)
  {
    return deferred_progress ().arg (progressCallbacks).arg (progressCallbacks1);
  }
  ...
  @NonNull
  default IMPLTYPE deferred_then (@NonNull JSAnonymousFunction doneCallbacks,
                                  @NonNull JSAnonymousFunction failCallbacks)
  {
    return deferred_then ().arg (doneCallbacks).arg (failCallbacks);
  }
  ...
  @NonNull
  default IMPLTYPE off (@NonNull IJSExpression events,
  ...
  @NonNull
  default IMPLTYPE pushStack (@NonNull IJSExpression elements,
  ...
  @NonNull
  default IMPLTYPE stop (@NonNull IJSExpression queue,
