...
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (RequestParameterManager.class);
  ...
  @Nullable
  public IMenuItemPage getMenuItemFromParameterIfValid (@Nullable final String sMenuItemID)
  {
  ...
  @Nullable
  public Locale getLocaleFromParameterIfValid (@Nullable final String sDisplayLocale)
  {
                              ...
                              @Nonnull @Nonempty final String sApplicationID)
  {
    ...
    final String sMenuItemID = AttributeValueConverter.getAsString (m_sRequestParamNameMenuItem,
                                                                    ...
                                                                    null);
    final IMenuItemPage aMenuItem = getMenuItemFromParameterIfValid (sMenuItemID);
    if (aMenuItem != null)
    {
      // Store in session
    ...
    final String sDisplayLocale = AttributeValueConverter.getAsString (m_sRequestParamNameLocale,
                                                                       ...
                                                                       null);
    final Locale aDisplayLocale = getLocaleFromParameterIfValid (sDisplayLocale);
    if (aDisplayLocale != null)
    {
      // Store in session
