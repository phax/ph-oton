...
public class FeedSource extends AbstractFeedElement
{
  ...
  protected final void fillElement (@NonNull final IMicroElement aElement)
  {
    ...
    if (m_aGenerator != null)
      aElement.addChild (m_aGenerator.getAsElement ("generator"));
    if (m_sIcon != null)
      aElement.addElementNS (CFeed.XMLNS_ATOM, "icon").addText (m_sIcon);
    if (m_sID != null)
      aElement.addElementNS (CFeed.XMLNS_ATOM, "id").addText (m_sID);
    for (final IFeedElement aLink : m_aLinks)
      aElement.addChild (aLink.getAsElement ("link"));
    if (m_sLogo != null)
      aElement.addElementNS (CFeed.XMLNS_ATOM, "logo").addText (m_sLogo);
    if (m_aRights != null)
      aElement.addChild (m_aRights.getAsElement ("rights"));
    if (m_aSubtitle != null)
      aElement.addChild (m_aSubtitle.getAsElement ("subtitle"));
    if (m_aTitle != null)
  ...
  public boolean isValid ()
  {
    ...
    {
      LOGGER.warn ("generator is invalid");
      return false;
    }
    ...
    {
      LOGGER.warn ("subtitle is invalid");
      return false;
    }
    if (!m_aTitle.isValid ())
    {
    ...
    // representing this Atom feed.
    {
      ...
      if (!bFoundSelf)
        LOGGER.warn ("no '" + FeedLink.REL_SELF + "' link found!");
    }
