...
/**
 * A recording {@link ITelemetryMeterSPI} for the ph-oton-audit tests.<br>
 ...
 * instrument of {@code AuditMetrics} is resolved once in its static initializer. Other test classes
 * of this module create audit items and would therefore bind that instrument to the no-op meter
 * before a telemetry test could install anything.
 *
